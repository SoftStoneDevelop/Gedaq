...
namespace Tests
{
    ...
    internal partial class Int32MArrayArrayInt32
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int32arrayint32e1m
(
    m_id Int32,
    m_value Array(Int32),
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int32arrayint32e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
