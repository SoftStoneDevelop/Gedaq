...
namespace Tests
{
    ...
    internal partial class UInt64ArrayArrayUInt64
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint64arrayuint641m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint64arrayuint641m;
";
            await cmd.ExecuteNonQueryAsync();
        }
