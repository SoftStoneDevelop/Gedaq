...
namespace Tests
{
    ...
    internal partial class SByteMArrayArrayArrayInt8
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.sbytearrayarrayint8e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.sbytearrayarrayint8e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
