...
namespace Tests
{
    ...
    internal partial class ByteMArrayArrayArrayUInt8
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.bytearrayarrayuint8e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.bytearrayarrayuint8e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
