...
namespace Tests
{
    ...
    internal partial class UInt64MArrayArrayArrayUInt64
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint64arrayarrayuint64e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint64arrayarrayuint64e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
