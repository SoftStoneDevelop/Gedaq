...
namespace Tests
{
    ...
    internal partial class IPAddressArrayIPv4Array
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.ipaddressipv4array1m
(
    m_id Int32,
    m_value IPv4[],
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.ipaddressipv4array1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
