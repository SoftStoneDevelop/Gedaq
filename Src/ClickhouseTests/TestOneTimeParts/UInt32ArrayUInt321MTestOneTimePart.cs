...
namespace Tests
{
    ...
    internal partial class UInt32ArrayArrayUInt32
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint32arrayuint321m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint32arrayuint321m;
";
            await cmd.ExecuteNonQueryAsync();
        }
