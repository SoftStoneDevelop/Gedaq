...
namespace Tests
{
    ...
    internal partial class IPAddressMArrayMArrayD1
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.ipaddressmarrayd1e1m
(
    m_id Int32,
    m_value Array(IPv4),
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.ipaddressmarrayd1e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
