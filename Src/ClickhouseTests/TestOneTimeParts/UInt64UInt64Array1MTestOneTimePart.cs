...
namespace Tests
{
    ...
    internal partial class UInt64ArrayUInt64Array
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint64uint64array1m
(
    m_id Int32,
    m_value UInt64[],
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint64uint64array1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
