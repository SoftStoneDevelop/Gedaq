...
namespace Tests
{
    ...
    internal partial class StringArrayStringArray
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.stringstringarray1m
(
    m_id Int32,
    m_value String[],
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringstringarray1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
