...
namespace Tests
{
    ...
    internal partial class Int16MArrayArrayArrayInt16
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int16arrayarrayint16e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int16arrayarrayint16e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
