...
namespace Tests
{
    ...
    internal partial class StringMArrayArrayString
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.stringarraystringe1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringarraystringe1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
