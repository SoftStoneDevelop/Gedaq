...
namespace Tests
{
    ...
    internal partial class UInt32MArrayArrayUInt32
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint32arrayuint32e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint32arrayuint32e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
