...
namespace Tests
{
    ...
    internal partial class IPAddressMArrayArrayArrayIPv4
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.ipaddressarrayarrayipv4e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.ipaddressarrayarrayipv4e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
