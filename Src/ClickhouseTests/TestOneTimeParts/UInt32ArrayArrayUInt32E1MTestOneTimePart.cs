...
namespace Tests
{
    ...
    internal partial class UInt32MArrayArrayArrayUInt32
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint32arrayarrayuint32e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint32arrayarrayuint32e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
