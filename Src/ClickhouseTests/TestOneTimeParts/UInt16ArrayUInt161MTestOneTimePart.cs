...
namespace Tests
{
    ...
    internal partial class UInt16ArrayArrayUInt16
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint16arrayuint161m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint16arrayuint161m;
";
            await cmd.ExecuteNonQueryAsync();
        }
