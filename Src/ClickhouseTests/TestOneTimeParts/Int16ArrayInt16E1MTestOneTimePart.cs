...
namespace Tests
{
    ...
    internal partial class Int16MArrayArrayInt16
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int16arrayint16e1m
(
    m_id Int32,
    m_value Array(Int16),
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int16arrayint16e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
