...
namespace Tests
{
    ...
    internal partial class Int32MArrayArrayArrayInt32
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int32arrayarrayint32e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int32arrayarrayint32e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
