...
namespace Tests
{
    ...
    internal partial class Int64MArrayArrayArrayInt64
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int64arrayarrayint64e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int64arrayarrayint64e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
