...
namespace Tests
{
    ...
    internal partial class StringMArrayArrayArrayString
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.stringarrayarraystringe1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringarrayarraystringe1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
