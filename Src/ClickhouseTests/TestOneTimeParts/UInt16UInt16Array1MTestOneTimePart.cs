...
namespace Tests
{
    ...
    internal partial class UInt16ArrayUInt16Array
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint16uint16array1m
(
    m_id Int32,
    m_value UInt16[],
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint16uint16array1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
