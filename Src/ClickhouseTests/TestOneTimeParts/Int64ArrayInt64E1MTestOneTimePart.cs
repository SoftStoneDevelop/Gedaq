...
namespace Tests
{
    ...
    internal partial class Int64MArrayArrayInt64
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.int64arrayint64e1m
(
    m_id Int32,
    m_value Array(Int64),
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int64arrayint64e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
