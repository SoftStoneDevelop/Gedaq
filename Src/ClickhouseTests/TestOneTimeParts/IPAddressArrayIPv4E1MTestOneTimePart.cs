...
namespace Tests
{
    ...
    internal partial class IPAddressMArrayArrayIPv4
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.ipaddressarrayipv4e1m
(
    m_id Int32,
    m_value Array(IPv4),
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.ipaddressarrayipv4e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
