...
namespace Tests
{
    ...
    internal partial class StringArrayArrayString
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.stringarraystring1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringarraystring1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
