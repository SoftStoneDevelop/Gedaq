...
namespace Tests
{
    ...
    internal partial class UInt16MArrayArrayArrayUInt16
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint16arrayarrayuint16e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint16arrayarrayuint16e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
