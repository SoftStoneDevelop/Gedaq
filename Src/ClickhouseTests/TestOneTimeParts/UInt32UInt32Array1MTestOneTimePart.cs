...
namespace Tests
{
    ...
    internal partial class UInt32ArrayUInt32Array
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.uint32uint32array1m
(
    m_id Int32,
    m_value UInt32[],
    mi_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.uint32uint32array1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
