...
namespace Tests
{
    ...
    internal partial class GuidMArrayArrayArrayUUID
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.guidarrayarrayuuide1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.guidarrayarrayuuide1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
