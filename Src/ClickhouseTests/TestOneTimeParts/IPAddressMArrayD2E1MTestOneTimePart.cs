...
namespace Tests
{
    ...
    internal partial class IPAddressMArrayMArrayD2
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE IF NOT EXISTS gedaqtests.ipaddressmarrayd2e1m
(
    m_id Int32,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.ipaddressmarrayd2e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
