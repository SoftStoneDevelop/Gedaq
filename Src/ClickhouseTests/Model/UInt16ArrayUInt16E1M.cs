...
namespace Tests
{
    public class UInt16ArrayUInt16E1M
    {
        ...
        public UInt16ArrayUInt161MI ModelInner { get; set; }

        
        public System.UInt16[] NullableValue { get; set; }

        public static void AssertModel(UInt16ArrayUInt16E1M actual, UInt16ArrayUInt16E1M expect, bool checkInInnerOnlyId)
        {
