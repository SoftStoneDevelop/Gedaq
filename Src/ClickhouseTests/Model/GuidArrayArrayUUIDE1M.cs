...
namespace Tests
{
    public class GuidArrayArrayUUIDE1M
    {
        ...
        public GuidArrayArrayUUID1MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(GuidArrayArrayUUIDE1M actual, GuidArrayArrayUUIDE1M expect, bool checkInInnerOnlyId)
        {
