...
namespace Tests
{
    public class Int32ArrayArrayInt32E1M
    {
        ...
        public Int32ArrayArrayInt321MI ModelInner { get; set; }

        
        public System.Int32[,] NullableValue { get; set; }

        public static void AssertModel(Int32ArrayArrayInt32E1M actual, Int32ArrayArrayInt32E1M expect, bool checkInInnerOnlyId)
        {
