...
namespace Tests
{
    public class Int16ArrayArrayInt161MI
    {
        ...
        public static void AssertModel(Int16ArrayArrayInt161MI actual, Int16ArrayArrayInt161MI expect, bool checkInInnerOnlyId)
        {
