...
namespace Tests
{
    public class Int64MArrayD2E1M
    {
        ...
        public Int64MArrayD2E1MI ModelInner { get; set; }

        
        public System.Int64[,] NullableValue { get; set; }

        public static void AssertModel(Int64MArrayD2E1M actual, Int64MArrayD2E1M expect, bool checkInInnerOnlyId)
        {
