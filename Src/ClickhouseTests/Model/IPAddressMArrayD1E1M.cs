...
namespace Tests
{
    public class IPAddressMArrayD1E1M
    {
        ...
        public IPAddressMArrayD1E1MI ModelInner { get; set; }

        
        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressMArrayD1E1M actual, IPAddressMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
