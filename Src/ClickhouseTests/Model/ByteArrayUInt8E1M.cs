...
namespace Tests
{
    public class ByteArrayUInt8E1M
    {
        ...
        public ByteArrayUInt81MI ModelInner { get; set; }

        
        public System.Byte[] NullableValue { get; set; }

        public static void AssertModel(ByteArrayUInt8E1M actual, ByteArrayUInt8E1M expect, bool checkInInnerOnlyId)
        {
