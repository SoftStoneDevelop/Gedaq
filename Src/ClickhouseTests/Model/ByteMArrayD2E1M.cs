...
namespace Tests
{
    public class ByteMArrayD2E1M
    {
        ...
        public ByteMArrayD2E1MI ModelInner { get; set; }

        
        public System.Byte[,] NullableValue { get; set; }

        public static void AssertModel(ByteMArrayD2E1M actual, ByteMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
