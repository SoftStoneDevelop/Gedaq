...
namespace Tests
{
    public class SByteInt8Array1M
    {
        ...
        public SByteInt8Array1MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SByteInt8Array1M actual, SByteInt8Array1M expect, bool checkInInnerOnlyId)
        {
