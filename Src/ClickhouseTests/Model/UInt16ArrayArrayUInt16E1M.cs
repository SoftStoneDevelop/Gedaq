...
namespace Tests
{
    public class UInt16ArrayArrayUInt16E1M
    {
        ...
        public UInt16ArrayArrayUInt161MI ModelInner { get; set; }

        
        public System.UInt16[,] NullableValue { get; set; }

        public static void AssertModel(UInt16ArrayArrayUInt16E1M actual, UInt16ArrayArrayUInt16E1M expect, bool checkInInnerOnlyId)
        {
