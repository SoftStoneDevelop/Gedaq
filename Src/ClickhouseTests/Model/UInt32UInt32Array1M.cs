...
namespace Tests
{
    public class UInt32UInt32Array1M
    {
        ...
        public UInt32UInt32Array1MI ModelInner { get; set; }

        
        public System.UInt32[] NullableValue { get; set; }

        public static void AssertModel(UInt32UInt32Array1M actual, UInt32UInt32Array1M expect, bool checkInInnerOnlyId)
        {
