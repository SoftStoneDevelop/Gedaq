...
namespace Tests
{
    public class Int64ArrayArrayInt641MI
    {
        ...
        public static void AssertModel(Int64ArrayArrayInt641MI actual, Int64ArrayArrayInt641MI expect, bool checkInInnerOnlyId)
        {
