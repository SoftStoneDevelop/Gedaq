...
namespace Tests
{
    public class ByteArrayArrayUInt8E1M
    {
        ...
        public ByteArrayArrayUInt81MI ModelInner { get; set; }

        
        public System.Byte[,] NullableValue { get; set; }

        public static void AssertModel(ByteArrayArrayUInt8E1M actual, ByteArrayArrayUInt8E1M expect, bool checkInInnerOnlyId)
        {
