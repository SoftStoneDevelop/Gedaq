...
namespace Tests
{
    public class UInt32ArrayUInt32E1M
    {
        ...
        public UInt32ArrayUInt321MI ModelInner { get; set; }

        
        public System.UInt32[] NullableValue { get; set; }

        public static void AssertModel(UInt32ArrayUInt32E1M actual, UInt32ArrayUInt32E1M expect, bool checkInInnerOnlyId)
        {
