...
namespace Tests
{
    public class UInt32MArrayD2E1M
    {
        ...
        public UInt32MArrayD2E1MI ModelInner { get; set; }

        
        public System.UInt32[,] NullableValue { get; set; }

        public static void AssertModel(UInt32MArrayD2E1M actual, UInt32MArrayD2E1M expect, bool checkInInnerOnlyId)
        {
