...
namespace Tests
{
    public class SByteMArrayD2E1M
    {
        ...
        public SByteMArrayD2E1MI ModelInner { get; set; }

        
        public System.SByte[,] NullableValue { get; set; }

        public static void AssertModel(SByteMArrayD2E1M actual, SByteMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
