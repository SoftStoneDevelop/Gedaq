...
namespace Tests
{
    public class StringMArrayD1E1M
    {
        ...
        public StringMArrayD1E1MI ModelInner { get; set; }

        
        public System.String[] NullableValue { get; set; }

        public static void AssertModel(StringMArrayD1E1M actual, StringMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
