...
namespace Tests
{
    public class IPAddressArrayArrayIPv4E1M
    {
        ...
        public IPAddressArrayArrayIPv41MI ModelInner { get; set; }

        
        public System.Net.IPAddress[,] NullableValue { get; set; }

        public static void AssertModel(IPAddressArrayArrayIPv4E1M actual, IPAddressArrayArrayIPv4E1M expect, bool checkInInnerOnlyId)
        {
