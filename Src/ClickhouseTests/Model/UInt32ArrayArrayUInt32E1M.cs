...
namespace Tests
{
    public class UInt32ArrayArrayUInt32E1M
    {
        ...
        public UInt32ArrayArrayUInt321MI ModelInner { get; set; }

        
        public System.UInt32[,] NullableValue { get; set; }

        public static void AssertModel(UInt32ArrayArrayUInt32E1M actual, UInt32ArrayArrayUInt32E1M expect, bool checkInInnerOnlyId)
        {
