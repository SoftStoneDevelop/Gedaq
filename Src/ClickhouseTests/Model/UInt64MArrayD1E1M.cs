...
namespace Tests
{
    public class UInt64MArrayD1E1M
    {
        ...
        public UInt64MArrayD1E1MI ModelInner { get; set; }

        
        public System.UInt64[] NullableValue { get; set; }

        public static void AssertModel(UInt64MArrayD1E1M actual, UInt64MArrayD1E1M expect, bool checkInInnerOnlyId)
        {
