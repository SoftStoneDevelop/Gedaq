...
namespace Tests
{
    public class UInt64ArrayArrayUInt64E1M
    {
        ...
        public UInt64ArrayArrayUInt641MI ModelInner { get; set; }

        
        public System.UInt64[,] NullableValue { get; set; }

        public static void AssertModel(UInt64ArrayArrayUInt64E1M actual, UInt64ArrayArrayUInt64E1M expect, bool checkInInnerOnlyId)
        {
