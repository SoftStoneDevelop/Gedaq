...
namespace Tests
{
    public class UInt16MArrayD1E1M
    {
        ...
        public UInt16MArrayD1E1MI ModelInner { get; set; }

        
        public System.UInt16[] NullableValue { get; set; }

        public static void AssertModel(UInt16MArrayD1E1M actual, UInt16MArrayD1E1M expect, bool checkInInnerOnlyId)
        {
