...
namespace Tests
{
    public class UInt32MArrayD1E1M
    {
        ...
        public UInt32MArrayD1E1MI ModelInner { get; set; }

        
        public System.UInt32[] NullableValue { get; set; }

        public static void AssertModel(UInt32MArrayD1E1M actual, UInt32MArrayD1E1M expect, bool checkInInnerOnlyId)
        {
