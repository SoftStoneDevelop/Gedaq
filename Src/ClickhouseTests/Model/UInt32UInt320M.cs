...
namespace Tests
{
    public class UInt32UInt320M
    {
        ...
        public UInt32UInt320MI ModelInner { get; set; }

        
        public System.UInt32? NullableValue { get; set; }

        public static void AssertModel(UInt32UInt320M actual, UInt32UInt320M expect, bool checkInInnerOnlyId)
        {
