...
namespace Tests
{
    public class Int32Int32Array1M
    {
        ...
        public Int32Int32Array1MI ModelInner { get; set; }

        
        public System.Int32[] NullableValue { get; set; }

        public static void AssertModel(Int32Int32Array1M actual, Int32Int32Array1M expect, bool checkInInnerOnlyId)
        {
