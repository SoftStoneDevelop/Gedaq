...
namespace Tests
{
    public class Int16ArrayArrayInt16E1M
    {
        ...
        public Int16ArrayArrayInt161MI ModelInner { get; set; }

        
        public System.Int16[,] NullableValue { get; set; }

        public static void AssertModel(Int16ArrayArrayInt16E1M actual, Int16ArrayArrayInt16E1M expect, bool checkInInnerOnlyId)
        {
