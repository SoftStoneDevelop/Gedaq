...
namespace Tests
{
    public class Int16MArrayD1E1M
    {
        ...
        public Int16MArrayD1E1MI ModelInner { get; set; }

        
        public System.Int16[] NullableValue { get; set; }

        public static void AssertModel(Int16MArrayD1E1M actual, Int16MArrayD1E1M expect, bool checkInInnerOnlyId)
        {
