...
namespace Tests
{
    public class IPAddressArrayIPv4E1M
    {
        ...
        public IPAddressArrayIPv41MI ModelInner { get; set; }

        
        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressArrayIPv4E1M actual, IPAddressArrayIPv4E1M expect, bool checkInInnerOnlyId)
        {
