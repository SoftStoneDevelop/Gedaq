...
namespace Tests
{
    public class Guidv7MArrayD2E1M
    {
        ...
        public Guidv7MArrayD2E1MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(Guidv7MArrayD2E1M actual, Guidv7MArrayD2E1M expect, bool checkInInnerOnlyId)
        {
