...
namespace Tests
{
    public class StringArrayArrayStringE1M
    {
        ...
        public StringArrayArrayString1MI ModelInner { get; set; }

        
        public System.String[,] NullableValue { get; set; }

        public static void AssertModel(StringArrayArrayStringE1M actual, StringArrayArrayStringE1M expect, bool checkInInnerOnlyId)
        {
