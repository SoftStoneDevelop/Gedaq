...
namespace Tests
{
    public class StringArrayArrayString1MI
    {
        ...
        public static void AssertModel(StringArrayArrayString1MI actual, StringArrayArrayString1MI expect, bool checkInInnerOnlyId)
        {
