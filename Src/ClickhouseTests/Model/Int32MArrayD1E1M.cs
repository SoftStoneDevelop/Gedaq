...
namespace Tests
{
    public class Int32MArrayD1E1M
    {
        ...
        public Int32MArrayD1E1MI ModelInner { get; set; }

        
        public System.Int32[] NullableValue { get; set; }

        public static void AssertModel(Int32MArrayD1E1M actual, Int32MArrayD1E1M expect, bool checkInInnerOnlyId)
        {
