...
namespace Tests
{
    public class UInt16UInt16Array1M
    {
        ...
        public UInt16UInt16Array1MI ModelInner { get; set; }

        
        public System.UInt16[] NullableValue { get; set; }

        public static void AssertModel(UInt16UInt16Array1M actual, UInt16UInt16Array1M expect, bool checkInInnerOnlyId)
        {
