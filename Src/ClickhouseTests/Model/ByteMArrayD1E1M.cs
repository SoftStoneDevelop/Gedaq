...
namespace Tests
{
    public class ByteMArrayD1E1M
    {
        ...
        public ByteMArrayD1E1MI ModelInner { get; set; }

        
        public System.Byte[] NullableValue { get; set; }

        public static void AssertModel(ByteMArrayD1E1M actual, ByteMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
