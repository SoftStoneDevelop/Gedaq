...
namespace Tests
{
    public class UInt64ArrayUInt64E1M
    {
        ...
        public UInt64ArrayUInt641MI ModelInner { get; set; }

        
        public System.UInt64[] NullableValue { get; set; }

        public static void AssertModel(UInt64ArrayUInt64E1M actual, UInt64ArrayUInt64E1M expect, bool checkInInnerOnlyId)
        {
