...
namespace Tests
{
    public class GuidArrayUUIDE1M
    {
        ...
        public GuidArrayUUID1MI ModelInner { get; set; }

        
        public System.Guid[] NullableValue { get; set; }

        public static void AssertModel(GuidArrayUUIDE1M actual, GuidArrayUUIDE1M expect, bool checkInInnerOnlyId)
        {
