...
namespace Tests
{
    public class StringStringE0M
    {
        ...
        public StringStringE0MI ModelInner { get; set; }

        
        public System.String? NullableValue { get; set; }

        public static void AssertModel(StringStringE0M actual, StringStringE0M expect, bool checkInInnerOnlyId)
        {
