...
namespace Tests
{
    public class StringStringArray1M
    {
        ...
        public StringStringArray1MI ModelInner { get; set; }

        
        public System.String[] NullableValue { get; set; }

        public static void AssertModel(StringStringArray1M actual, StringStringArray1M expect, bool checkInInnerOnlyId)
        {
