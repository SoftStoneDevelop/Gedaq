...
namespace Tests
{
    public class StringMArrayD2E1M
    {
        ...
        public StringMArrayD2E1MI ModelInner { get; set; }

        
        public System.String[,] NullableValue { get; set; }

        public static void AssertModel(StringMArrayD2E1M actual, StringMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
