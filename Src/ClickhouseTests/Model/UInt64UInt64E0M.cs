...
namespace Tests
{
    public class UInt64UInt64E0M
    {
        ...
        public UInt64UInt64E0MI ModelInner { get; set; }

        
        public System.UInt64? NullableValue { get; set; }

        public static void AssertModel(UInt64UInt64E0M actual, UInt64UInt64E0M expect, bool checkInInnerOnlyId)
        {
