...
namespace Tests
{
    public class SByteMArrayD1E1M
    {
        ...
        public SByteMArrayD1E1MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SByteMArrayD1E1M actual, SByteMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
