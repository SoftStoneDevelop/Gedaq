...
namespace Tests
{
    public class GuidMArrayD2E1M
    {
        ...
        public GuidMArrayD2E1MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(GuidMArrayD2E1M actual, GuidMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
