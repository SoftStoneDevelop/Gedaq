...
namespace Tests
{
    public class Int64ArrayArrayInt64E1M
    {
        ...
        public Int64ArrayArrayInt641MI ModelInner { get; set; }

        
        public System.Int64[,] NullableValue { get; set; }

        public static void AssertModel(Int64ArrayArrayInt64E1M actual, Int64ArrayArrayInt64E1M expect, bool checkInInnerOnlyId)
        {
