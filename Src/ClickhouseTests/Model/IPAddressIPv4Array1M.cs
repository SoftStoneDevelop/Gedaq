...
namespace Tests
{
    public class IPAddressIPv4Array1M
    {
        ...
        public IPAddressIPv4Array1MI ModelInner { get; set; }

        
        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressIPv4Array1M actual, IPAddressIPv4Array1M expect, bool checkInInnerOnlyId)
        {
