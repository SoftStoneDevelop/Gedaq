...
namespace Tests
{
    public class UInt32ArrayArrayUInt321MI
    {
        ...
        public static void AssertModel(UInt32ArrayArrayUInt321MI actual, UInt32ArrayArrayUInt321MI expect, bool checkInInnerOnlyId)
        {
