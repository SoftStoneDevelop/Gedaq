...
namespace Tests
{
    public class ByteUInt8E0M
    {
        ...
        public ByteUInt8E0MI ModelInner { get; set; }

        
        public System.Byte? NullableValue { get; set; }

        public static void AssertModel(ByteUInt8E0M actual, ByteUInt8E0M expect, bool checkInInnerOnlyId)
        {
