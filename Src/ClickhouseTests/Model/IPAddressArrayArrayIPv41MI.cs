...
namespace Tests
{
    public class IPAddressArrayArrayIPv41MI
    {
        ...
        public static void AssertModel(IPAddressArrayArrayIPv41MI actual, IPAddressArrayArrayIPv41MI expect, bool checkInInnerOnlyId)
        {
