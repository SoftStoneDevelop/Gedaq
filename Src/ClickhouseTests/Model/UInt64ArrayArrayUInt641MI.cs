...
namespace Tests
{
    public class UInt64ArrayArrayUInt641MI
    {
        ...
        public static void AssertModel(UInt64ArrayArrayUInt641MI actual, UInt64ArrayArrayUInt641MI expect, bool checkInInnerOnlyId)
        {
