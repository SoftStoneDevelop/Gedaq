...
namespace Tests
{
    public class StringArrayStringE1M
    {
        ...
        public StringArrayString1MI ModelInner { get; set; }

        
        public System.String[] NullableValue { get; set; }

        public static void AssertModel(StringArrayStringE1M actual, StringArrayStringE1M expect, bool checkInInnerOnlyId)
        {
