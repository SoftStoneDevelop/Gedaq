...
namespace Tests
{
    public class SByteArrayInt8E1M
    {
        ...
        public SByteArrayInt81MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SByteArrayInt8E1M actual, SByteArrayInt8E1M expect, bool checkInInnerOnlyId)
        {
