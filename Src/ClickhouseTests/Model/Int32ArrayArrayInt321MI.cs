...
namespace Tests
{
    public class Int32ArrayArrayInt321MI
    {
        ...
        public static void AssertModel(Int32ArrayArrayInt321MI actual, Int32ArrayArrayInt321MI expect, bool checkInInnerOnlyId)
        {
