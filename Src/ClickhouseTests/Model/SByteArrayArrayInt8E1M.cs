...
namespace Tests
{
    public class SByteArrayArrayInt8E1M
    {
        ...
        public SByteArrayArrayInt81MI ModelInner { get; set; }

        
        public System.SByte[,] NullableValue { get; set; }

        public static void AssertModel(SByteArrayArrayInt8E1M actual, SByteArrayArrayInt8E1M expect, bool checkInInnerOnlyId)
        {
