...
namespace Tests
{
    public class GuidMArrayD1E1M
    {
        ...
        public GuidMArrayD1E1MI ModelInner { get; set; }

        
        public System.Guid[] NullableValue { get; set; }

        public static void AssertModel(GuidMArrayD1E1M actual, GuidMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
