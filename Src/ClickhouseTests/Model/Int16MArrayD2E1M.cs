...
namespace Tests
{
    public class Int16MArrayD2E1M
    {
        ...
        public Int16MArrayD2E1MI ModelInner { get; set; }

        
        public System.Int16[,] NullableValue { get; set; }

        public static void AssertModel(Int16MArrayD2E1M actual, Int16MArrayD2E1M expect, bool checkInInnerOnlyId)
        {
