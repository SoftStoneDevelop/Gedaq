...
namespace Tests
{
    public class Int32MArrayD2E1M
    {
        ...
        public Int32MArrayD2E1MI ModelInner { get; set; }

        
        public System.Int32[,] NullableValue { get; set; }

        public static void AssertModel(Int32MArrayD2E1M actual, Int32MArrayD2E1M expect, bool checkInInnerOnlyId)
        {
