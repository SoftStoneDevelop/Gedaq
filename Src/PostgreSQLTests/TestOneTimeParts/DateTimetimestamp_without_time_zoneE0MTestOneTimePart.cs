...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.datetimetimestamp_without_time_zonee0m
(
    id integer NOT NULL,
    value timestamp without time zone NOT NULL,
    nullablevalue timestamp without time zone,
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_datetimetimestamp_without_time_zonee0m
(
    id integer NOT NULL,
    value timestamp without time zone NOT NULL,
    nullablevalue timestamp without time zone,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.datetimetimestamp_without_time_zonee0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_datetimetimestamp_without_time_zonee0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
