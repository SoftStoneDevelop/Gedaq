...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.int32integere0m
(
    id integer NOT NULL,
    value integer NOT NULL,
    nullablevalue integer,
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_int32integere0m
(
    id integer NOT NULL,
    value integer NOT NULL,
    nullablevalue integer,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.int32integere0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_int32integere0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
