...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.npgsqlpolygonpolygon0m
(
    id integer NOT NULL,
    value polygon NOT NULL,
    nullablevalue polygon,
    npgsqlpolygonpolygon0mi_id integer,
    CONSTRAINT npgsqlpolygonpolygon0m_pkey PRIMARY KEY (id),
    CONSTRAINT npgsqlpolygonpolygon0m_npgsqlpolygonpolygon0mi_fk FOREIGN KEY (npgsqlpolygonpolygon0mi_id)
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_npgsqlpolygonpolygon0m
(
    id integer NOT NULL,
    value polygon NOT NULL,
    nullablevalue polygon,
    npgsqlpolygonpolygon0mi_id integer,
    CONSTRAINT binary_npgsqlpolygonpolygon0m_pkey PRIMARY KEY (id),
    CONSTRAINT binary_npgsqlpolygonpolygon0m_binary_npgsqlpolygonpolygon0mi_fk FOREIGN KEY (npgsqlpolygonpolygon0mi_id)
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.npgsqlpolygonpolygon0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_npgsqlpolygonpolygon0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
