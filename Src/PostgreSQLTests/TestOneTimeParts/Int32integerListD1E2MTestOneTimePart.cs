...
namespace Tests
{
    ...
    internal partial class Int32ListintegerListD1
    {
...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.int32integerlistd1e2m
(
    id integer NOT NULL,
    value integer[] NOT NULL,
    nullablevalue integer[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_int32integerlistd1e2m
(
    id integer NOT NULL,
    value integer[] NOT NULL,
    nullablevalue integer[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.int32integerlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_int32integerlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
