...
namespace Tests
{
    ...
    internal partial class TimeOnlyListtime_without_time_zoneListD1
    {
...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.timeonlytime_without_time_zonelistd1e2m
(
    id integer NOT NULL,
    value time without time zone[] NOT NULL,
    nullablevalue time without time zone[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_timeonlytime_without_time_zonelistd1e2m
(
    id integer NOT NULL,
    value time without time zone[] NOT NULL,
    nullablevalue time without time zone[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.timeonlytime_without_time_zonelistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_timeonlytime_without_time_zonelistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
