...
namespace Tests
{
    ...
    internal partial class DecimalListnumericListD1
    {
...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.decimalnumericlistd1e2m
(
    id integer NOT NULL,
    value numeric[] NOT NULL,
    nullablevalue numeric[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_decimalnumericlistd1e2m
(
    id integer NOT NULL,
    value numeric[] NOT NULL,
    nullablevalue numeric[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.decimalnumericlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_decimalnumericlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
