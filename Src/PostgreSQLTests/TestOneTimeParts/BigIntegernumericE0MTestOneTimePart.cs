...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.bigintegernumerice0m
(
    id integer NOT NULL,
    value numeric NOT NULL,
    nullablevalue numeric,
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_bigintegernumerice0m
(
    id integer NOT NULL,
    value numeric NOT NULL,
    nullablevalue numeric,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.bigintegernumerice0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_bigintegernumerice0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
