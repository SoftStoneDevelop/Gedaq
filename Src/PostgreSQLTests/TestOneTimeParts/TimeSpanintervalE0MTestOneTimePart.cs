...
(
    ...
    CONSTRAINT timespanintervale0m_timespaninterval0mi_fk FOREIGN KEY (timespaninterval0mi_id)
...
(
    ...
    CONSTRAINT binary_timespanintervale0m_binary_timespaninterval0mi_fk FOREIGN KEY (timespaninterval0mi_id)
