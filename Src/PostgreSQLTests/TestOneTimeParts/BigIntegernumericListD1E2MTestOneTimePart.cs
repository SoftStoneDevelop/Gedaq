...
namespace Tests
{
    ...
    internal partial class BigIntegerListnumericListD1
    {
...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.bigintegernumericlistd1e2m
(
    id integer NOT NULL,
    value numeric[] NOT NULL,
    nullablevalue numeric[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_bigintegernumericlistd1e2m
(
    id integer NOT NULL,
    value numeric[] NOT NULL,
    nullablevalue numeric[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.bigintegernumericlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_bigintegernumericlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
