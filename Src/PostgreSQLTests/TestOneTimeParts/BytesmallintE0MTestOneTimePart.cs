...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.bytesmallinte0m
(
    id integer NOT NULL,
    value smallint NOT NULL,
    nullablevalue smallint,
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_bytesmallinte0m
(
    id integer NOT NULL,
    value smallint NOT NULL,
    nullablevalue smallint,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.bytesmallinte0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_bytesmallinte0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
