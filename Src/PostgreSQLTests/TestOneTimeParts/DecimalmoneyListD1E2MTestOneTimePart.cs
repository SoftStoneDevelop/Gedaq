...
namespace Tests
{
    ...
    internal partial class DecimalListmoneyListD1
    {
...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.decimalmoneylistd1e2m
(
    id integer NOT NULL,
    value money[] NOT NULL,
    nullablevalue money[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_decimalmoneylistd1e2m
(
    id integer NOT NULL,
    value money[] NOT NULL,
    nullablevalue money[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.decimalmoneylistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_decimalmoneylistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
