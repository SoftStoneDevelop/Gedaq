...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.decimalnumerice0m
(
    id integer NOT NULL,
    value numeric NOT NULL,
    nullablevalue numeric,
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_decimalnumerice0m
(
    id integer NOT NULL,
    value numeric NOT NULL,
    nullablevalue numeric,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.decimalnumerice0m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_decimalnumerice0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
