...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.guiduuidlistd1e2m
(
    id integer NOT NULL,
    value uuid[] NOT NULL,
    nullablevalue uuid[],
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_guiduuidlistd1e2m
(
    id integer NOT NULL,
    value uuid[] NOT NULL,
    nullablevalue uuid[],
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.guiduuidlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_guiduuidlistd1e2m;
";
            await cmd.ExecuteNonQueryAsync();
        }
