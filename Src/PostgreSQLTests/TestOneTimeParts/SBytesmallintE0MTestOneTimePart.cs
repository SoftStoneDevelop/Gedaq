...
(
    ...
    CONSTRAINT sbytesmallinte0m_sbytesmallint0mi_fk FOREIGN KEY (sbytesmallint0mi_id)
...
(
    ...
    CONSTRAINT binary_sbytesmallinte0m_binary_sbytesmallint0mi_fk FOREIGN KEY (sbytesmallint0mi_id)
