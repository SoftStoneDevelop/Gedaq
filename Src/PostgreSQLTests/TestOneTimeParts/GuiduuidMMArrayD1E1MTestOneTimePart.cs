...
";
        ...
        {
            cmd.CommandText = @"
CREATE TABLE public.guiduuidmmarrayd1e1m
(
    id integer NOT NULL,
    value uuid[] NOT NULL,
    nullablevalue uuid[],
    guiduuidmmarrayd1e1mi_id integer,
    CONSTRAINT guiduuidmmarrayd1e1m_pkey PRIMARY KEY (id),
    CONSTRAINT guiduuidmmarrayd1e1m_guiduuidmmarrayd1e1mi_fk FOREIGN KEY (guiduuidmmarrayd1e1mi_id)
...
";
            ...
            cmd.CommandText = @"
CREATE TABLE public.binary_guiduuidmmarrayd1e1m
(
    id integer NOT NULL,
    value uuid[] NOT NULL,
    nullablevalue uuid[],
    guiduuidmmarrayd1e1mi_id integer,
    CONSTRAINT binary_guiduuidmmarrayd1e1m_pkey PRIMARY KEY (id),
    CONSTRAINT binary_guiduuidmmarrayd1e1m_binary_guiduuidmmarrayd1e1mi_fk FOREIGN KEY (guiduuidmmarrayd1e1mi_id)
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE public.guiduuidmmarrayd1e1m;
";
            await cmd.ExecuteNonQueryAsync();

            cmd.CommandText = @"
DROP TABLE public.binary_guiduuidmmarrayd1e1m;
";
            await cmd.ExecuteNonQueryAsync();
        }
