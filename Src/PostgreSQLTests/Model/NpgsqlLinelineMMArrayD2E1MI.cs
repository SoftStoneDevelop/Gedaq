...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD2E1MI
    {
        ...
        public static void AssertModel(NpgsqlLinelineMMArrayD2E1MI actual, NpgsqlLinelineMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
