...
namespace Tests
{
    public class SBytesmallintMArrayD1E1M
    {
        ...
        public SBytesmallintMArrayD11MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintMArrayD1E1M actual, SBytesmallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
