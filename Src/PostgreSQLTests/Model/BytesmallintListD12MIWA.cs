...
namespace Tests
{
    public class BytesmallintListD12MIWA
    {
        ...
        public static void AssertModel(BytesmallintListD12MIWA actual, BytesmallintListD12MI expect, bool checkInInnerOnlyId)
        {
