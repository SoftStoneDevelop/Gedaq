...
namespace Tests
{
    public class FlatNpgsqlPathpathArray2M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathArray2M actual, NpgsqlPathpathArray2M expect, bool checkInInnerOnlyId)
        {
