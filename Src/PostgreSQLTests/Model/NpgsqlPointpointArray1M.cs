...
namespace Tests
{
    public class NpgsqlPointpointArray1M
    {
        public System.Int32 Id { get; set; }

        public NpgsqlTypes.NpgsqlPoint[] Value { get; set; }

        public NpgsqlPointpointArray1MI ModelInner { get; set; }

        public NpgsqlTypes.NpgsqlPoint[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointArray1M actual, NpgsqlPointpointArray1M expect, bool checkInInnerOnlyId)
        {
