...
namespace Tests
{
    public class NpgsqlPointpointMMArrayD1E1MI
    {
        ...
        public static void AssertModel(NpgsqlPointpointMMArrayD1E1MI actual, NpgsqlPointpointMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
