...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleMArrayD11MIWA actual, NpgsqlCirclecircleMArrayD11MI expect, bool checkInInnerOnlyId)
        {
