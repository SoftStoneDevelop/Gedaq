...
namespace Tests
{
    public class NpgsqlPolygonpolygonListD1E2MIWA
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonListD1E2MIWA actual, NpgsqlPolygonpolygonListD1E2MI expect, bool checkInInnerOnlyId)
        {
