...
namespace Tests
{
    public class FlatInt32integerMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt32integerMMArrayD1E1M actual, Int32integerMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
