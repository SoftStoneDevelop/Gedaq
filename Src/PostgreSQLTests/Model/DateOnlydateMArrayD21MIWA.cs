...
namespace Tests
{
    public class DateOnlydateMArrayD21MIWA
    {
        ...
        public static void AssertModel(DateOnlydateMArrayD21MIWA actual, DateOnlydateMArrayD21MI expect, bool checkInInnerOnlyId)
        {
