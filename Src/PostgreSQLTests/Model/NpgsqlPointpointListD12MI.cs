...
namespace Tests
{
    public class NpgsqlPointpointListD12MI
    {
        ...
        public static void AssertModel(NpgsqlPointpointListD12MI actual, NpgsqlPointpointListD12MI expect, bool checkInInnerOnlyId)
        {
