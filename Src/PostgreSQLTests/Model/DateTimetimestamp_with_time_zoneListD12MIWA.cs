...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneListD12MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneListD12MIWA actual, DateTimetimestamp_with_time_zoneListD12MI expect, bool checkInInnerOnlyId)
        {
