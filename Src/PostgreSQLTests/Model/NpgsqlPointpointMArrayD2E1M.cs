...
namespace Tests
{
    public class NpgsqlPointpointMArrayD2E1M
    {
        ...
        public NpgsqlPointpointMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPoint[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointMArrayD2E1M actual, NpgsqlPointpointMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
