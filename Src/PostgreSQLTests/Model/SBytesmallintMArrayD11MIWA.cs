...
namespace Tests
{
    public class SBytesmallintMArrayD11MIWA
    {
        ...
        public static void AssertModel(SBytesmallintMArrayD11MIWA actual, SBytesmallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
