...
namespace Tests
{
    public class NpgsqlPointpointE0MIWA
    {
        ...
        public static void AssertModel(NpgsqlPointpointE0MIWA actual, NpgsqlPointpointE0MI expect, bool checkInInnerOnlyId)
        {
