...
namespace Tests
{
    public class CharcharE0M
    {
        ...
        public static void AssertModel(CharcharE0M actual, CharcharE0M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Char)default));
