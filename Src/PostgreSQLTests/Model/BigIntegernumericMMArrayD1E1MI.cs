...
namespace Tests
{
    public class BigIntegernumericMMArrayD1E1MI
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD1E1MI actual, BigIntegernumericMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
