...
namespace Tests
{
    public class FlatGuiduuidMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatGuiduuidMMArrayD2E1M actual, GuiduuidMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
