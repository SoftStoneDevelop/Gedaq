...
namespace Tests
{
    public class SinglerealMArrayD21MIWA
    {
        ...
        public static void AssertModel(SinglerealMArrayD21MIWA actual, SinglerealMArrayD21MI expect, bool checkInInnerOnlyId)
        {
