...
namespace Tests
{
    public class BooleanbooleanMArrayD1E1M
    {
        ...
        public BooleanbooleanMArrayD11MI ModelInner { get; set; }

        
        public System.Boolean[] NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanMArrayD1E1M actual, BooleanbooleanMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
