...
namespace Tests
{
    public class SBytesmallintMArrayD2E1M
    {
        ...
        public SBytesmallintMArrayD21MI ModelInner { get; set; }

        
        public System.SByte[,] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintMArrayD2E1M actual, SBytesmallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
