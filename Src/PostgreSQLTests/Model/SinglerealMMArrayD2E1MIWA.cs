...
namespace Tests
{
    public class SinglerealMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(SinglerealMMArrayD2E1MIWA actual, SinglerealMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
