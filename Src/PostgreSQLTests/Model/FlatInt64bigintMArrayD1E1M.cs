...
namespace Tests
{
    public class FlatInt64bigintMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt64bigintMArrayD1E1M actual, Int64bigintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
