...
namespace Tests
{
    public class FlatSinglerealMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatSinglerealMMArrayD1E1M actual, SinglerealMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
