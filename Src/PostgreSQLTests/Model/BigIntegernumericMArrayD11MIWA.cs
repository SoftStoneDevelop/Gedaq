...
namespace Tests
{
    public class BigIntegernumericMArrayD11MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericMArrayD11MIWA actual, BigIntegernumericMArrayD11MI expect, bool checkInInnerOnlyId)
        {
