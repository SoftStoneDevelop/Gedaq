...
namespace Tests
{
    public class DecimalnumericMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD1E1MIWA actual, DecimalnumericMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
