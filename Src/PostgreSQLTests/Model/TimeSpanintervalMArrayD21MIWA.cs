...
namespace Tests
{
    public class TimeSpanintervalMArrayD21MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalMArrayD21MIWA actual, TimeSpanintervalMArrayD21MI expect, bool checkInInnerOnlyId)
        {
