...
namespace Tests
{
    public class FlatTimeSpanintervalMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalMArrayD1E1M actual, TimeSpanintervalMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
