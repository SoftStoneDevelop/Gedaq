...
namespace Tests
{
    public class NpgsqlPointpointMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlPointpointMArrayD21MIWA actual, NpgsqlPointpointMArrayD21MI expect, bool checkInInnerOnlyId)
        {
