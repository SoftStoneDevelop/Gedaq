...
namespace Tests
{
    public class BigIntegernumericMMArrayD2E1M
    {
        ...
        public BigIntegernumericMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger[,] NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericMMArrayD2E1M actual, BigIntegernumericMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
