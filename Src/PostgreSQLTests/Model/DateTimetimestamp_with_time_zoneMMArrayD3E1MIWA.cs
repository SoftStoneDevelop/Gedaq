...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMMArrayD3E1MIWA actual, DateTimetimestamp_with_time_zoneMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
