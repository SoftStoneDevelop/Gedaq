...
namespace Tests
{
    public class FlatGuiduuidMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatGuiduuidMMArrayD1E1M actual, GuiduuidMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
