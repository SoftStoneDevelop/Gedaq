...
namespace Tests
{
    public class FlatInt64bigintMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatInt64bigintMMArrayD3E1M actual, Int64bigintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
