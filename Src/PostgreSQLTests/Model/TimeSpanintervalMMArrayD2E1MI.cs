...
namespace Tests
{
    public class TimeSpanintervalMMArrayD2E1MI
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD2E1MI actual, TimeSpanintervalMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
