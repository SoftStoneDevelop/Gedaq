...
namespace Tests
{
    public class SBytesmallintMMArrayD2E1MI
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD2E1MI actual, SBytesmallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
