...
namespace Tests
{
    public class FlatNpgsqlBoxboxMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlBoxboxMMArrayD2E1M actual, NpgsqlBoxboxMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
