...
namespace Tests
{
    public class DecimalmoneyMMArrayD3E1MI
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD3E1MI actual, DecimalmoneyMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
