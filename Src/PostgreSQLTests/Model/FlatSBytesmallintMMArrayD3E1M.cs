...
namespace Tests
{
    public class FlatSBytesmallintMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintMMArrayD3E1M actual, SBytesmallintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
