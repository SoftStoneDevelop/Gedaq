...
namespace Tests
{
    public class DateOnlydateMArrayD2E1M
    {
        ...
        public DateOnlydateMArrayD21MI ModelInner { get; set; }

        
        public System.DateOnly[,] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateMArrayD2E1M actual, DateOnlydateMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
