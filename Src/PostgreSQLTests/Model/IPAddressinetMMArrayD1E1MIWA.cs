...
namespace Tests
{
    public class IPAddressinetMMArrayD1E1MIWA
    {
        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(9))]
        [Gedaq.Common.Attributes.Alias(order: 0)]
        public System.Int32 Id { get; set; }

        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(-2147483624))]
        ...
        public static void AssertModel(IPAddressinetMMArrayD1E1MIWA actual, IPAddressinetMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
