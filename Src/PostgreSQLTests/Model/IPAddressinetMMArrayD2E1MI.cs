...
namespace Tests
{
    public class IPAddressinetMMArrayD2E1MI
    {
        ...
        public static void AssertModel(IPAddressinetMMArrayD2E1MI actual, IPAddressinetMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
