...
namespace Tests
{
    public class FlatTimeSpanintervalMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalMMArrayD3E1M actual, TimeSpanintervalMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
