...
namespace Tests
{
    public class NpgsqlIntervalintervalArray2MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalArray2MI actual, NpgsqlIntervalintervalArray2MI expect, bool checkInInnerOnlyId)
        {
