...
namespace Tests
{
    public class SBytesmallintMMArrayD3E1MI
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD3E1MI actual, SBytesmallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
