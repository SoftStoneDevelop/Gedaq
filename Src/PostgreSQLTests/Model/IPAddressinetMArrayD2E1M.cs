...
namespace Tests
{
    public class IPAddressinetMArrayD2E1M
    {
        ...
        public IPAddressinetMArrayD21MI ModelInner { get; set; }

        
        public System.Net.IPAddress[,] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetMArrayD2E1M actual, IPAddressinetMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
