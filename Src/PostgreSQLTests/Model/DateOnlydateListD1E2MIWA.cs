...
namespace Tests
{
    public class DateOnlydateListD1E2MIWA
    {
        ...
        public static void AssertModel(DateOnlydateListD1E2MIWA actual, DateOnlydateListD1E2MI expect, bool checkInInnerOnlyId)
        {
