...
namespace Tests
{
    public class DecimalnumericMMArrayD2E1MI
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD2E1MI actual, DecimalnumericMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
