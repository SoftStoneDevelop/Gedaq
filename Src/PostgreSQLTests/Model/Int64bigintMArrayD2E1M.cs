...
namespace Tests
{
    public class Int64bigintMArrayD2E1M
    {
        ...
        public Int64bigintMArrayD21MI ModelInner { get; set; }

        
        public System.Int64[,] NullableValue { get; set; }

        public static void AssertModel(Int64bigintMArrayD2E1M actual, Int64bigintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
