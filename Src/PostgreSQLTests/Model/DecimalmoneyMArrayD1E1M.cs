...
namespace Tests
{
    public class DecimalmoneyMArrayD1E1M
    {
        ...
        public DecimalmoneyMArrayD11MI ModelInner { get; set; }

        
        public System.Decimal[] NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyMArrayD1E1M actual, DecimalmoneyMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
