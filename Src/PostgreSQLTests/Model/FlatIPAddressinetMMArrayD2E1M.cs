...
namespace Tests
{
    public class FlatIPAddressinetMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetMMArrayD2E1M actual, IPAddressinetMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
