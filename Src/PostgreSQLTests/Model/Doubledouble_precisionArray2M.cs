...
namespace Tests
{
    public class Doubledouble_precisionArray2M
    {
        ...
        public Doubledouble_precisionArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Double> NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionArray2M actual, Doubledouble_precisionArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Double>)default));
