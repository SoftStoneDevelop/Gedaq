...
namespace Tests
{
    public class DecimalnumericMArrayD11MI
    {
        ...
        public static void AssertModel(DecimalnumericMArrayD11MI actual, DecimalnumericMArrayD11MI expect, bool checkInInnerOnlyId)
        {
