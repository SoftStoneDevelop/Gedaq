...
namespace Tests
{
    public class SinglerealListD1E2M
    {
        ...
        public SinglerealListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Single> NullableValue { get; set; }

        public static void AssertModel(SinglerealListD1E2M actual, SinglerealListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Single>)default));
