...
namespace Tests
{
    public class FlatBigIntegernumericMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBigIntegernumericMMArrayD1E1M actual, BigIntegernumericMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
