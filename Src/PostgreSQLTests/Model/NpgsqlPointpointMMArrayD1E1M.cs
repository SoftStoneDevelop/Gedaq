...
namespace Tests
{
    public class NpgsqlPointpointMMArrayD1E1M
    {
        ...
        public NpgsqlPointpointMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPoint[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointMMArrayD1E1M actual, NpgsqlPointpointMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
