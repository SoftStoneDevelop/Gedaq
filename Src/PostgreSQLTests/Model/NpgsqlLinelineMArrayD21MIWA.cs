...
namespace Tests
{
    public class NpgsqlLinelineMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineMArrayD21MIWA actual, NpgsqlLinelineMArrayD21MI expect, bool checkInInnerOnlyId)
        {
