...
namespace Tests
{
    public class BooleanbooleanListD1E2M
    {
        ...
        public static void AssertModel(BooleanbooleanListD1E2M actual, BooleanbooleanListD1E2M expect, bool checkInInnerOnlyId)
        {
