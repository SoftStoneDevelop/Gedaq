...
namespace Tests
{
    public class GuiduuidMArrayD1E1M
    {
        ...
        public GuiduuidMArrayD11MI ModelInner { get; set; }

        
        public System.Guid[] NullableValue { get; set; }

        public static void AssertModel(GuiduuidMArrayD1E1M actual, GuiduuidMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
