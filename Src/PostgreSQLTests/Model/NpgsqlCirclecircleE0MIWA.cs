...
namespace Tests
{
    public class NpgsqlCirclecircleE0MIWA
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleE0MIWA actual, NpgsqlCirclecircleE0MI expect, bool checkInInnerOnlyId)
        {
