...
namespace Tests
{
    public class SinglerealMMArrayD1E1M
    {
        ...
        public SinglerealMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Single[] NullableValue { get; set; }

        public static void AssertModel(SinglerealMMArrayD1E1M actual, SinglerealMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
