...
namespace Tests
{
    public class FlatDoubledouble_precisionArray2M
    {
        ...
        public static void AssertModel(FlatDoubledouble_precisionArray2M actual, Doubledouble_precisionArray2M expect, bool checkInInnerOnlyId)
        {
