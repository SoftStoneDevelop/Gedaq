...
namespace Tests
{
    public class DateOnlydateMArrayD11MIWA
    {
        ...
        public static void AssertModel(DateOnlydateMArrayD11MIWA actual, DateOnlydateMArrayD11MI expect, bool checkInInnerOnlyId)
        {
