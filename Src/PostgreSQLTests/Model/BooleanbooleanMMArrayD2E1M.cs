...
namespace Tests
{
    public class BooleanbooleanMMArrayD2E1M
    {
        ...
        public BooleanbooleanMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Boolean[,] NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanMMArrayD2E1M actual, BooleanbooleanMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
