...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD1E1M
    {
        ...
        public NpgsqlPolygonpolygonMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPolygon[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonMArrayD1E1M actual, NpgsqlPolygonpolygonMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
