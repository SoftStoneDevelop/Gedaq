...
namespace Tests
{
    public class Int64bigintMMArrayD2E1MI
    {
        ...
        public static void AssertModel(Int64bigintMMArrayD2E1MI actual, Int64bigintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
