...
namespace Tests
{
    public class FlatBigIntegernumericMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBigIntegernumericMArrayD1E1M actual, BigIntegernumericMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
