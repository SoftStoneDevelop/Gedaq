...
namespace Tests
{
    public class NpgsqlPathpathListD1E2MI
    {
        ...
        public static void AssertModel(NpgsqlPathpathListD1E2MI actual, NpgsqlPathpathListD1E2MI expect, bool checkInInnerOnlyId)
        {
