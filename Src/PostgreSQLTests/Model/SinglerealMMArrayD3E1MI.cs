...
namespace Tests
{
    public class SinglerealMMArrayD3E1MI
    {
        ...
        public static void AssertModel(SinglerealMMArrayD3E1MI actual, SinglerealMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
