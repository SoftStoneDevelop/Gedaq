...
namespace Tests
{
    public class IPAddressinetArray1MIWA
    {
        ...
        public static void AssertModel(IPAddressinetArray1MIWA actual, IPAddressinetArray1MI expect, bool checkInInnerOnlyId)
        {
