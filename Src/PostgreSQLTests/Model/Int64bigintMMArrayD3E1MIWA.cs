...
namespace Tests
{
    public class Int64bigintMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(Int64bigintMMArrayD3E1MIWA actual, Int64bigintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
