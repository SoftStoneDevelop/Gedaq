...
namespace Tests
{
    public class SBytesmallintMMArrayD1E1M
    {
        ...
        public SBytesmallintMMArrayD1E1MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintMMArrayD1E1M actual, SBytesmallintMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
