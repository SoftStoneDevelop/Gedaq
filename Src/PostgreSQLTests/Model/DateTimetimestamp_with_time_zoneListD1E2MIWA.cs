...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneListD1E2MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneListD1E2MIWA actual, DateTimetimestamp_with_time_zoneListD1E2MI expect, bool checkInInnerOnlyId)
        {
