...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneArray2MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneArray2MIWA actual, DateTimetimestamp_with_time_zoneArray2MI expect, bool checkInInnerOnlyId)
        {
