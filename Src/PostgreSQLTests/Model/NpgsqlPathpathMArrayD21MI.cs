...
namespace Tests
{
    public class NpgsqlPathpathMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlPathpathMArrayD21MI actual, NpgsqlPathpathMArrayD21MI expect, bool checkInInnerOnlyId)
        {
