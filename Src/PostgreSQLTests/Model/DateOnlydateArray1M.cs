...
namespace Tests
{
    public class DateOnlydateArray1M
    {
        ...
        public DateOnlydateArray1MI ModelInner { get; set; }

        
        public System.DateOnly[] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateArray1M actual, DateOnlydateArray1M expect, bool checkInInnerOnlyId)
        {
