...
namespace Tests
{
    public class SBytesmallintMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD2E1MIWA actual, SBytesmallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
