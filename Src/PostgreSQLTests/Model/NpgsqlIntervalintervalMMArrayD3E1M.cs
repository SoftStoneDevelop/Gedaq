...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD3E1M
    {
        ...
        public NpgsqlIntervalintervalMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlInterval[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalMMArrayD3E1M actual, NpgsqlIntervalintervalMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
