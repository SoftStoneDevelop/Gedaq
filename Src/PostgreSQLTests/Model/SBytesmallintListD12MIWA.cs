...
namespace Tests
{
    public class SBytesmallintListD12MIWA
    {
        ...
        public static void AssertModel(SBytesmallintListD12MIWA actual, SBytesmallintListD12MI expect, bool checkInInnerOnlyId)
        {
