...
namespace Tests
{
    public class DateOnlydateMMArrayD3E1M
    {
        ...
        public DateOnlydateMMArrayD3E1MI ModelInner { get; set; }

        
        public System.DateOnly[,,] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateMMArrayD3E1M actual, DateOnlydateMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
