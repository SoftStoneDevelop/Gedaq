...
namespace Tests
{
    public class Doubledouble_precision0MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precision0MIWA actual, Doubledouble_precision0MI expect, bool checkInInnerOnlyId)
        {
