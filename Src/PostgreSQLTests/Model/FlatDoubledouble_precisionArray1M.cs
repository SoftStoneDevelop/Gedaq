...
namespace Tests
{
    public class FlatDoubledouble_precisionArray1M
    {
        ...
        public static void AssertModel(FlatDoubledouble_precisionArray1M actual, Doubledouble_precisionArray1M expect, bool checkInInnerOnlyId)
        {
