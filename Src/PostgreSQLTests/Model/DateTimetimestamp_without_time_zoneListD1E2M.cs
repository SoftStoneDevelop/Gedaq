...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneListD1E2M
    {
        ...
        public DateTimetimestamp_without_time_zoneListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.DateTime> NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_without_time_zoneListD1E2M actual, DateTimetimestamp_without_time_zoneListD1E2M expect, bool checkInInnerOnlyId)
        {
