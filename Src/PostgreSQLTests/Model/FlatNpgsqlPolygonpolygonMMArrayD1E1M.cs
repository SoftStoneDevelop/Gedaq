...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonMMArrayD1E1M actual, NpgsqlPolygonpolygonMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
