...
namespace Tests
{
    public class Doubledouble_precisionListD1E2MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precisionListD1E2MIWA actual, Doubledouble_precisionListD1E2MI expect, bool checkInInnerOnlyId)
        {
