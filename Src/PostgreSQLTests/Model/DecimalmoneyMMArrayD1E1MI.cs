...
namespace Tests
{
    public class DecimalmoneyMMArrayD1E1MI
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD1E1MI actual, DecimalmoneyMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
