...
namespace Tests
{
    public class StringtextMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(StringtextMMArrayD2E1MIWA actual, StringtextMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
