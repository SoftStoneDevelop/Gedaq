...
namespace Tests
{
    public class BigIntegernumericListD1E2M
    {
        ...
        public static void AssertModel(BigIntegernumericListD1E2M actual, BigIntegernumericListD1E2M expect, bool checkInInnerOnlyId)
        {
