...
namespace Tests
{
    public class FlatDateOnlydateMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatDateOnlydateMMArrayD3E1M actual, DateOnlydateMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
