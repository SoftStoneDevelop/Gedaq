...
namespace Tests
{
    public class IPAddressinetMArrayD11MI
    {
        ...
        public static void AssertModel(IPAddressinetMArrayD11MI actual, IPAddressinetMArrayD11MI expect, bool checkInInnerOnlyId)
        {
