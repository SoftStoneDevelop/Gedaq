...
namespace Tests
{
    public class Int32integerE0M
    {
        ...
        public Int32integerE0MI ModelInner { get; set; }

        
        public System.Int32? NullableValue { get; set; }

        public static void AssertModel(Int32integerE0M actual, Int32integerE0M expect, bool checkInInnerOnlyId)
        {
