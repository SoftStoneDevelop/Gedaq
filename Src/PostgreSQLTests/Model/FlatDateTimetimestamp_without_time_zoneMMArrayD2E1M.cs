...
namespace Tests
{
    public class FlatDateTimetimestamp_without_time_zoneMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDateTimetimestamp_without_time_zoneMMArrayD2E1M actual, DateTimetimestamp_without_time_zoneMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
