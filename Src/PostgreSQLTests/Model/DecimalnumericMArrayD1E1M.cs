...
namespace Tests
{
    public class DecimalnumericMArrayD1E1M
    {
        ...
        public DecimalnumericMArrayD11MI ModelInner { get; set; }

        
        public System.Decimal[] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericMArrayD1E1M actual, DecimalnumericMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
