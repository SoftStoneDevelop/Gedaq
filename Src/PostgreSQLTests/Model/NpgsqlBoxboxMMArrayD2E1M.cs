...
namespace Tests
{
    public class NpgsqlBoxboxMMArrayD2E1M
    {
        ...
        public NpgsqlBoxboxMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlBox[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlBoxboxMMArrayD2E1M actual, NpgsqlBoxboxMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
