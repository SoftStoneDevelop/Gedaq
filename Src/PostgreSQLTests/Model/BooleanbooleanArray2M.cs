...
namespace Tests
{
    public class BooleanbooleanArray2M
    {
        ...
        public BooleanbooleanArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Boolean> NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanArray2M actual, BooleanbooleanArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Boolean>)default));
