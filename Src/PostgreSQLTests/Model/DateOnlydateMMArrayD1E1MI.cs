...
namespace Tests
{
    public class DateOnlydateMMArrayD1E1MI
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD1E1MI actual, DateOnlydateMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
