...
namespace Tests
{
    public class FlatNpgsqlPointpointMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPointpointMArrayD1E1M actual, NpgsqlPointpointMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
