...
namespace Tests
{
    public class BigIntegernumericMArrayD11MI
    {
        ...
        public static void AssertModel(BigIntegernumericMArrayD11MI actual, BigIntegernumericMArrayD11MI expect, bool checkInInnerOnlyId)
        {
