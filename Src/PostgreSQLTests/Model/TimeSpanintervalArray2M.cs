...
namespace Tests
{
    public class TimeSpanintervalArray2M
    {
        ...
        public TimeSpanintervalArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.TimeSpan> NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalArray2M actual, TimeSpanintervalArray2M expect, bool checkInInnerOnlyId)
        {
