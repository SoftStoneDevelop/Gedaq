...
namespace Tests
{
    public class BooleanbooleanMMArrayD3E1MI
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD3E1MI actual, BooleanbooleanMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
