...
namespace Tests
{
    public class FlatDecimalnumericMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericMArrayD1E1M actual, DecimalnumericMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
