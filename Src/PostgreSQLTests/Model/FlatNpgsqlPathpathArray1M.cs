...
namespace Tests
{
    public class FlatNpgsqlPathpathArray1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathArray1M actual, NpgsqlPathpathArray1M expect, bool checkInInnerOnlyId)
        {
