...
namespace Tests
{
    public class BigIntegernumericMMArrayD1E1M
    {
        ...
        public BigIntegernumericMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger[] NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericMMArrayD1E1M actual, BigIntegernumericMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Numerics.BigInteger[])default));
