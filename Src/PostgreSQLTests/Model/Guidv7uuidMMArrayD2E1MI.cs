...
namespace Tests
{
    public class Guidv7uuidMMArrayD2E1MI
    {
        ...
        public static void AssertModel(Guidv7uuidMMArrayD2E1MI actual, Guidv7uuidMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
