...
namespace Tests
{
    public class DecimalnumericMArrayD21MI
    {
        ...
        public static void AssertModel(DecimalnumericMArrayD21MI actual, DecimalnumericMArrayD21MI expect, bool checkInInnerOnlyId)
        {
