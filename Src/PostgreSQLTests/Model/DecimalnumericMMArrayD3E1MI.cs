...
namespace Tests
{
    public class DecimalnumericMMArrayD3E1MI
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD3E1MI actual, DecimalnumericMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
