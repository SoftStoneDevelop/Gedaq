...
namespace Tests
{
    public class DecimalmoneyMMArrayD2E1M
    {
        ...
        public DecimalmoneyMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Decimal[,] NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyMMArrayD2E1M actual, DecimalmoneyMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
