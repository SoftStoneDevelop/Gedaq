...
namespace Tests
{
    public class TimeOnlytime_without_time_zone0MIWA
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zone0MIWA actual, TimeOnlytime_without_time_zone0MI expect, bool checkInInnerOnlyId)
        {
