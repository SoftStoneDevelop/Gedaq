...
namespace Tests
{
    public class BytesmallintMArrayD2E1M
    {
        ...
        public BytesmallintMArrayD21MI ModelInner { get; set; }

        
        public System.Byte[,] NullableValue { get; set; }

        public static void AssertModel(BytesmallintMArrayD2E1M actual, BytesmallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
