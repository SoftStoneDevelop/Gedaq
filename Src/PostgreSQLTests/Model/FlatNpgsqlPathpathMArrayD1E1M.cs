...
namespace Tests
{
    public class FlatNpgsqlPathpathMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathMArrayD1E1M actual, NpgsqlPathpathMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
