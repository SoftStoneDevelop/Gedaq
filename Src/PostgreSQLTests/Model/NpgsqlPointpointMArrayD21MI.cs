...
namespace Tests
{
    public class NpgsqlPointpointMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlPointpointMArrayD21MI actual, NpgsqlPointpointMArrayD21MI expect, bool checkInInnerOnlyId)
        {
