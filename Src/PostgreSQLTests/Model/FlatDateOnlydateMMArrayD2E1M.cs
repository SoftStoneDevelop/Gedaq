...
namespace Tests
{
    public class FlatDateOnlydateMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDateOnlydateMMArrayD2E1M actual, DateOnlydateMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
