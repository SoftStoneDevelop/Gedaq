...
namespace Tests
{
    public class FlatInt64bigintMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt64bigintMMArrayD1E1M actual, Int64bigintMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
