...
namespace Tests
{
    public class NpgsqlBoxboxMMArrayD1E1M
    {
        ...
        public NpgsqlBoxboxMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlBox[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlBoxboxMMArrayD1E1M actual, NpgsqlBoxboxMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((NpgsqlTypes.NpgsqlBox[])default));
