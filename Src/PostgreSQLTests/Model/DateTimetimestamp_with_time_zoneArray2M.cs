...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneArray2M
    {
        ...
        public DateTimetimestamp_with_time_zoneArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.DateTime> NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_with_time_zoneArray2M actual, DateTimetimestamp_with_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
