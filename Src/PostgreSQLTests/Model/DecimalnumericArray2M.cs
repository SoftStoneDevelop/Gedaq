...
namespace Tests
{
    public class DecimalnumericArray2M
    {
        ...
        public DecimalnumericArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Decimal> NullableValue { get; set; }

        public static void AssertModel(DecimalnumericArray2M actual, DecimalnumericArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Decimal>)default));
