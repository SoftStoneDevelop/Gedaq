...
namespace Tests
{
    public class BooleanbooleanMArrayD2E1M
    {
        ...
        public BooleanbooleanMArrayD21MI ModelInner { get; set; }

        
        public System.Boolean[,] NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanMArrayD2E1M actual, BooleanbooleanMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
