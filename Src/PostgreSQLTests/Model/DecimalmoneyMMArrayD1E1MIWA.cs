...
namespace Tests
{
    public class DecimalmoneyMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD1E1MIWA actual, DecimalmoneyMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
