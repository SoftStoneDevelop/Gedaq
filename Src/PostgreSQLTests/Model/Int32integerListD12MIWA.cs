...
namespace Tests
{
    public class Int32integerListD12MIWA
    {
        ...
        public static void AssertModel(Int32integerListD12MIWA actual, Int32integerListD12MI expect, bool checkInInnerOnlyId)
        {
