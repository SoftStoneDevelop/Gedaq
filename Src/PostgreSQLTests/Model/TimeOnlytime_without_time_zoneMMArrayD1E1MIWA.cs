...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMMArrayD1E1MIWA actual, TimeOnlytime_without_time_zoneMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
