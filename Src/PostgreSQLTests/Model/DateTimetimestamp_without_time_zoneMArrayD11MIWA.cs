...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMArrayD11MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMArrayD11MIWA actual, DateTimetimestamp_without_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
