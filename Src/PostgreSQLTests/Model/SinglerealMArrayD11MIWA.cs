...
namespace Tests
{
    public class SinglerealMArrayD11MIWA
    {
        ...
        public static void AssertModel(SinglerealMArrayD11MIWA actual, SinglerealMArrayD11MI expect, bool checkInInnerOnlyId)
        {
