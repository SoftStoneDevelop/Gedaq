...
namespace Tests
{
    public class NpgsqlLinelineArray2M
    {
        public System.Int32 Id { get; set; }

        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlLine> Value { get; set; }

        public NpgsqlLinelineArray2MI ModelInner { get; set; }

        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlLine> NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineArray2M actual, NpgsqlLinelineArray2M expect, bool checkInInnerOnlyId)
        {
