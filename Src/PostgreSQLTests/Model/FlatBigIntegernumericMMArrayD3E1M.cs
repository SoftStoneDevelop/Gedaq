...
namespace Tests
{
    public class FlatBigIntegernumericMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatBigIntegernumericMMArrayD3E1M actual, BigIntegernumericMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
