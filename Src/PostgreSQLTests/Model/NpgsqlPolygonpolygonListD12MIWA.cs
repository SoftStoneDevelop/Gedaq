...
namespace Tests
{
    public class NpgsqlPolygonpolygonListD12MIWA
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonListD12MIWA actual, NpgsqlPolygonpolygonListD12MI expect, bool checkInInnerOnlyId)
        {
