...
namespace Tests
{
    public class DecimalnumericListD1E2MIWA
    {
        ...
        public static void AssertModel(DecimalnumericListD1E2MIWA actual, DecimalnumericListD1E2MI expect, bool checkInInnerOnlyId)
        {
