...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonMArrayD1E1M actual, NpgsqlPolygonpolygonMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
