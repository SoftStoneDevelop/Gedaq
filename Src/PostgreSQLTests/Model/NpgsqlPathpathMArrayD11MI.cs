...
namespace Tests
{
    public class NpgsqlPathpathMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlPathpathMArrayD11MI actual, NpgsqlPathpathMArrayD11MI expect, bool checkInInnerOnlyId)
        {
