...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMArrayD11MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMArrayD11MIWA actual, DateTimetimestamp_with_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
