...
namespace Tests
{
    public class Guidv7uuidE0M
    {
        ...
        public Guidv7uuidE0MI ModelInner { get; set; }

        
        public System.Guid? NullableValue { get; set; }

        public static void AssertModel(Guidv7uuidE0M actual, Guidv7uuidE0M expect, bool checkInInnerOnlyId)
        {
