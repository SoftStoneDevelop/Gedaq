...
namespace Tests
{
    public class FlatSBytesmallintMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintMArrayD1E1M actual, SBytesmallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
