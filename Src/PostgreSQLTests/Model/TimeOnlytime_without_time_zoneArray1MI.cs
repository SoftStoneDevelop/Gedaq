...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneArray1MI
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneArray1MI actual, TimeOnlytime_without_time_zoneArray1MI expect, bool checkInInnerOnlyId)
        {
