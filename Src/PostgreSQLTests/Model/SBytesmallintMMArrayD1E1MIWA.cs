...
namespace Tests
{
    public class SBytesmallintMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD1E1MIWA actual, SBytesmallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
