...
namespace Tests
{
    public class FlatInt64bigintMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt64bigintMArrayD2E1M actual, Int64bigintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
