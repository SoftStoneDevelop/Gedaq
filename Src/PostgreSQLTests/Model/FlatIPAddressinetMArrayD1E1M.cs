...
namespace Tests
{
    public class FlatIPAddressinetMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetMArrayD1E1M actual, IPAddressinetMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
