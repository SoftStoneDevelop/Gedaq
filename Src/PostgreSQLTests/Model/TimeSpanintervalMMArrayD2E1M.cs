...
namespace Tests
{
    public class TimeSpanintervalMMArrayD2E1M
    {
        ...
        public TimeSpanintervalMMArrayD2E1MI ModelInner { get; set; }

        
        public System.TimeSpan[,] NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalMMArrayD2E1M actual, TimeSpanintervalMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
