...
namespace Tests
{
    public class IPAddressinetMArrayD21MI
    {
        ...
        public static void AssertModel(IPAddressinetMArrayD21MI actual, IPAddressinetMArrayD21MI expect, bool checkInInnerOnlyId)
        {
