...
namespace Tests
{
    public class IPAddressinetMMArrayD3E1MI
    {
        ...
        public static void AssertModel(IPAddressinetMMArrayD3E1MI actual, IPAddressinetMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
