...
namespace Tests
{
    public class BigIntegernumericMMArrayD3E1M
    {
        ...
        public BigIntegernumericMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger[,,] NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericMMArrayD3E1M actual, BigIntegernumericMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
