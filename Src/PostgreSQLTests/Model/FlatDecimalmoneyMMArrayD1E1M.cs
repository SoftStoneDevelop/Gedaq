...
namespace Tests
{
    public class FlatDecimalmoneyMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDecimalmoneyMMArrayD1E1M actual, DecimalmoneyMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
