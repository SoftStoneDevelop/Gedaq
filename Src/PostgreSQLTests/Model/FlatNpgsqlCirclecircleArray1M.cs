...
namespace Tests
{
    public class FlatNpgsqlCirclecircleArray1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleArray1M actual, NpgsqlCirclecircleArray1M expect, bool checkInInnerOnlyId)
        {
