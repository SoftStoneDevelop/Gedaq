...
namespace Tests
{
    public class Doubledouble_precisionMArrayD11MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precisionMArrayD11MIWA actual, Doubledouble_precisionMArrayD11MI expect, bool checkInInnerOnlyId)
        {
