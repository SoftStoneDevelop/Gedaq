...
namespace Tests
{
    public class FlatNpgsqlCirclecircleMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleMArrayD1E1M actual, NpgsqlCirclecircleMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
