...
namespace Tests
{
    public class NpgsqlPointpointMArrayD1E1M
    {
        ...
        public NpgsqlPointpointMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPoint[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointMArrayD1E1M actual, NpgsqlPointpointMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
