...
namespace Tests
{
    public class FlatBooleanbooleanMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanMMArrayD1E1M actual, BooleanbooleanMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
