...
namespace Tests
{
    public class FlatSBytesmallintMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintMMArrayD1E1M actual, SBytesmallintMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
