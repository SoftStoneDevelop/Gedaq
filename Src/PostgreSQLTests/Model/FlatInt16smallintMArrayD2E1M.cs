...
namespace Tests
{
    public class FlatInt16smallintMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt16smallintMArrayD2E1M actual, Int16smallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
