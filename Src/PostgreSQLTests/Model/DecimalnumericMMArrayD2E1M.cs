...
namespace Tests
{
    public class DecimalnumericMMArrayD2E1M
    {
        ...
        public DecimalnumericMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Decimal[,] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericMMArrayD2E1M actual, DecimalnumericMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
