...
namespace Tests
{
    public class NpgsqlCirclecircleMMArrayD1E1M
    {
        ...
        public NpgsqlCirclecircleMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleMMArrayD1E1M actual, NpgsqlCirclecircleMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((NpgsqlTypes.NpgsqlCircle[])default));
