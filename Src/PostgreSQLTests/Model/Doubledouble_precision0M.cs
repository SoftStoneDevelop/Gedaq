...
namespace Tests
{
    public class Doubledouble_precision0M
    {
        ...
        public static void AssertModel(Doubledouble_precision0M actual, Doubledouble_precision0M expect, bool checkInInnerOnlyId)
        {
