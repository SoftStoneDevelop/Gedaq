...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneListD12MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneListD12MIWA actual, DateTimetimestamp_without_time_zoneListD12MI expect, bool checkInInnerOnlyId)
        {
