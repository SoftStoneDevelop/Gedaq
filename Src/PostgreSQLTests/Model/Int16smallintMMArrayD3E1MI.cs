...
namespace Tests
{
    public class Int16smallintMMArrayD3E1MI
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD3E1MI actual, Int16smallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
