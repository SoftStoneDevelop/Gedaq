...
namespace Tests
{
    public class Int32integerMArrayD1E1M
    {
        ...
        public Int32integerMArrayD11MI ModelInner { get; set; }

        
        public System.Int32[] NullableValue { get; set; }

        public static void AssertModel(Int32integerMArrayD1E1M actual, Int32integerMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
