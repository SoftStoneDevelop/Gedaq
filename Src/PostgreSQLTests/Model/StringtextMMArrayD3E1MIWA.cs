...
namespace Tests
{
    public class StringtextMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(StringtextMMArrayD3E1MIWA actual, StringtextMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
