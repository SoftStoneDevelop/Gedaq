...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMMArrayD2E1MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMMArrayD2E1MI actual, DateTimetimestamp_without_time_zoneMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
