...
namespace Tests
{
    public class FlatSBytesmallintArray2M
    {
        ...
        public static void AssertModel(FlatSBytesmallintArray2M actual, SBytesmallintArray2M expect, bool checkInInnerOnlyId)
        {
