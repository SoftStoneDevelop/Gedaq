...
namespace Tests
{
    public class FlatSBytesmallintMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintMArrayD2E1M actual, SBytesmallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
