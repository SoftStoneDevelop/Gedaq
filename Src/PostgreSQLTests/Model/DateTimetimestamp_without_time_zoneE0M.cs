...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneE0M
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneE0M actual, DateTimetimestamp_without_time_zoneE0M expect, bool checkInInnerOnlyId)
        {
