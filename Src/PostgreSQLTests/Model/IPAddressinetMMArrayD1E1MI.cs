...
namespace Tests
{
    public class IPAddressinetMMArrayD1E1MI
    {
        ...
        public static void AssertModel(IPAddressinetMMArrayD1E1MI actual, IPAddressinetMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
