...
namespace Tests
{
    public class DateOnlydateMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD1E1MIWA actual, DateOnlydateMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
