...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMArrayD11MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMArrayD11MI actual, DateTimetimestamp_with_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
