...
namespace Tests
{
    public class GuiduuidMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(GuiduuidMMArrayD1E1MIWA actual, GuiduuidMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
