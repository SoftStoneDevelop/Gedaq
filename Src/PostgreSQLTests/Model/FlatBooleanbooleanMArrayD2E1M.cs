...
namespace Tests
{
    public class FlatBooleanbooleanMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanMArrayD2E1M actual, BooleanbooleanMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
