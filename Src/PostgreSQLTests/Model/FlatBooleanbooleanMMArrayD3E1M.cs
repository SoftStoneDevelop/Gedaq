...
namespace Tests
{
    public class FlatBooleanbooleanMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanMMArrayD3E1M actual, BooleanbooleanMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
