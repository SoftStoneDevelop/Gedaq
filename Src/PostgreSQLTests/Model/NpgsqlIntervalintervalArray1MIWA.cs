...
namespace Tests
{
    public class NpgsqlIntervalintervalArray1MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalArray1MIWA actual, NpgsqlIntervalintervalArray1MI expect, bool checkInInnerOnlyId)
        {
