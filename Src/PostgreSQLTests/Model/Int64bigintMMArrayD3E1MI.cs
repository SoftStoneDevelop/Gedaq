...
namespace Tests
{
    public class Int64bigintMMArrayD3E1MI
    {
        ...
        public static void AssertModel(Int64bigintMMArrayD3E1MI actual, Int64bigintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
