...
namespace Tests
{
    public class NpgsqlBoxboxMMArrayD3E1M
    {
        ...
        public NpgsqlBoxboxMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlBox[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlBoxboxMMArrayD3E1M actual, NpgsqlBoxboxMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
