...
namespace Tests
{
    public class BytesmallintMMArrayD2E1M
    {
        ...
        public BytesmallintMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Byte[,] NullableValue { get; set; }

        public static void AssertModel(BytesmallintMMArrayD2E1M actual, BytesmallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
