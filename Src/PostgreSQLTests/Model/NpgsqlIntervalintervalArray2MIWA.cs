...
namespace Tests
{
    public class NpgsqlIntervalintervalArray2MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalArray2MIWA actual, NpgsqlIntervalintervalArray2MI expect, bool checkInInnerOnlyId)
        {
