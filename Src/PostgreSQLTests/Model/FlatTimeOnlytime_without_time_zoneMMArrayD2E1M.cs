...
namespace Tests
{
    public class FlatTimeOnlytime_without_time_zoneMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatTimeOnlytime_without_time_zoneMMArrayD2E1M actual, TimeOnlytime_without_time_zoneMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
