...
namespace Tests
{
    public class GuiduuidMMArrayD2E1M
    {
        ...
        public GuiduuidMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(GuiduuidMMArrayD2E1M actual, GuiduuidMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
