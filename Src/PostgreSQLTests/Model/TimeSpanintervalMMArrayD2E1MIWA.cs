...
namespace Tests
{
    public class TimeSpanintervalMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD2E1MIWA actual, TimeSpanintervalMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
