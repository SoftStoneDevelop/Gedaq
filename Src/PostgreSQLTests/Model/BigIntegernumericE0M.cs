...
namespace Tests
{
    public class BigIntegernumericE0M
    {
        ...
        public BigIntegernumericE0MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger? NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericE0M actual, BigIntegernumericE0M expect, bool checkInInnerOnlyId)
        {
