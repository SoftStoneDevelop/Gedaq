...
namespace Tests
{
    public class Int32integerMMArrayD1E1M
    {
        ...
        public Int32integerMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Int32[] NullableValue { get; set; }

        public static void AssertModel(Int32integerMMArrayD1E1M actual, Int32integerMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
