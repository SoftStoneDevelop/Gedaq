...
namespace Tests
{
    public class NpgsqlPathpathMMArrayD1E1M
    {
        ...
        public NpgsqlPathpathMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPath[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPathpathMMArrayD1E1M actual, NpgsqlPathpathMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
