...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneE0M
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneE0M actual, TimeOnlytime_without_time_zoneE0M expect, bool checkInInnerOnlyId)
        {
