...
namespace Tests
{
    public class Doubledouble_precisionE0MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precisionE0MIWA actual, Doubledouble_precisionE0MI expect, bool checkInInnerOnlyId)
        {
