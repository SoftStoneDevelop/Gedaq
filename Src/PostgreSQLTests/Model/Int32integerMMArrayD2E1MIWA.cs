...
namespace Tests
{
    public class Int32integerMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(Int32integerMMArrayD2E1MIWA actual, Int32integerMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
