...
namespace Tests
{
    public class SBytesmallintE0M
    {
        ...
        public SBytesmallintE0MI ModelInner { get; set; }

        
        public System.SByte? NullableValue { get; set; }

        public static void AssertModel(SBytesmallintE0M actual, SBytesmallintE0M expect, bool checkInInnerOnlyId)
        {
