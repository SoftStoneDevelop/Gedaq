...
namespace Tests
{
    public class DecimalnumericListD1E2M
    {
        ...
        public static void AssertModel(DecimalnumericListD1E2M actual, DecimalnumericListD1E2M expect, bool checkInInnerOnlyId)
        {
