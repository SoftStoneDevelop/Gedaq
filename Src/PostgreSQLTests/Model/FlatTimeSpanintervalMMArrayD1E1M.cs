...
namespace Tests
{
    public class FlatTimeSpanintervalMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalMMArrayD1E1M actual, TimeSpanintervalMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
