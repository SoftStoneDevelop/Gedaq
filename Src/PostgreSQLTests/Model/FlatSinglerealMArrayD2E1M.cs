...
namespace Tests
{
    public class FlatSinglerealMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatSinglerealMArrayD2E1M actual, SinglerealMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
