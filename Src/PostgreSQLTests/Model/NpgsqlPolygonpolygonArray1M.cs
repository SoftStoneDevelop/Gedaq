...
namespace Tests
{
    public class NpgsqlPolygonpolygonArray1M
    {
        public System.Int32 Id { get; set; }

        public NpgsqlTypes.NpgsqlPolygon[] Value { get; set; }

        public NpgsqlPolygonpolygonArray1MI ModelInner { get; set; }

        public NpgsqlTypes.NpgsqlPolygon[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonArray1M actual, NpgsqlPolygonpolygonArray1M expect, bool checkInInnerOnlyId)
        {
