...
namespace Tests
{
    public class NpgsqlPolygonpolygonMMArrayD1E1M
    {
        ...
        public NpgsqlPolygonpolygonMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPolygon[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonMMArrayD1E1M actual, NpgsqlPolygonpolygonMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((NpgsqlTypes.NpgsqlPolygon[])default));
