...
namespace Tests
{
    public class Doubledouble_precisionListD1E2M
    {
        ...
        public static void AssertModel(Doubledouble_precisionListD1E2M actual, Doubledouble_precisionListD1E2M expect, bool checkInInnerOnlyId)
        {
