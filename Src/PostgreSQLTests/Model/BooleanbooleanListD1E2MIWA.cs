...
namespace Tests
{
    public class BooleanbooleanListD1E2MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanListD1E2MIWA actual, BooleanbooleanListD1E2MI expect, bool checkInInnerOnlyId)
        {
