...
namespace Tests
{
    public class NpgsqlLinelineMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlLinelineMArrayD21MI actual, NpgsqlLinelineMArrayD21MI expect, bool checkInInnerOnlyId)
        {
