...
namespace Tests
{
    public class Int64bigintListD1E2MIWA
    {
        ...
        public static void AssertModel(Int64bigintListD1E2MIWA actual, Int64bigintListD1E2MI expect, bool checkInInnerOnlyId)
        {
