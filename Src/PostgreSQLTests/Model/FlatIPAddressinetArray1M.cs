...
namespace Tests
{
    public class FlatIPAddressinetArray1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetArray1M actual, IPAddressinetArray1M expect, bool checkInInnerOnlyId)
        {
