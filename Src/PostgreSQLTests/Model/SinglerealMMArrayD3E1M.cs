...
namespace Tests
{
    public class SinglerealMMArrayD3E1M
    {
        ...
        public SinglerealMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Single[,,] NullableValue { get; set; }

        public static void AssertModel(SinglerealMMArrayD3E1M actual, SinglerealMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Single[,,])default));
