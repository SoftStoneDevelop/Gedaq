...
namespace Tests
{
    public class TimeSpanintervalListD1E2M
    {
        ...
        public TimeSpanintervalListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.TimeSpan> NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalListD1E2M actual, TimeSpanintervalListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.TimeSpan>)default));
