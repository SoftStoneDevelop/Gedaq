...
namespace Tests
{
    public class NpgsqlCirclecircleMMArrayD2E1M
    {
        ...
        public NpgsqlCirclecircleMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleMMArrayD2E1M actual, NpgsqlCirclecircleMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
