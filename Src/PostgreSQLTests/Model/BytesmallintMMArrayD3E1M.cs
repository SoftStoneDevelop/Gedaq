...
namespace Tests
{
    public class BytesmallintMMArrayD3E1M
    {
        ...
        public BytesmallintMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Byte[,,] NullableValue { get; set; }

        public static void AssertModel(BytesmallintMMArrayD3E1M actual, BytesmallintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
