...
namespace Tests
{
    public class SBytesmallintArray1M
    {
        ...
        public SBytesmallintArray1MI ModelInner { get; set; }

        
        public System.SByte[] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintArray1M actual, SBytesmallintArray1M expect, bool checkInInnerOnlyId)
        {
