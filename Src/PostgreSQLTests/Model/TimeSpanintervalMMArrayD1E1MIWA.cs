...
namespace Tests
{
    public class TimeSpanintervalMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD1E1MIWA actual, TimeSpanintervalMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
