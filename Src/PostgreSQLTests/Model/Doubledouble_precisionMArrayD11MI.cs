...
namespace Tests
{
    public class Doubledouble_precisionMArrayD11MI
    {
        ...
        public static void AssertModel(Doubledouble_precisionMArrayD11MI actual, Doubledouble_precisionMArrayD11MI expect, bool checkInInnerOnlyId)
        {
