...
namespace Tests
{
    public class FlatSinglerealMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatSinglerealMArrayD1E1M actual, SinglerealMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
