...
namespace Tests
{
    public class BigIntegernumericMArrayD21MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericMArrayD21MIWA actual, BigIntegernumericMArrayD21MI expect, bool checkInInnerOnlyId)
        {
