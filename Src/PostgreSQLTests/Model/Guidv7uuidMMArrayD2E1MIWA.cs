...
namespace Tests
{
    public class Guidv7uuidMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(Guidv7uuidMMArrayD2E1MIWA actual, Guidv7uuidMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
