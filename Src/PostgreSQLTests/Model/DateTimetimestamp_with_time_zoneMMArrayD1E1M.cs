...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMMArrayD1E1M
    {
        ...
        public DateTimetimestamp_with_time_zoneMMArrayD1E1MI ModelInner { get; set; }

        
        public System.DateTime[] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_with_time_zoneMMArrayD1E1M actual, DateTimetimestamp_with_time_zoneMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
