...
namespace Tests
{
    public class DecimalnumericMMArrayD1E1MI
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD1E1MI actual, DecimalnumericMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
