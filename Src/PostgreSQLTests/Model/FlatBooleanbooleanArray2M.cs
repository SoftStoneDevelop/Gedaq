...
namespace Tests
{
    public class FlatBooleanbooleanArray2M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanArray2M actual, BooleanbooleanArray2M expect, bool checkInInnerOnlyId)
        {
