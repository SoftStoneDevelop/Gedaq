...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMMArrayD1E1MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMMArrayD1E1MI actual, DateTimetimestamp_with_time_zoneMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
