...
namespace Tests
{
    public class NpgsqlLinelineMArrayD1E1M
    {
        ...
        public NpgsqlLinelineMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineMArrayD1E1M actual, NpgsqlLinelineMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
