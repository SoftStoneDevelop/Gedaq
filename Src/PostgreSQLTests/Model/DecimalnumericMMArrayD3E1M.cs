...
namespace Tests
{
    public class DecimalnumericMMArrayD3E1M
    {
        ...
        public DecimalnumericMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Decimal[,,] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericMMArrayD3E1M actual, DecimalnumericMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
