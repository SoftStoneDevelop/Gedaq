...
namespace Tests
{
    public class BooleanbooleanMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD2E1MIWA actual, BooleanbooleanMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
