...
namespace Tests
{
    public class FlatDateOnlydateMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDateOnlydateMArrayD2E1M actual, DateOnlydateMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
