...
namespace Tests
{
    public class Int64bigintMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(Int64bigintMMArrayD1E1MIWA actual, Int64bigintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
