...
namespace Tests
{
    public class NpgsqlIntervalintervalE0M
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalE0M actual, NpgsqlIntervalintervalE0M expect, bool checkInInnerOnlyId)
        {
