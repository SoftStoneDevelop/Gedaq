...
namespace Tests
{
    public class Int16smallintArray1MIWA
    {
        ...
        public static void AssertModel(Int16smallintArray1MIWA actual, Int16smallintArray1MI expect, bool checkInInnerOnlyId)
        {
