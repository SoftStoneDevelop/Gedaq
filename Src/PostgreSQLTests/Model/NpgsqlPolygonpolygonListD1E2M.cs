...
namespace Tests
{
    public class NpgsqlPolygonpolygonListD1E2M
    {
        ...
        public NpgsqlPolygonpolygonListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlPolygon> NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonListD1E2M actual, NpgsqlPolygonpolygonListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<NpgsqlTypes.NpgsqlPolygon>)default));
