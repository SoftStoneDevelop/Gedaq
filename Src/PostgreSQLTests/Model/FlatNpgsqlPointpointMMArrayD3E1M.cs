...
namespace Tests
{
    public class FlatNpgsqlPointpointMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPointpointMMArrayD3E1M actual, NpgsqlPointpointMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
