...
namespace Tests
{
    public class BytesmallintMArrayD11MI
    {
        ...
        public static void AssertModel(BytesmallintMArrayD11MI actual, BytesmallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
