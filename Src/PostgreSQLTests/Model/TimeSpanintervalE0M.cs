...
namespace Tests
{
    public class TimeSpanintervalE0M
    {
        ...
        public TimeSpanintervalE0MI ModelInner { get; set; }

        
        public System.TimeSpan? NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalE0M actual, TimeSpanintervalE0M expect, bool checkInInnerOnlyId)
        {
