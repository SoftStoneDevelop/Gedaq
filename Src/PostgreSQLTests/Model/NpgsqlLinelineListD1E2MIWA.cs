...
namespace Tests
{
    public class NpgsqlLinelineListD1E2MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineListD1E2MIWA actual, NpgsqlLinelineListD1E2MI expect, bool checkInInnerOnlyId)
        {
