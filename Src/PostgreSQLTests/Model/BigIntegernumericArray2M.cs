...
namespace Tests
{
    public class BigIntegernumericArray2M
    {
        ...
        public BigIntegernumericArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Numerics.BigInteger> NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericArray2M actual, BigIntegernumericArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Numerics.BigInteger>)default));
