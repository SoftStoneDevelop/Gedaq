...
namespace Tests
{
    public class Int32integerMArrayD2E1M
    {
        ...
        public Int32integerMArrayD21MI ModelInner { get; set; }

        
        public System.Int32[,] NullableValue { get; set; }

        public static void AssertModel(Int32integerMArrayD2E1M actual, Int32integerMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
