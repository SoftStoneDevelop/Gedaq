...
namespace Tests
{
    public class NpgsqlCirclecircleArray1M
    {
        ...
        public NpgsqlCirclecircleArray1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleArray1M actual, NpgsqlCirclecircleArray1M expect, bool checkInInnerOnlyId)
        {
