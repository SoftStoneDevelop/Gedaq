...
namespace Tests
{
    public class TimeSpanintervalMMArrayD1E1MI
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD1E1MI actual, TimeSpanintervalMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
