...
namespace Tests
{
    public class BytesmallintMArrayD1E1M
    {
        ...
        public BytesmallintMArrayD11MI ModelInner { get; set; }

        
        public System.Byte[] NullableValue { get; set; }

        public static void AssertModel(BytesmallintMArrayD1E1M actual, BytesmallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
