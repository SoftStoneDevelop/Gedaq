...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD1E1MI
    {
        ...
        public static void AssertModel(NpgsqlLinelineMMArrayD1E1MI actual, NpgsqlLinelineMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
