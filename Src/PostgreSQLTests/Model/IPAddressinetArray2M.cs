...
namespace Tests
{
    public class IPAddressinetArray2M
    {
        public System.Int32 Id { get; set; }

        public System.Collections.Generic.List<System.Net.IPAddress> Value { get; set; }

        public IPAddressinetArray2MI ModelInner { get; set; }

        public System.Collections.Generic.List<System.Net.IPAddress> NullableValue { get; set; }

        public static void AssertModel(IPAddressinetArray2M actual, IPAddressinetArray2M expect, bool checkInInnerOnlyId)
        {
