...
namespace Tests
{
    public class Doubledouble_precisionMMArrayD3E1MI
    {
        ...
        public static void AssertModel(Doubledouble_precisionMMArrayD3E1MI actual, Doubledouble_precisionMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
