...
namespace Tests
{
    public class FlatDecimalnumericMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericMMArrayD1E1M actual, DecimalnumericMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
