...
namespace Tests
{
    public class NpgsqlBoxboxMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlBoxboxMArrayD21MIWA actual, NpgsqlBoxboxMArrayD21MI expect, bool checkInInnerOnlyId)
        {
