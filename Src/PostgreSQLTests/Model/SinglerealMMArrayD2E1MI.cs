...
namespace Tests
{
    public class SinglerealMMArrayD2E1MI
    {
        ...
        public static void AssertModel(SinglerealMMArrayD2E1MI actual, SinglerealMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
