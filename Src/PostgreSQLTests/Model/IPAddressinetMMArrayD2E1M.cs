...
namespace Tests
{
    public class IPAddressinetMMArrayD2E1M
    {
        ...
        public IPAddressinetMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Net.IPAddress[,] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetMMArrayD2E1M actual, IPAddressinetMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
