...
namespace Tests
{
    public class BigIntegernumericMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD2E1MIWA actual, BigIntegernumericMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
