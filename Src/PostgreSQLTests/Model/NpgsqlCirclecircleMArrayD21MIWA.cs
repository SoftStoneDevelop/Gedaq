...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleMArrayD21MIWA actual, NpgsqlCirclecircleMArrayD21MI expect, bool checkInInnerOnlyId)
        {
