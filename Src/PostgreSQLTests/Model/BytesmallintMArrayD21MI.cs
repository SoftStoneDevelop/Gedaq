...
namespace Tests
{
    public class BytesmallintMArrayD21MI
    {
        ...
        public static void AssertModel(BytesmallintMArrayD21MI actual, BytesmallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
