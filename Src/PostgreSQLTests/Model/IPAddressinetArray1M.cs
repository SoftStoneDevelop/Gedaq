...
namespace Tests
{
    public class IPAddressinetArray1M
    {
        public System.Int32 Id { get; set; }

        public System.Net.IPAddress[] Value { get; set; }

        public IPAddressinetArray1MI ModelInner { get; set; }

        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetArray1M actual, IPAddressinetArray1M expect, bool checkInInnerOnlyId)
        {
