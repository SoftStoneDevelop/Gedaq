...
namespace Tests
{
    public class BytesmallintMMArrayD1E1MI
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD1E1MI actual, BytesmallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
