...
namespace Tests
{
    public class FlatNpgsqlPointpointArray2M
    {
        ...
        public static void AssertModel(FlatNpgsqlPointpointArray2M actual, NpgsqlPointpointArray2M expect, bool checkInInnerOnlyId)
        {
