...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMArrayD11MI
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMArrayD11MI actual, TimeOnlytime_without_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
