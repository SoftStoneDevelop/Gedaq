...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMMArrayD3E1M
    {
        ...
        public TimeOnlytime_without_time_zoneMMArrayD3E1MI ModelInner { get; set; }

        
        public System.TimeOnly[,,] NullableValue { get; set; }

        public static void AssertModel(TimeOnlytime_without_time_zoneMMArrayD3E1M actual, TimeOnlytime_without_time_zoneMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.TimeOnly[,,])default));
