...
namespace Tests
{
    public class SBytesmallintMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD3E1MIWA actual, SBytesmallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
