...
namespace Tests
{
    public class Int64bigintMArrayD1E1M
    {
        ...
        public Int64bigintMArrayD11MI ModelInner { get; set; }

        
        public System.Int64[] NullableValue { get; set; }

        public static void AssertModel(Int64bigintMArrayD1E1M actual, Int64bigintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
