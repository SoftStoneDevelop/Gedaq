...
namespace Tests
{
    public class Int16smallintMMArrayD1E1MI
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD1E1MI actual, Int16smallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
