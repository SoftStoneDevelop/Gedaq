...
namespace Tests
{
    public class Int16smallintMArrayD21MI
    {
        ...
        public static void AssertModel(Int16smallintMArrayD21MI actual, Int16smallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
