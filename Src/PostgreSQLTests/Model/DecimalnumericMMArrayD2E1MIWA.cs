...
namespace Tests
{
    public class DecimalnumericMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD2E1MIWA actual, DecimalnumericMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
