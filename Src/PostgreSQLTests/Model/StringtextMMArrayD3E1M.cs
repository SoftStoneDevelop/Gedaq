...
namespace Tests
{
    public class StringtextMMArrayD3E1M
    {
        ...
        public StringtextMMArrayD3E1MI ModelInner { get; set; }

        
        public System.String[,,] NullableValue { get; set; }

        public static void AssertModel(StringtextMMArrayD3E1M actual, StringtextMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
