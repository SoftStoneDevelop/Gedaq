...
namespace Tests
{
    public class FlatTimeOnlytime_without_time_zoneArray2M
    {
        ...
        public static void AssertModel(FlatTimeOnlytime_without_time_zoneArray2M actual, TimeOnlytime_without_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
