...
namespace Tests
{
    public class DateOnlydateMArrayD1E1M
    {
        ...
        public DateOnlydateMArrayD11MI ModelInner { get; set; }

        
        public System.DateOnly[] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateMArrayD1E1M actual, DateOnlydateMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
