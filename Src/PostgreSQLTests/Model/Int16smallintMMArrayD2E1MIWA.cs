...
namespace Tests
{
    public class Int16smallintMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD2E1MIWA actual, Int16smallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
