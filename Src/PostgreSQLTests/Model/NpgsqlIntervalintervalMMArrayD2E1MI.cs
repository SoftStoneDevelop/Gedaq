...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD2E1MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMMArrayD2E1MI actual, NpgsqlIntervalintervalMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
