...
namespace Tests
{
    public class GuiduuidMMArrayD3E1M
    {
        ...
        public GuiduuidMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Guid[,,] NullableValue { get; set; }

        public static void AssertModel(GuiduuidMMArrayD3E1M actual, GuiduuidMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
