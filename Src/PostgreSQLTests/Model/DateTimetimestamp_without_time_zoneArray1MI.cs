...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneArray1MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneArray1MI actual, DateTimetimestamp_without_time_zoneArray1MI expect, bool checkInInnerOnlyId)
        {
