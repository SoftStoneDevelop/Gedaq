...
namespace Tests
{
    public class NpgsqlBoxboxMMArrayD3E1MI
    {
        ...
        public static void AssertModel(NpgsqlBoxboxMMArrayD3E1MI actual, NpgsqlBoxboxMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
