...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneArray1M
    {
        ...
        public DateTimetimestamp_with_time_zoneArray1MI ModelInner { get; set; }

        
        public System.DateTime[] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_with_time_zoneArray1M actual, DateTimetimestamp_with_time_zoneArray1M expect, bool checkInInnerOnlyId)
        {
