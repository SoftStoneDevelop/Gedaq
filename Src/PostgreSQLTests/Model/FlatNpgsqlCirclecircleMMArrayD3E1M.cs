...
namespace Tests
{
    public class FlatNpgsqlCirclecircleMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleMMArrayD3E1M actual, NpgsqlCirclecircleMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
