...
namespace Tests
{
    public class Int32integerMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(Int32integerMMArrayD3E1MIWA actual, Int32integerMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
