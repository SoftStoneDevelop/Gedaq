...
namespace Tests
{
    public class NpgsqlIntervalintervalE0MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalE0MI actual, NpgsqlIntervalintervalE0MI expect, bool checkInInnerOnlyId)
        {
