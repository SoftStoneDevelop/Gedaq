...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMArrayD11MIWA
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMArrayD11MIWA actual, TimeOnlytime_without_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
