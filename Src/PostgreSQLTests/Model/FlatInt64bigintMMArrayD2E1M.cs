...
namespace Tests
{
    public class FlatInt64bigintMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt64bigintMMArrayD2E1M actual, Int64bigintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
