...
namespace Tests
{
    public class BigIntegernumericE0MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericE0MIWA actual, BigIntegernumericE0MI expect, bool checkInInnerOnlyId)
        {
