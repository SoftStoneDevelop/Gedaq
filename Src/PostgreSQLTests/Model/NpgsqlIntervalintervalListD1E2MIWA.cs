...
namespace Tests
{
    public class NpgsqlIntervalintervalListD1E2MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalListD1E2MIWA actual, NpgsqlIntervalintervalListD1E2MI expect, bool checkInInnerOnlyId)
        {
