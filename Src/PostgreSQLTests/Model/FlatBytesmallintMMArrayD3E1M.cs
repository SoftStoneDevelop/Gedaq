...
namespace Tests
{
    public class FlatBytesmallintMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatBytesmallintMMArrayD3E1M actual, BytesmallintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
