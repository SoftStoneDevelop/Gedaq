...
namespace Tests
{
    public class FlatInt32integerMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatInt32integerMMArrayD3E1M actual, Int32integerMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
