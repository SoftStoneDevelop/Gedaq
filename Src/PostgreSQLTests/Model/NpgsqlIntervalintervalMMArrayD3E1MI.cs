...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD3E1MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMMArrayD3E1MI actual, NpgsqlIntervalintervalMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
