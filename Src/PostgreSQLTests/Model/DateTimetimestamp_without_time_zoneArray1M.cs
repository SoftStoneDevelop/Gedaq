...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneArray1M
    {
        public System.Int32 Id { get; set; }

        public System.DateTime[] Value { get; set; }

        public DateTimetimestamp_without_time_zoneArray1MI ModelInner { get; set; }

        public System.DateTime[] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_without_time_zoneArray1M actual, DateTimetimestamp_without_time_zoneArray1M expect, bool checkInInnerOnlyId)
        {
