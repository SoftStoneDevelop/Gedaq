...
namespace Tests
{
    public class GuiduuidMArrayD2E1M
    {
        ...
        public GuiduuidMArrayD21MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(GuiduuidMArrayD2E1M actual, GuiduuidMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
