...
namespace Tests
{
    public class BytesmallintE0M
    {
        ...
        public BytesmallintE0MI ModelInner { get; set; }

        
        public System.Byte? NullableValue { get; set; }

        public static void AssertModel(BytesmallintE0M actual, BytesmallintE0M expect, bool checkInInnerOnlyId)
        {
