...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMArrayD21MI actual, NpgsqlIntervalintervalMArrayD21MI expect, bool checkInInnerOnlyId)
        {
