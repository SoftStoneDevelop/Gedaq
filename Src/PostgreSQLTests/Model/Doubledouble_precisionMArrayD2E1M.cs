...
namespace Tests
{
    public class Doubledouble_precisionMArrayD2E1M
    {
        ...
        public Doubledouble_precisionMArrayD21MI ModelInner { get; set; }

        
        public System.Double[,] NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionMArrayD2E1M actual, Doubledouble_precisionMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
