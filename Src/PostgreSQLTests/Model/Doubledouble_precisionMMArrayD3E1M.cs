...
namespace Tests
{
    public class Doubledouble_precisionMMArrayD3E1M
    {
        ...
        public Doubledouble_precisionMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Double[,,] NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionMMArrayD3E1M actual, Doubledouble_precisionMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
