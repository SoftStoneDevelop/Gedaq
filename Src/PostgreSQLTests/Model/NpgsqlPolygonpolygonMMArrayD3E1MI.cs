...
namespace Tests
{
    public class NpgsqlPolygonpolygonMMArrayD3E1MI
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonMMArrayD3E1MI actual, NpgsqlPolygonpolygonMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
