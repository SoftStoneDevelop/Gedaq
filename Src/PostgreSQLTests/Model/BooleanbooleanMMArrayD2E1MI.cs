...
namespace Tests
{
    public class BooleanbooleanMMArrayD2E1MI
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD2E1MI actual, BooleanbooleanMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
