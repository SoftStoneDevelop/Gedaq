...
namespace Tests
{
    public class FlatDecimalnumericArray2M
    {
        ...
        public static void AssertModel(FlatDecimalnumericArray2M actual, DecimalnumericArray2M expect, bool checkInInnerOnlyId)
        {
