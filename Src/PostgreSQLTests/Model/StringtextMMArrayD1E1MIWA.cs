...
namespace Tests
{
    public class StringtextMMArrayD1E1MIWA
    {
        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(9))]
        [Gedaq.Common.Attributes.Alias(order: 0)]
        public System.Int32 Id { get; set; }

        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(-2147483629))]
        ...
        public static void AssertModel(StringtextMMArrayD1E1MIWA actual, StringtextMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
