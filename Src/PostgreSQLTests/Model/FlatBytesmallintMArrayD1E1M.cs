...
namespace Tests
{
    public class FlatBytesmallintMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBytesmallintMArrayD1E1M actual, BytesmallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
