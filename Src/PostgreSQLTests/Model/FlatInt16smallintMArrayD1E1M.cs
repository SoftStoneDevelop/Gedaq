...
namespace Tests
{
    public class FlatInt16smallintMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt16smallintMArrayD1E1M actual, Int16smallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
