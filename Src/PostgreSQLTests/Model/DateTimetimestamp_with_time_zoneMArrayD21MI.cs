...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMArrayD21MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMArrayD21MI actual, DateTimetimestamp_with_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
