...
namespace Tests
{
    public class FlatDecimalmoneyMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatDecimalmoneyMMArrayD3E1M actual, DecimalmoneyMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
