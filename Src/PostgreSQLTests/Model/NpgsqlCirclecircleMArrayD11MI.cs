...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleMArrayD11MI actual, NpgsqlCirclecircleMArrayD11MI expect, bool checkInInnerOnlyId)
        {
