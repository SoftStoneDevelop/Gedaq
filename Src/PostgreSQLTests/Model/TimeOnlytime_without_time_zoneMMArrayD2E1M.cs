...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMMArrayD2E1M
    {
        ...
        public TimeOnlytime_without_time_zoneMMArrayD2E1MI ModelInner { get; set; }

        
        public System.TimeOnly[,] NullableValue { get; set; }

        public static void AssertModel(TimeOnlytime_without_time_zoneMMArrayD2E1M actual, TimeOnlytime_without_time_zoneMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
