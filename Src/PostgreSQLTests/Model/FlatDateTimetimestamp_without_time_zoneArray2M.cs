...
namespace Tests
{
    public class FlatDateTimetimestamp_without_time_zoneArray2M
    {
        ...
        public static void AssertModel(FlatDateTimetimestamp_without_time_zoneArray2M actual, DateTimetimestamp_without_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
