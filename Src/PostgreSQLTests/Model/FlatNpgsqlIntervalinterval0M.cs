...
namespace Tests
{
    public class FlatNpgsqlIntervalinterval0M
    {
        ...
        public static void AssertModel(FlatNpgsqlIntervalinterval0M actual, NpgsqlIntervalinterval0M expect, bool checkInInnerOnlyId)
        {
