...
namespace Tests
{
    public class TimeSpanintervalMMArrayD3E1MI
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD3E1MI actual, TimeSpanintervalMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
