...
namespace Tests
{
    public class SBytesmallintMMArrayD1E1MI
    {
        ...
        public static void AssertModel(SBytesmallintMMArrayD1E1MI actual, SBytesmallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
