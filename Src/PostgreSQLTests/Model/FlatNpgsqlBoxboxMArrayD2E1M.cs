...
namespace Tests
{
    public class FlatNpgsqlBoxboxMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlBoxboxMArrayD2E1M actual, NpgsqlBoxboxMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
