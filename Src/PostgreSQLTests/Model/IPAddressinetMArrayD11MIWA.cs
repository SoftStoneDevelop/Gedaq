...
namespace Tests
{
    public class IPAddressinetMArrayD11MIWA
    {
        ...
        public static void AssertModel(IPAddressinetMArrayD11MIWA actual, IPAddressinetMArrayD11MI expect, bool checkInInnerOnlyId)
        {
