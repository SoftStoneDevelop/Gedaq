...
namespace Tests
{
    public class FlatDecimalmoneyMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDecimalmoneyMMArrayD2E1M actual, DecimalmoneyMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
