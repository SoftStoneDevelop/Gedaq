...
namespace Tests
{
    public class FlatDateOnlydateMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDateOnlydateMArrayD1E1M actual, DateOnlydateMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
