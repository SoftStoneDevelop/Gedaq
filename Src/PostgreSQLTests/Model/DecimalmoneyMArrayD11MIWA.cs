...
namespace Tests
{
    public class DecimalmoneyMArrayD11MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyMArrayD11MIWA actual, DecimalmoneyMArrayD11MI expect, bool checkInInnerOnlyId)
        {
