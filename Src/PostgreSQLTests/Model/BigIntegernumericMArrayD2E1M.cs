...
namespace Tests
{
    public class BigIntegernumericMArrayD2E1M
    {
        ...
        public BigIntegernumericMArrayD21MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger[,] NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericMArrayD2E1M actual, BigIntegernumericMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
