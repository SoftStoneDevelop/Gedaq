...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineMMArrayD1E1MIWA actual, NpgsqlLinelineMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
