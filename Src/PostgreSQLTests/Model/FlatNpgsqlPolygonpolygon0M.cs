...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygon0M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygon0M actual, NpgsqlPolygonpolygon0M expect, bool checkInInnerOnlyId)
        {
