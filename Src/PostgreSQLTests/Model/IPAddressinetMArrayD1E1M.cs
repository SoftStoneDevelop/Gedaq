...
namespace Tests
{
    public class IPAddressinetMArrayD1E1M
    {
        ...
        public IPAddressinetMArrayD11MI ModelInner { get; set; }

        
        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetMArrayD1E1M actual, IPAddressinetMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
