...
namespace Tests
{
    public class FlatInt32integerMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt32integerMMArrayD2E1M actual, Int32integerMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
