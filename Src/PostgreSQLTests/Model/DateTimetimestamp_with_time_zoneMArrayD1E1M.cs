...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMArrayD1E1M
    {
        ...
        public DateTimetimestamp_with_time_zoneMArrayD11MI ModelInner { get; set; }

        
        public System.DateTime[] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_with_time_zoneMArrayD1E1M actual, DateTimetimestamp_with_time_zoneMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
