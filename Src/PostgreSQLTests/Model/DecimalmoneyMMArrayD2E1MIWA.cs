...
namespace Tests
{
    public class DecimalmoneyMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD2E1MIWA actual, DecimalmoneyMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
