...
namespace Tests
{
    public class Int16smallintArray2MIWA
    {
        ...
        public static void AssertModel(Int16smallintArray2MIWA actual, Int16smallintArray2MI expect, bool checkInInnerOnlyId)
        {
