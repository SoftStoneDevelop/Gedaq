...
namespace Tests
{
    public class FlatIPAddressinetMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetMMArrayD1E1M actual, IPAddressinetMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
