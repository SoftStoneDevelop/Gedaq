...
namespace Tests
{
    public class Int16smallintMArrayD1E1M
    {
        ...
        public Int16smallintMArrayD11MI ModelInner { get; set; }

        
        public System.Int16[] NullableValue { get; set; }

        public static void AssertModel(Int16smallintMArrayD1E1M actual, Int16smallintMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
