...
namespace Tests
{
    public class StringtextMArrayD11MIWA
    {
        ...
        public static void AssertModel(StringtextMArrayD11MIWA actual, StringtextMArrayD11MI expect, bool checkInInnerOnlyId)
        {
