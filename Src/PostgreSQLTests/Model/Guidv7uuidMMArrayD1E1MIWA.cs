...
namespace Tests
{
    public class Guidv7uuidMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(Guidv7uuidMMArrayD1E1MIWA actual, Guidv7uuidMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
