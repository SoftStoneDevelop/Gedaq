...
namespace Tests
{
    public class TimeSpanintervalMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalMMArrayD3E1MIWA actual, TimeSpanintervalMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
