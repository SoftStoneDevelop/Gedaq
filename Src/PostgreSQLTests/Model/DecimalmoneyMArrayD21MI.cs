...
namespace Tests
{
    public class DecimalmoneyMArrayD21MI
    {
        ...
        public static void AssertModel(DecimalmoneyMArrayD21MI actual, DecimalmoneyMArrayD21MI expect, bool checkInInnerOnlyId)
        {
