...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonMArrayD21MIWA actual, NpgsqlPolygonpolygonMArrayD21MI expect, bool checkInInnerOnlyId)
        {
