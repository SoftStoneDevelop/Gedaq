...
namespace Tests
{
    public class FlatBytesmallintMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBytesmallintMMArrayD1E1M actual, BytesmallintMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
