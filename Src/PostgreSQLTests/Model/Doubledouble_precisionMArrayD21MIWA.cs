...
namespace Tests
{
    public class Doubledouble_precisionMArrayD21MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precisionMArrayD21MIWA actual, Doubledouble_precisionMArrayD21MI expect, bool checkInInnerOnlyId)
        {
