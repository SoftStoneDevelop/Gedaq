...
namespace Tests
{
    public class TimeSpanintervalMArrayD21MI
    {
        ...
        public static void AssertModel(TimeSpanintervalMArrayD21MI actual, TimeSpanintervalMArrayD21MI expect, bool checkInInnerOnlyId)
        {
