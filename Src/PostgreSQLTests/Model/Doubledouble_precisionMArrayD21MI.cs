...
namespace Tests
{
    public class Doubledouble_precisionMArrayD21MI
    {
        ...
        public static void AssertModel(Doubledouble_precisionMArrayD21MI actual, Doubledouble_precisionMArrayD21MI expect, bool checkInInnerOnlyId)
        {
