...
namespace Tests
{
    public class SBytesmallintListD1E2M
    {
        ...
        public static void AssertModel(SBytesmallintListD1E2M actual, SBytesmallintListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.SByte>)default));
