...
namespace Tests
{
    public class FlatStringtextMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatStringtextMMArrayD1E1M actual, StringtextMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
