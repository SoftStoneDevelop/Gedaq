...
namespace Tests
{
    public class StringtextArray2M
    {
        public System.Int32 Id { get; set; }

        public System.Collections.Generic.List<System.String> Value { get; set; }

        public StringtextArray2MI ModelInner { get; set; }

        public System.Collections.Generic.List<System.String> NullableValue { get; set; }

        public static void AssertModel(StringtextArray2M actual, StringtextArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.String>)default));
