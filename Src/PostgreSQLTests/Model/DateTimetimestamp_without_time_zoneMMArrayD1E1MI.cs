...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMMArrayD1E1MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMMArrayD1E1MI actual, DateTimetimestamp_without_time_zoneMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
