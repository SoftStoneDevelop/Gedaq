...
namespace Tests
{
    public class FlatStringtextMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatStringtextMMArrayD2E1M actual, StringtextMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
