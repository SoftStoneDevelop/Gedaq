...
namespace Tests
{
    public class BytesmallintMArrayD11MIWA
    {
        ...
        public static void AssertModel(BytesmallintMArrayD11MIWA actual, BytesmallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
