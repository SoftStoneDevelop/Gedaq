...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD2E1M
    {
        ...
        public NpgsqlCirclecircleMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleMArrayD2E1M actual, NpgsqlCirclecircleMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
