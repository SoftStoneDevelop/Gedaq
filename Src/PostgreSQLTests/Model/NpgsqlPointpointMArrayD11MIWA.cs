...
namespace Tests
{
    public class NpgsqlPointpointMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlPointpointMArrayD11MIWA actual, NpgsqlPointpointMArrayD11MI expect, bool checkInInnerOnlyId)
        {
