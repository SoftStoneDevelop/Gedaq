...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMArrayD11MI actual, NpgsqlIntervalintervalMArrayD11MI expect, bool checkInInnerOnlyId)
        {
