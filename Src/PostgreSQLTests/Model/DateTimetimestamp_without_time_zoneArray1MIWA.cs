...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneArray1MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneArray1MIWA actual, DateTimetimestamp_without_time_zoneArray1MI expect, bool checkInInnerOnlyId)
        {
