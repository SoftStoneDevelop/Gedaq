...
namespace Tests
{
    public class DecimalnumericMMArrayD1E1M
    {
        ...
        public DecimalnumericMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Decimal[] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericMMArrayD1E1M actual, DecimalnumericMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
