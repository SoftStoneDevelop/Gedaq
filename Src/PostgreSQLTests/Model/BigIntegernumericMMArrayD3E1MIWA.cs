...
namespace Tests
{
    public class BigIntegernumericMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD3E1MIWA actual, BigIntegernumericMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
