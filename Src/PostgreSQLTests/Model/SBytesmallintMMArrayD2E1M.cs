...
namespace Tests
{
    public class SBytesmallintMMArrayD2E1M
    {
        ...
        public SBytesmallintMMArrayD2E1MI ModelInner { get; set; }

        
        public System.SByte[,] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintMMArrayD2E1M actual, SBytesmallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
