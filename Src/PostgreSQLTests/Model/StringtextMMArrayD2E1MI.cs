...
namespace Tests
{
    public class StringtextMMArrayD2E1MI
    {
        ...
        public static void AssertModel(StringtextMMArrayD2E1MI actual, StringtextMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
