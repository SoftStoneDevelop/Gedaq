...
namespace Tests
{
    public class Int32integerArray1M
    {
        ...
        public Int32integerArray1MI ModelInner { get; set; }

        
        public System.Int32[] NullableValue { get; set; }

        public static void AssertModel(Int32integerArray1M actual, Int32integerArray1M expect, bool checkInInnerOnlyId)
        {
