...
namespace Tests
{
    public class BytesmallintMMArrayD2E1MI
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD2E1MI actual, BytesmallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
