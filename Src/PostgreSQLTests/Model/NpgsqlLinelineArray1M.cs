...
namespace Tests
{
    public class NpgsqlLinelineArray1M
    {
        ...
        public NpgsqlLinelineArray1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineArray1M actual, NpgsqlLinelineArray1M expect, bool checkInInnerOnlyId)
        {
