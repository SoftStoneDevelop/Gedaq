...
namespace Tests
{
    public class FlatDecimalmoneyMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDecimalmoneyMArrayD1E1M actual, DecimalmoneyMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
