...
namespace Tests
{
    public class BytesmallintMMArrayD3E1MI
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD3E1MI actual, BytesmallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
