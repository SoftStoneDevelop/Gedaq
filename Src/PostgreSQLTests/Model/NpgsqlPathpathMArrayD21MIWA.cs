...
namespace Tests
{
    public class NpgsqlPathpathMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlPathpathMArrayD21MIWA actual, NpgsqlPathpathMArrayD21MI expect, bool checkInInnerOnlyId)
        {
