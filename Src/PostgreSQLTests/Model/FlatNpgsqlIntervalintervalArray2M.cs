...
namespace Tests
{
    public class FlatNpgsqlIntervalintervalArray2M
    {
        ...
        public static void AssertModel(FlatNpgsqlIntervalintervalArray2M actual, NpgsqlIntervalintervalArray2M expect, bool checkInInnerOnlyId)
        {
