...
namespace Tests
{
    public class BytesmallintMArrayD21MIWA
    {
        ...
        public static void AssertModel(BytesmallintMArrayD21MIWA actual, BytesmallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
