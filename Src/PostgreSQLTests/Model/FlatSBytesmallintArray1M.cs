...
namespace Tests
{
    public class FlatSBytesmallintArray1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintArray1M actual, SBytesmallintArray1M expect, bool checkInInnerOnlyId)
        {
