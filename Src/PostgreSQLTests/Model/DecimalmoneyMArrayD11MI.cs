...
namespace Tests
{
    public class DecimalmoneyMArrayD11MI
    {
        ...
        public static void AssertModel(DecimalmoneyMArrayD11MI actual, DecimalmoneyMArrayD11MI expect, bool checkInInnerOnlyId)
        {
