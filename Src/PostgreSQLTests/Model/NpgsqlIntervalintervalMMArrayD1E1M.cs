...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD1E1M
    {
        ...
        public NpgsqlIntervalintervalMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlInterval[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalMMArrayD1E1M actual, NpgsqlIntervalintervalMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
