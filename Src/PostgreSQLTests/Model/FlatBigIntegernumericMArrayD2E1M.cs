...
namespace Tests
{
    public class FlatBigIntegernumericMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBigIntegernumericMArrayD2E1M actual, BigIntegernumericMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
