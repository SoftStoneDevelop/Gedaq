...
namespace Tests
{
    public class IPAddressinetMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(IPAddressinetMMArrayD3E1MIWA actual, IPAddressinetMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
