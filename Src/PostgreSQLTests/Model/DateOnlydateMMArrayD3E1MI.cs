...
namespace Tests
{
    public class DateOnlydateMMArrayD3E1MI
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD3E1MI actual, DateOnlydateMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
