...
namespace Tests
{
    public class FlatDecimalnumericMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericMMArrayD2E1M actual, DecimalnumericMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
