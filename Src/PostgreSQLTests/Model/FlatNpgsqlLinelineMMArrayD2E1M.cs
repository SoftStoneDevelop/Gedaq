...
namespace Tests
{
    public class FlatNpgsqlLinelineMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlLinelineMMArrayD2E1M actual, NpgsqlLinelineMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
