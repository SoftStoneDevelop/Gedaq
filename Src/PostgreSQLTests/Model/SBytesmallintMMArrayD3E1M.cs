...
namespace Tests
{
    public class SBytesmallintMMArrayD3E1M
    {
        ...
        public SBytesmallintMMArrayD3E1MI ModelInner { get; set; }

        
        public System.SByte[,,] NullableValue { get; set; }

        public static void AssertModel(SBytesmallintMMArrayD3E1M actual, SBytesmallintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
