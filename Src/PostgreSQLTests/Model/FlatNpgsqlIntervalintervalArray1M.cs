...
namespace Tests
{
    public class FlatNpgsqlIntervalintervalArray1M
    {
        ...
        public static void AssertModel(FlatNpgsqlIntervalintervalArray1M actual, NpgsqlIntervalintervalArray1M expect, bool checkInInnerOnlyId)
        {
