...
namespace Tests
{
    public class NpgsqlPathpathListD12MI
    {
        ...
        public static void AssertModel(NpgsqlPathpathListD12MI actual, NpgsqlPathpathListD12MI expect, bool checkInInnerOnlyId)
        {
