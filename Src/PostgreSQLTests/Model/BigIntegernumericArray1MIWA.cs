...
namespace Tests
{
    public class BigIntegernumericArray1MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericArray1MIWA actual, BigIntegernumericArray1MI expect, bool checkInInnerOnlyId)
        {
