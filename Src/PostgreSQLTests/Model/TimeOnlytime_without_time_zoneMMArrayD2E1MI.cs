...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMMArrayD2E1MI
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMMArrayD2E1MI actual, TimeOnlytime_without_time_zoneMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
