...
namespace Tests
{
    public class SBytesmallintMArrayD11MI
    {
        ...
        public static void AssertModel(SBytesmallintMArrayD11MI actual, SBytesmallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
