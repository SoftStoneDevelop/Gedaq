...
namespace Tests
{
    public class NpgsqlLinelineMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlLinelineMArrayD11MI actual, NpgsqlLinelineMArrayD11MI expect, bool checkInInnerOnlyId)
        {
