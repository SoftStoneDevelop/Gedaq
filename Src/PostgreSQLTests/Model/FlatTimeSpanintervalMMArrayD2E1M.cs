...
namespace Tests
{
    public class FlatTimeSpanintervalMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalMMArrayD2E1M actual, TimeSpanintervalMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
