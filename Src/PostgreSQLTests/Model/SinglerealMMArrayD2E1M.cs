...
namespace Tests
{
    public class SinglerealMMArrayD2E1M
    {
        ...
        public SinglerealMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Single[,] NullableValue { get; set; }

        public static void AssertModel(SinglerealMMArrayD2E1M actual, SinglerealMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
