...
namespace Tests
{
    public class NpgsqlBoxboxMArrayD2E1M
    {
        ...
        public NpgsqlBoxboxMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlBox[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlBoxboxMArrayD2E1M actual, NpgsqlBoxboxMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
