...
namespace Tests
{
    public class NpgsqlIntervalintervalArray2M
    {
        public System.Int32 Id { get; set; }

        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlInterval> Value { get; set; }

        public NpgsqlIntervalintervalArray2MI ModelInner { get; set; }

        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlInterval> NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalArray2M actual, NpgsqlIntervalintervalArray2M expect, bool checkInInnerOnlyId)
        {
