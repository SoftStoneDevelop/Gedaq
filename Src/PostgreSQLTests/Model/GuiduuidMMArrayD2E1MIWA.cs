...
namespace Tests
{
    public class GuiduuidMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(GuiduuidMMArrayD2E1MIWA actual, GuiduuidMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
