...
namespace Tests
{
    public class DecimalmoneyMMArrayD2E1MI
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD2E1MI actual, DecimalmoneyMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
