...
namespace Tests
{
    public class FlatNpgsqlLinelineMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlLinelineMArrayD1E1M actual, NpgsqlLinelineMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
