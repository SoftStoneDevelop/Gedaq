...
namespace Tests
{
    public class GuiduuidArray2M
    {
        ...
        public GuiduuidArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Guid> NullableValue { get; set; }

        public static void AssertModel(GuiduuidArray2M actual, GuiduuidArray2M expect, bool checkInInnerOnlyId)
        {
