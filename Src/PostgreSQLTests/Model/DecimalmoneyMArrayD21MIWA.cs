...
namespace Tests
{
    public class DecimalmoneyMArrayD21MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyMArrayD21MIWA actual, DecimalmoneyMArrayD21MI expect, bool checkInInnerOnlyId)
        {
