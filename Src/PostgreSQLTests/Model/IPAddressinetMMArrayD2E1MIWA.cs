...
namespace Tests
{
    public class IPAddressinetMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(IPAddressinetMMArrayD2E1MIWA actual, IPAddressinetMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
