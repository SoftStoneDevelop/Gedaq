...
namespace Tests
{
    public class SBytesmallintListD1E2MIWA
    {
        ...
        public static void AssertModel(SBytesmallintListD1E2MIWA actual, SBytesmallintListD1E2MI expect, bool checkInInnerOnlyId)
        {
