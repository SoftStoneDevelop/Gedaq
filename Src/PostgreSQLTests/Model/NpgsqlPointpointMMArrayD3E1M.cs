...
namespace Tests
{
    public class NpgsqlPointpointMMArrayD3E1M
    {
        ...
        public NpgsqlPointpointMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPoint[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointMMArrayD3E1M actual, NpgsqlPointpointMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
