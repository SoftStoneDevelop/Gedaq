...
namespace Tests
{
    public class FlatDateTimetimestamp_with_time_zoneArray2M
    {
        ...
        public static void AssertModel(FlatDateTimetimestamp_with_time_zoneArray2M actual, DateTimetimestamp_with_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
