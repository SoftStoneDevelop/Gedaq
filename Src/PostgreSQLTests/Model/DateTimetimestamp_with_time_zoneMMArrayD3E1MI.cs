...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMMArrayD3E1MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMMArrayD3E1MI actual, DateTimetimestamp_with_time_zoneMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
