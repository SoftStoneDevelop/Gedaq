...
namespace Tests
{
    public class BigIntegernumericArray2MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericArray2MIWA actual, BigIntegernumericArray2MI expect, bool checkInInnerOnlyId)
        {
