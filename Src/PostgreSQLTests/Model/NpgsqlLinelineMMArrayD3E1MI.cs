...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD3E1MI
    {
        ...
        public static void AssertModel(NpgsqlLinelineMMArrayD3E1MI actual, NpgsqlLinelineMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
