...
namespace Tests
{
    public class NpgsqlPointpointMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlPointpointMArrayD11MI actual, NpgsqlPointpointMArrayD11MI expect, bool checkInInnerOnlyId)
        {
