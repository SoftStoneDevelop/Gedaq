...
namespace Tests
{
    public class IPAddressinetMArrayD21MIWA
    {
        ...
        public static void AssertModel(IPAddressinetMArrayD21MIWA actual, IPAddressinetMArrayD21MI expect, bool checkInInnerOnlyId)
        {
