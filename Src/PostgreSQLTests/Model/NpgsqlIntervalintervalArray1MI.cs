...
namespace Tests
{
    public class NpgsqlIntervalintervalArray1MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalArray1MI actual, NpgsqlIntervalintervalArray1MI expect, bool checkInInnerOnlyId)
        {
