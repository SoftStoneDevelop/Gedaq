...
namespace Tests
{
    public class FlatNpgsqlBoxboxMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlBoxboxMMArrayD1E1M actual, NpgsqlBoxboxMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
