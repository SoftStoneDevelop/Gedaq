...
namespace Tests
{
    public class DecimalmoneyListD12MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyListD12MIWA actual, DecimalmoneyListD12MI expect, bool checkInInnerOnlyId)
        {
