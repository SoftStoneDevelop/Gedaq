...
namespace Tests
{
    public class Int32integerListD1E2M
    {
        ...
        public Int32integerListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Int32> NullableValue { get; set; }

        public static void AssertModel(Int32integerListD1E2M actual, Int32integerListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Int32>)default));
