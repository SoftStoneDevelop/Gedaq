...
namespace Tests
{
    public class Int32integerMArrayD21MI
    {
        ...
        public static void AssertModel(Int32integerMArrayD21MI actual, Int32integerMArrayD21MI expect, bool checkInInnerOnlyId)
        {
