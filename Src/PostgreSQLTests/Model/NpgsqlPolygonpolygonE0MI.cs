...
namespace Tests
{
    public class NpgsqlPolygonpolygonE0MI
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonE0MI actual, NpgsqlPolygonpolygonE0MI expect, bool checkInInnerOnlyId)
        {
