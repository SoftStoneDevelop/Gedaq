...
namespace Tests
{
    public class Doubledouble_precisionMMArrayD1E1M
    {
        ...
        public Doubledouble_precisionMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Double[] NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionMMArrayD1E1M actual, Doubledouble_precisionMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Double[])default));
