...
namespace Tests
{
    public class FlatNpgsqlPathpathMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathMMArrayD3E1M actual, NpgsqlPathpathMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
