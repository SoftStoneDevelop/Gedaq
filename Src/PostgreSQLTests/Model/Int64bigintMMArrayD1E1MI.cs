...
namespace Tests
{
    public class Int64bigintMMArrayD1E1MI
    {
        ...
        public static void AssertModel(Int64bigintMMArrayD1E1MI actual, Int64bigintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
