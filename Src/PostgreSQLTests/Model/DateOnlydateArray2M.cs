...
namespace Tests
{
    public class DateOnlydateArray2M
    {
        ...
        public DateOnlydateArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.DateOnly> NullableValue { get; set; }

        public static void AssertModel(DateOnlydateArray2M actual, DateOnlydateArray2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.DateOnly>)default));
