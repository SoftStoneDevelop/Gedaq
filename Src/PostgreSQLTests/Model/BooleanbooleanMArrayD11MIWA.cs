...
namespace Tests
{
    public class BooleanbooleanMArrayD11MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanMArrayD11MIWA actual, BooleanbooleanMArrayD11MI expect, bool checkInInnerOnlyId)
        {
