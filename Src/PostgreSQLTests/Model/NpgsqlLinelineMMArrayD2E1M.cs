...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD2E1M
    {
        ...
        public NpgsqlLinelineMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineMMArrayD2E1M actual, NpgsqlLinelineMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
