...
namespace Tests
{
    public class FlatDecimalnumericArray1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericArray1M actual, DecimalnumericArray1M expect, bool checkInInnerOnlyId)
        {
