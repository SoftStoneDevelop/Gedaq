...
namespace Tests
{
    public class IPAddressinet0M
    {
        ...
        public IPAddressinet0MI ModelInner { get; set; }

        
        public System.Net.IPAddress NullableValue { get; set; }

        public static void AssertModel(IPAddressinet0M actual, IPAddressinet0M expect, bool checkInInnerOnlyId)
        {
