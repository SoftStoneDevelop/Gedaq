...
namespace Tests
{
    public class DecimalmoneyMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyMMArrayD3E1MIWA actual, DecimalmoneyMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
