...
namespace Tests
{
    public class Doubledouble_precisionMMArrayD2E1M
    {
        ...
        public Doubledouble_precisionMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Double[,] NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionMMArrayD2E1M actual, Doubledouble_precisionMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
