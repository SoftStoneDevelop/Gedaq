...
namespace Tests
{
    public class Int32integerMArrayD21MIWA
    {
        ...
        public static void AssertModel(Int32integerMArrayD21MIWA actual, Int32integerMArrayD21MI expect, bool checkInInnerOnlyId)
        {
