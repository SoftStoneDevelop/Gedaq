...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD1E1M
    {
        ...
        public NpgsqlCirclecircleMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleMArrayD1E1M actual, NpgsqlCirclecircleMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
