...
namespace Tests
{
    public class NpgsqlPathpathMMArrayD3E1M
    {
        ...
        public NpgsqlPathpathMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPath[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPathpathMMArrayD3E1M actual, NpgsqlPathpathMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
