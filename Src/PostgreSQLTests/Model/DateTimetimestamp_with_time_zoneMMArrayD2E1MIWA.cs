...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMMArrayD2E1MIWA
    {
        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(9))]
        [Gedaq.Common.Attributes.Alias(order: 0)]
        public System.Int32 Id { get; set; }

        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(-2147483622))]
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMMArrayD2E1MIWA actual, DateTimetimestamp_with_time_zoneMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
