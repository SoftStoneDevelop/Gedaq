...
namespace Tests
{
    public class TimeOnlytime_without_time_zone0M
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zone0M actual, TimeOnlytime_without_time_zone0M expect, bool checkInInnerOnlyId)
        {
