...
namespace Tests
{
    public class TimeSpanintervalMMArrayD1E1M
    {
        ...
        public TimeSpanintervalMMArrayD1E1MI ModelInner { get; set; }

        
        public System.TimeSpan[] NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalMMArrayD1E1M actual, TimeSpanintervalMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
