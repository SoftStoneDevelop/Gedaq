...
namespace Tests
{
    public class FlatTimeSpanintervalArray2M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalArray2M actual, TimeSpanintervalArray2M expect, bool checkInInnerOnlyId)
        {
