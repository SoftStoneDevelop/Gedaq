...
namespace Tests
{
    public class NpgsqlPathpathMMArrayD2E1M
    {
        ...
        public NpgsqlPathpathMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPath[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPathpathMMArrayD2E1M actual, NpgsqlPathpathMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
