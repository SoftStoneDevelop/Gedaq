...
namespace Tests
{
    public class DecimalnumericE0M
    {
        ...
        public DecimalnumericE0MI ModelInner { get; set; }

        
        public System.Decimal? NullableValue { get; set; }

        public static void AssertModel(DecimalnumericE0M actual, DecimalnumericE0M expect, bool checkInInnerOnlyId)
        {
