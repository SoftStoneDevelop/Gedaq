...
namespace Tests
{
    public class Doubledouble_precisionMMArrayD2E1MI
    {
        ...
        public static void AssertModel(Doubledouble_precisionMMArrayD2E1MI actual, Doubledouble_precisionMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
