...
namespace Tests
{
    public class DateOnlydateMMArrayD2E1M
    {
        ...
        public DateOnlydateMMArrayD2E1MI ModelInner { get; set; }

        
        public System.DateOnly[,] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateMMArrayD2E1M actual, DateOnlydateMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.DateOnly[,])default));
