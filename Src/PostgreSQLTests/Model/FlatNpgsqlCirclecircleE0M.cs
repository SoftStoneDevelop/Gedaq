...
namespace Tests
{
    public class FlatNpgsqlCirclecircleE0M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleE0M actual, NpgsqlCirclecircleE0M expect, bool checkInInnerOnlyId)
        {
