...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonMMArrayD2E1M actual, NpgsqlPolygonpolygonMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
