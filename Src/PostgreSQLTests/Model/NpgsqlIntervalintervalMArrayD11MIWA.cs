...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMArrayD11MIWA actual, NpgsqlIntervalintervalMArrayD11MI expect, bool checkInInnerOnlyId)
        {
