...
namespace Tests
{
    public class DecimalnumericMArrayD21MIWA
    {
        ...
        public static void AssertModel(DecimalnumericMArrayD21MIWA actual, DecimalnumericMArrayD21MI expect, bool checkInInnerOnlyId)
        {
