...
namespace Tests
{
    public class FlatIPAddressinetMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetMMArrayD3E1M actual, IPAddressinetMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
