...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD3E1M
    {
        ...
        public NpgsqlLinelineMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineMMArrayD3E1M actual, NpgsqlLinelineMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((NpgsqlTypes.NpgsqlLine[,,])default));
