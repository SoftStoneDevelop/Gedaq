...
namespace Tests
{
    public class FlatInt32integerMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt32integerMArrayD2E1M actual, Int32integerMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
