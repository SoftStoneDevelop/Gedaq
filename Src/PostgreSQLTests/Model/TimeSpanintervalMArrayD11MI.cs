...
namespace Tests
{
    public class TimeSpanintervalMArrayD11MI
    {
        ...
        public static void AssertModel(TimeSpanintervalMArrayD11MI actual, TimeSpanintervalMArrayD11MI expect, bool checkInInnerOnlyId)
        {
