...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneE0MIWA
    {
        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(9))]
        [Gedaq.Common.Attributes.Alias(order: 0)]
        public System.Int32 Id { get; set; }

        [Gedaq.Npgsql.Attributes.DbType((NpgsqlTypes.NpgsqlDbType)(20))]
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneE0MIWA actual, TimeOnlytime_without_time_zoneE0MI expect, bool checkInInnerOnlyId)
        {
