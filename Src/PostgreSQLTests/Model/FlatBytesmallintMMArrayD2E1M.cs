...
namespace Tests
{
    public class FlatBytesmallintMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBytesmallintMMArrayD2E1M actual, BytesmallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
