...
namespace Tests
{
    public class BooleanbooleanMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD3E1MIWA actual, BooleanbooleanMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
