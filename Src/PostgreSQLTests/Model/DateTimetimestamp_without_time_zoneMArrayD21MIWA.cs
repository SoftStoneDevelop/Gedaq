...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMArrayD21MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMArrayD21MIWA actual, DateTimetimestamp_without_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
