...
namespace Tests
{
    public class FlatNpgsqlBoxboxMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlBoxboxMArrayD1E1M actual, NpgsqlBoxboxMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
