...
namespace Tests
{
    public class FlatTimeSpanintervalMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatTimeSpanintervalMArrayD2E1M actual, TimeSpanintervalMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
