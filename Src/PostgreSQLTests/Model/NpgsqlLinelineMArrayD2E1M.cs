...
namespace Tests
{
    public class NpgsqlLinelineMArrayD2E1M
    {
        ...
        public NpgsqlLinelineMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineMArrayD2E1M actual, NpgsqlLinelineMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
