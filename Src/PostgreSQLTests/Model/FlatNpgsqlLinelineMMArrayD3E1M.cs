...
namespace Tests
{
    public class FlatNpgsqlLinelineMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlLinelineMMArrayD3E1M actual, NpgsqlLinelineMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
