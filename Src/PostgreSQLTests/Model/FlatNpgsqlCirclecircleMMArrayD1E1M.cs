...
namespace Tests
{
    public class FlatNpgsqlCirclecircleMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleMMArrayD1E1M actual, NpgsqlCirclecircleMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
