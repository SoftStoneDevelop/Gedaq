...
namespace Tests
{
    public class Int32integerMMArrayD1E1MI
    {
        ...
        public static void AssertModel(Int32integerMMArrayD1E1MI actual, Int32integerMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
