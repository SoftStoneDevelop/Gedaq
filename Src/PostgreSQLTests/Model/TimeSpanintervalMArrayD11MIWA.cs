...
namespace Tests
{
    public class TimeSpanintervalMArrayD11MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalMArrayD11MIWA actual, TimeSpanintervalMArrayD11MI expect, bool checkInInnerOnlyId)
        {
