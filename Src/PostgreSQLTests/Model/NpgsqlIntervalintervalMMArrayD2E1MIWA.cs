...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMMArrayD2E1MIWA actual, NpgsqlIntervalintervalMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
