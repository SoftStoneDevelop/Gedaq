...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD2E1M
    {
        ...
        public NpgsqlIntervalintervalMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlInterval[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalMArrayD2E1M actual, NpgsqlIntervalintervalMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
