...
namespace Tests
{
    public class DateOnlydateMArrayD11MI
    {
        ...
        public static void AssertModel(DateOnlydateMArrayD11MI actual, DateOnlydateMArrayD11MI expect, bool checkInInnerOnlyId)
        {
