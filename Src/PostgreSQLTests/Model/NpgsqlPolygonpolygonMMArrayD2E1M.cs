...
namespace Tests
{
    public class NpgsqlPolygonpolygonMMArrayD2E1M
    {
        ...
        public NpgsqlPolygonpolygonMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPolygon[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonMMArrayD2E1M actual, NpgsqlPolygonpolygonMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
