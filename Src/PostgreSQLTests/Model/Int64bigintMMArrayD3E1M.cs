...
namespace Tests
{
    public class Int64bigintMMArrayD3E1M
    {
        ...
        public Int64bigintMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Int64[,,] NullableValue { get; set; }

        public static void AssertModel(Int64bigintMMArrayD3E1M actual, Int64bigintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
