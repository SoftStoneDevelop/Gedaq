...
namespace Tests
{
    public class NpgsqlPathpathMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlPathpathMArrayD11MIWA actual, NpgsqlPathpathMArrayD11MI expect, bool checkInInnerOnlyId)
        {
