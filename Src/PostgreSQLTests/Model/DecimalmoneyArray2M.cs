...
namespace Tests
{
    public class DecimalmoneyArray2M
    {
        ...
        public DecimalmoneyArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Decimal> NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyArray2M actual, DecimalmoneyArray2M expect, bool checkInInnerOnlyId)
        {
