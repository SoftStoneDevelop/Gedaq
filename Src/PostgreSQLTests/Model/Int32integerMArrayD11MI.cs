...
namespace Tests
{
    public class Int32integerMArrayD11MI
    {
        ...
        public static void AssertModel(Int32integerMArrayD11MI actual, Int32integerMArrayD11MI expect, bool checkInInnerOnlyId)
        {
