...
namespace Tests
{
    public class Doubledouble_precisionMArrayD1E1M
    {
        ...
        public Doubledouble_precisionMArrayD11MI ModelInner { get; set; }

        
        public System.Double[] NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionMArrayD1E1M actual, Doubledouble_precisionMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
