...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneE0MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneE0MIWA actual, DateTimetimestamp_without_time_zoneE0MI expect, bool checkInInnerOnlyId)
        {
