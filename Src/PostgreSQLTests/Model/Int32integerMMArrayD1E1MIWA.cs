...
namespace Tests
{
    public class Int32integerMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(Int32integerMMArrayD1E1MIWA actual, Int32integerMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
