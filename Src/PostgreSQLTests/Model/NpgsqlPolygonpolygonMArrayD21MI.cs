...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonMArrayD21MI actual, NpgsqlPolygonpolygonMArrayD21MI expect, bool checkInInnerOnlyId)
        {
