...
namespace Tests
{
    public class SinglerealArray2M
    {
        ...
        public SinglerealArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Single> NullableValue { get; set; }

        public static void AssertModel(SinglerealArray2M actual, SinglerealArray2M expect, bool checkInInnerOnlyId)
        {
