...
namespace Tests
{
    public class FlatDecimalnumericMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericMArrayD2E1M actual, DecimalnumericMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
