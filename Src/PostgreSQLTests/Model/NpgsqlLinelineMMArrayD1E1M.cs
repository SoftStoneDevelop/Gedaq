...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD1E1M
    {
        ...
        public NpgsqlLinelineMMArrayD1E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlLine[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlLinelineMMArrayD1E1M actual, NpgsqlLinelineMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
