...
namespace Tests
{
    public class FlatStringtextMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatStringtextMArrayD2E1M actual, StringtextMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
