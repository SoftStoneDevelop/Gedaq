...
namespace Tests
{
    public class BooleanbooleanArray1MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanArray1MIWA actual, BooleanbooleanArray1MI expect, bool checkInInnerOnlyId)
        {
