...
namespace Tests
{
    public class NpgsqlPointpointListD1E2MIWA
    {
        ...
        public static void AssertModel(NpgsqlPointpointListD1E2MIWA actual, NpgsqlPointpointListD1E2MI expect, bool checkInInnerOnlyId)
        {
