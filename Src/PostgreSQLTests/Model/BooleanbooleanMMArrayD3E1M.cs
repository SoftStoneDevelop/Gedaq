...
namespace Tests
{
    public class BooleanbooleanMMArrayD3E1M
    {
        ...
        public BooleanbooleanMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Boolean[,,] NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanMMArrayD3E1M actual, BooleanbooleanMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Boolean[,,])default));
