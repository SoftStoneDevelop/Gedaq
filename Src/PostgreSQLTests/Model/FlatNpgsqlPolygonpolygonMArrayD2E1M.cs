...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonMArrayD2E1M actual, NpgsqlPolygonpolygonMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
