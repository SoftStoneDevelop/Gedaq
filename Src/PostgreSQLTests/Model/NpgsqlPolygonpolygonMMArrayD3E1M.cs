...
namespace Tests
{
    public class NpgsqlPolygonpolygonMMArrayD3E1M
    {
        ...
        public NpgsqlPolygonpolygonMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPolygon[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonMMArrayD3E1M actual, NpgsqlPolygonpolygonMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
