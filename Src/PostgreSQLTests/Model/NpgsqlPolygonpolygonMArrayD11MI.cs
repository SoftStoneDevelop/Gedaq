...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD11MI
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonMArrayD11MI actual, NpgsqlPolygonpolygonMArrayD11MI expect, bool checkInInnerOnlyId)
        {
