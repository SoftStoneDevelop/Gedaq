...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMArrayD21MI
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMArrayD21MI actual, TimeOnlytime_without_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
