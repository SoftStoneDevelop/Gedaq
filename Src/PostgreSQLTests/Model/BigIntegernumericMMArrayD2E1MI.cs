...
namespace Tests
{
    public class BigIntegernumericMMArrayD2E1MI
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD2E1MI actual, BigIntegernumericMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
