...
namespace Tests
{
    public class DecimalnumericMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(DecimalnumericMMArrayD3E1MIWA actual, DecimalnumericMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
