...
namespace Tests
{
    public class Int16smallintMMArrayD2E1MI
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD2E1MI actual, Int16smallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
