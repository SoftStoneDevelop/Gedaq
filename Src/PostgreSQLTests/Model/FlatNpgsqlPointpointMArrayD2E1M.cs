...
namespace Tests
{
    public class FlatNpgsqlPointpointMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPointpointMArrayD2E1M actual, NpgsqlPointpointMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
