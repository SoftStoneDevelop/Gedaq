...
namespace Tests
{
    public class DateOnlydateMArrayD21MI
    {
        ...
        public static void AssertModel(DateOnlydateMArrayD21MI actual, DateOnlydateMArrayD21MI expect, bool checkInInnerOnlyId)
        {
