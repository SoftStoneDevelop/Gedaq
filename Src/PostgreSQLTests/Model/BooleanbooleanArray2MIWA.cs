...
namespace Tests
{
    public class BooleanbooleanArray2MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanArray2MIWA actual, BooleanbooleanArray2MI expect, bool checkInInnerOnlyId)
        {
