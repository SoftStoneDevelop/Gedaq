...
namespace Tests
{
    public class FlatDecimalnumericMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatDecimalnumericMMArrayD3E1M actual, DecimalnumericMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
