...
namespace Tests
{
    public class FlatInt16smallintMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt16smallintMMArrayD1E1M actual, Int16smallintMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
