...
namespace Tests
{
    public class StringtextMArrayD1E1M
    {
        ...
        public StringtextMArrayD11MI ModelInner { get; set; }

        
        public System.String[] NullableValue { get; set; }

        public static void AssertModel(StringtextMArrayD1E1M actual, StringtextMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
