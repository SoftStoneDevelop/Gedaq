...
namespace Tests
{
    public class Int16smallintMMArrayD2E1M
    {
        ...
        public Int16smallintMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Int16[,] NullableValue { get; set; }

        public static void AssertModel(Int16smallintMMArrayD2E1M actual, Int16smallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
