...
namespace Tests
{
    public class FlatInt16smallintMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatInt16smallintMMArrayD3E1M actual, Int16smallintMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
