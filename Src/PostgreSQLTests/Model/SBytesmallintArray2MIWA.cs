...
namespace Tests
{
    public class SBytesmallintArray2MIWA
    {
        ...
        public static void AssertModel(SBytesmallintArray2MIWA actual, SBytesmallintArray2MI expect, bool checkInInnerOnlyId)
        {
