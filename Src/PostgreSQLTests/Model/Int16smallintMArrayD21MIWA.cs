...
namespace Tests
{
    public class Int16smallintMArrayD21MIWA
    {
        ...
        public static void AssertModel(Int16smallintMArrayD21MIWA actual, Int16smallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
