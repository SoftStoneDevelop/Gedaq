...
namespace Tests
{
    public class NpgsqlPolygonpolygonArray2MIWA
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonArray2MIWA actual, NpgsqlPolygonpolygonArray2MI expect, bool checkInInnerOnlyId)
        {
