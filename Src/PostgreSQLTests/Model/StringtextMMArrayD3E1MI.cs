...
namespace Tests
{
    public class StringtextMMArrayD3E1MI
    {
        ...
        public static void AssertModel(StringtextMMArrayD3E1MI actual, StringtextMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
