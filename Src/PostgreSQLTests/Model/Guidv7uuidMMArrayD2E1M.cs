...
namespace Tests
{
    public class Guidv7uuidMMArrayD2E1M
    {
        ...
        public Guidv7uuidMMArrayD2E1MI ModelInner { get; set; }

        
        public System.Guid[,] NullableValue { get; set; }

        public static void AssertModel(Guidv7uuidMMArrayD2E1M actual, Guidv7uuidMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
