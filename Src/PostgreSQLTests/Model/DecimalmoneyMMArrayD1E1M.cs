...
namespace Tests
{
    public class DecimalmoneyMMArrayD1E1M
    {
        ...
        public DecimalmoneyMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Decimal[] NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyMMArrayD1E1M actual, DecimalmoneyMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
