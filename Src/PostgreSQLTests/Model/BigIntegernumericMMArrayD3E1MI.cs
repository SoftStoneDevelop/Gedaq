...
namespace Tests
{
    public class BigIntegernumericMMArrayD3E1MI
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD3E1MI actual, BigIntegernumericMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
