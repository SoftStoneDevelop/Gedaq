...
namespace Tests
{
    public class SinglerealMArrayD1E1M
    {
        ...
        public SinglerealMArrayD11MI ModelInner { get; set; }

        
        public System.Single[] NullableValue { get; set; }

        public static void AssertModel(SinglerealMArrayD1E1M actual, SinglerealMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
