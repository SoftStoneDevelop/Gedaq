...
namespace Tests
{
    public class NpgsqlCirclecircleListD12MIWA
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleListD12MIWA actual, NpgsqlCirclecircleListD12MI expect, bool checkInInnerOnlyId)
        {
