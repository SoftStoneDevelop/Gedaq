...
namespace Tests
{
    public class DecimalnumericArray2MIWA
    {
        ...
        public static void AssertModel(DecimalnumericArray2MIWA actual, DecimalnumericArray2MI expect, bool checkInInnerOnlyId)
        {
