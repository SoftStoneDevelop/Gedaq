...
namespace Tests
{
    public class FlatBooleanbooleanMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanMMArrayD2E1M actual, BooleanbooleanMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
