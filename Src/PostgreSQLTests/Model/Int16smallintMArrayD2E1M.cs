...
namespace Tests
{
    public class Int16smallintMArrayD2E1M
    {
        ...
        public Int16smallintMArrayD21MI ModelInner { get; set; }

        
        public System.Int16[,] NullableValue { get; set; }

        public static void AssertModel(Int16smallintMArrayD2E1M actual, Int16smallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
