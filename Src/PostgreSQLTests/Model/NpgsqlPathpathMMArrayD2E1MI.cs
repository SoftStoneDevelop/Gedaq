...
namespace Tests
{
    public class NpgsqlPathpathMMArrayD2E1MI
    {
        ...
        public static void AssertModel(NpgsqlPathpathMMArrayD2E1MI actual, NpgsqlPathpathMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
