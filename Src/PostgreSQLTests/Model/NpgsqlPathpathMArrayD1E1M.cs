...
namespace Tests
{
    public class NpgsqlPathpathMArrayD1E1M
    {
        ...
        public NpgsqlPathpathMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPath[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPathpathMArrayD1E1M actual, NpgsqlPathpathMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
