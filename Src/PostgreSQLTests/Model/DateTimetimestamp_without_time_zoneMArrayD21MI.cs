...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMArrayD21MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMArrayD21MI actual, DateTimetimestamp_without_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
