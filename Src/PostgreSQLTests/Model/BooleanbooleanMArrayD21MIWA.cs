...
namespace Tests
{
    public class BooleanbooleanMArrayD21MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanMArrayD21MIWA actual, BooleanbooleanMArrayD21MI expect, bool checkInInnerOnlyId)
        {
