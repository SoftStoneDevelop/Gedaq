...
namespace Tests
{
    public class NpgsqlCirclecircleArray1MI
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleArray1MI actual, NpgsqlCirclecircleArray1MI expect, bool checkInInnerOnlyId)
        {
