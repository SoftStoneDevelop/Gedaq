...
namespace Tests
{
    public class FlatNpgsqlCirclecircleMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleMMArrayD2E1M actual, NpgsqlCirclecircleMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
