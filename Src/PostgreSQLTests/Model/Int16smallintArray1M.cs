...
namespace Tests
{
    public class Int16smallintArray1M
    {
        ...
        public Int16smallintArray1MI ModelInner { get; set; }

        
        public System.Int16[] NullableValue { get; set; }

        public static void AssertModel(Int16smallintArray1M actual, Int16smallintArray1M expect, bool checkInInnerOnlyId)
        {
