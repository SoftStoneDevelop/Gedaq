...
namespace Tests
{
    public class BigIntegernumericMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(BigIntegernumericMMArrayD1E1MIWA actual, BigIntegernumericMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
