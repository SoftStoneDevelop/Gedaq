...
namespace Tests
{
    public class NpgsqlBoxboxListD12MIWA
    {
        ...
        public static void AssertModel(NpgsqlBoxboxListD12MIWA actual, NpgsqlBoxboxListD12MI expect, bool checkInInnerOnlyId)
        {
