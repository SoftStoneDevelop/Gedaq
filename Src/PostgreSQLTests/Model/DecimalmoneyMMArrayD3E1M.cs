...
namespace Tests
{
    public class DecimalmoneyMMArrayD3E1M
    {
        ...
        public DecimalmoneyMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Decimal[,,] NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyMMArrayD3E1M actual, DecimalmoneyMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
