...
namespace Tests
{
    public class FlatGuidv7uuidMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatGuidv7uuidMMArrayD2E1M actual, Guidv7uuidMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
