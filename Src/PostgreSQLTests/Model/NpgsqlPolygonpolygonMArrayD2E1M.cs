...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD2E1M
    {
        ...
        public NpgsqlPolygonpolygonMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPolygon[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPolygonpolygonMArrayD2E1M actual, NpgsqlPolygonpolygonMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
