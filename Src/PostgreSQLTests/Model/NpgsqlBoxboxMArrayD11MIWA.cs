...
namespace Tests
{
    public class NpgsqlBoxboxMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlBoxboxMArrayD11MIWA actual, NpgsqlBoxboxMArrayD11MI expect, bool checkInInnerOnlyId)
        {
