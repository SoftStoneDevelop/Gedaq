...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMMArrayD1E1MI
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMMArrayD1E1MI actual, TimeOnlytime_without_time_zoneMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
