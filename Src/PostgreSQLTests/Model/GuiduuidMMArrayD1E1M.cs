...
namespace Tests
{
    public class GuiduuidMMArrayD1E1M
    {
        ...
        public GuiduuidMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Guid[] NullableValue { get; set; }

        public static void AssertModel(GuiduuidMMArrayD1E1M actual, GuiduuidMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
