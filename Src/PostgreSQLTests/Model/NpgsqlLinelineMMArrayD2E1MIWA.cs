...
namespace Tests
{
    public class NpgsqlLinelineMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineMMArrayD2E1MIWA actual, NpgsqlLinelineMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
