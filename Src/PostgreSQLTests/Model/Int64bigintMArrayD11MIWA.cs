...
namespace Tests
{
    public class Int64bigintMArrayD11MIWA
    {
        ...
        public static void AssertModel(Int64bigintMArrayD11MIWA actual, Int64bigintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
