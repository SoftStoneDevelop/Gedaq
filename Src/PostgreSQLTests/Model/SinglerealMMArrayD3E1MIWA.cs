...
namespace Tests
{
    public class SinglerealMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(SinglerealMMArrayD3E1MIWA actual, SinglerealMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
