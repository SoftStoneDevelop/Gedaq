...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonE0M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonE0M actual, NpgsqlPolygonpolygonE0M expect, bool checkInInnerOnlyId)
        {
