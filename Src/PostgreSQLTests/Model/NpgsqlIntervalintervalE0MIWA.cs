...
namespace Tests
{
    public class NpgsqlIntervalintervalE0MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalE0MIWA actual, NpgsqlIntervalintervalE0MI expect, bool checkInInnerOnlyId)
        {
