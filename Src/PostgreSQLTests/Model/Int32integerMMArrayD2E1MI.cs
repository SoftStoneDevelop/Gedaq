...
namespace Tests
{
    public class Int32integerMMArrayD2E1MI
    {
        ...
        public static void AssertModel(Int32integerMMArrayD2E1MI actual, Int32integerMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
