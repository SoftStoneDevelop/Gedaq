...
namespace Tests
{
    public class FlatInt32integerMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatInt32integerMArrayD1E1M actual, Int32integerMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
