...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD1E1MI
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMMArrayD1E1MI actual, NpgsqlIntervalintervalMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
