...
namespace Tests
{
    public class BytesmallintMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD3E1MIWA actual, BytesmallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
