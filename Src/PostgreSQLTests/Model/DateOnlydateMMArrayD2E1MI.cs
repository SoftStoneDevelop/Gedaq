...
namespace Tests
{
    public class DateOnlydateMMArrayD2E1MI
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD2E1MI actual, DateOnlydateMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
