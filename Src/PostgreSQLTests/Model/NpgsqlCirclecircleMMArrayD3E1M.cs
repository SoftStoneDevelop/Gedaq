...
namespace Tests
{
    public class NpgsqlCirclecircleMMArrayD3E1M
    {
        ...
        public NpgsqlCirclecircleMMArrayD3E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlCircle[,,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleMMArrayD3E1M actual, NpgsqlCirclecircleMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
