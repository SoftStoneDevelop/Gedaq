...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD21MIWA
    {
        ...
        public static void AssertModel(NpgsqlIntervalintervalMArrayD21MIWA actual, NpgsqlIntervalintervalMArrayD21MI expect, bool checkInInnerOnlyId)
        {
