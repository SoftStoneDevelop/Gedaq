...
namespace Tests
{
    public class TimeSpanintervalArray2MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalArray2MIWA actual, TimeSpanintervalArray2MI expect, bool checkInInnerOnlyId)
        {
