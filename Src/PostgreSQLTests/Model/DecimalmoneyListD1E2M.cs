...
namespace Tests
{
    public class DecimalmoneyListD1E2M
    {
        ...
        public DecimalmoneyListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Decimal> NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyListD1E2M actual, DecimalmoneyListD1E2M expect, bool checkInInnerOnlyId)
        {
