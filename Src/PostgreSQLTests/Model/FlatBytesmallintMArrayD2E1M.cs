...
namespace Tests
{
    public class FlatBytesmallintMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBytesmallintMArrayD2E1M actual, BytesmallintMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
