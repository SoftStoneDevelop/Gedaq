...
namespace Tests
{
    public class NpgsqlPathpathArray1MIWA
    {
        ...
        public static void AssertModel(NpgsqlPathpathArray1MIWA actual, NpgsqlPathpathArray1MI expect, bool checkInInnerOnlyId)
        {
