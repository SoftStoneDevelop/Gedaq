...
namespace Tests
{
    public class DecimalmoneyE0MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyE0MIWA actual, DecimalmoneyE0MI expect, bool checkInInnerOnlyId)
        {
