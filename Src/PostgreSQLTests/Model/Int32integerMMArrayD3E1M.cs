...
namespace Tests
{
    public class Int32integerMMArrayD3E1M
    {
        ...
        public Int32integerMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Int32[,,] NullableValue { get; set; }

        public static void AssertModel(Int32integerMMArrayD3E1M actual, Int32integerMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
