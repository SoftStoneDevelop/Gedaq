...
namespace Tests
{
    public class Int64bigintMArrayD21MIWA
    {
        ...
        public static void AssertModel(Int64bigintMArrayD21MIWA actual, Int64bigintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
