...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMArrayD2E1M
    {
        ...
        public DateTimetimestamp_without_time_zoneMArrayD21MI ModelInner { get; set; }

        
        public System.DateTime[,] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_without_time_zoneMArrayD2E1M actual, DateTimetimestamp_without_time_zoneMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
