...
namespace Tests
{
    public class IPAddressinetArray2MIWA
    {
        ...
        public static void AssertModel(IPAddressinetArray2MIWA actual, IPAddressinetArray2MI expect, bool checkInInnerOnlyId)
        {
