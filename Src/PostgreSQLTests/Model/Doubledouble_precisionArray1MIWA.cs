...
namespace Tests
{
    public class Doubledouble_precisionArray1MIWA
    {
        ...
        public static void AssertModel(Doubledouble_precisionArray1MIWA actual, Doubledouble_precisionArray1MI expect, bool checkInInnerOnlyId)
        {
