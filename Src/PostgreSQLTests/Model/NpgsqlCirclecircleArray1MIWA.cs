...
namespace Tests
{
    public class NpgsqlCirclecircleArray1MIWA
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleArray1MIWA actual, NpgsqlCirclecircleArray1MI expect, bool checkInInnerOnlyId)
        {
