...
namespace Tests
{
    public class NpgsqlLinelineMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineMArrayD11MIWA actual, NpgsqlLinelineMArrayD11MI expect, bool checkInInnerOnlyId)
        {
