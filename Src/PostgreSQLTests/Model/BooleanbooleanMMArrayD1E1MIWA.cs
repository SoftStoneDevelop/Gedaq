...
namespace Tests
{
    public class BooleanbooleanMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD1E1MIWA actual, BooleanbooleanMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
