...
namespace Tests
{
    public class NpgsqlPolygonpolygonMArrayD11MIWA
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonMArrayD11MIWA actual, NpgsqlPolygonpolygonMArrayD11MI expect, bool checkInInnerOnlyId)
        {
