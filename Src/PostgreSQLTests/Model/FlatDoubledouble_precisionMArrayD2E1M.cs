...
namespace Tests
{
    public class FlatDoubledouble_precisionMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDoubledouble_precisionMArrayD2E1M actual, Doubledouble_precisionMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
