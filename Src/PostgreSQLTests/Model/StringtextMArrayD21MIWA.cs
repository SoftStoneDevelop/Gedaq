...
namespace Tests
{
    public class StringtextMArrayD21MIWA
    {
        ...
        public static void AssertModel(StringtextMArrayD21MIWA actual, StringtextMArrayD21MI expect, bool checkInInnerOnlyId)
        {
