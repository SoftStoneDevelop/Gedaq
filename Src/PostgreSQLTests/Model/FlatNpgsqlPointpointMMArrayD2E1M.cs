...
namespace Tests
{
    public class FlatNpgsqlPointpointMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPointpointMMArrayD2E1M actual, NpgsqlPointpointMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
