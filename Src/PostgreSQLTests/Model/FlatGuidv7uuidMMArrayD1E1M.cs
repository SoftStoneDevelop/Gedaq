...
namespace Tests
{
    public class FlatGuidv7uuidMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatGuidv7uuidMMArrayD1E1M actual, Guidv7uuidMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
