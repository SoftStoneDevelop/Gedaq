...
namespace Tests
{
    public class NpgsqlBoxboxMArrayD1E1M
    {
        ...
        public NpgsqlBoxboxMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlBox[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlBoxboxMArrayD1E1M actual, NpgsqlBoxboxMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
