...
namespace Tests
{
    public class IPAddressinetMMArrayD1E1M
    {
        ...
        public IPAddressinetMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Net.IPAddress[] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetMMArrayD1E1M actual, IPAddressinetMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
