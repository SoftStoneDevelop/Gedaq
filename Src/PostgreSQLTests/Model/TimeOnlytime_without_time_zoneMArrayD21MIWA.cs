...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMArrayD21MIWA
    {
        ...
        public static void AssertModel(TimeOnlytime_without_time_zoneMArrayD21MIWA actual, TimeOnlytime_without_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
