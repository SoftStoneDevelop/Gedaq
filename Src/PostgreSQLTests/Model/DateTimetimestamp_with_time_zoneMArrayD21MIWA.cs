...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneMArrayD21MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zoneMArrayD21MIWA actual, DateTimetimestamp_with_time_zoneMArrayD21MI expect, bool checkInInnerOnlyId)
        {
