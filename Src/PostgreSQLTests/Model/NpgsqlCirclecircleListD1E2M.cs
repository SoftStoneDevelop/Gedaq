...
namespace Tests
{
    public class NpgsqlCirclecircleListD1E2M
    {
        ...
        public NpgsqlCirclecircleListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlCircle> NullableValue { get; set; }

        public static void AssertModel(NpgsqlCirclecircleListD1E2M actual, NpgsqlCirclecircleListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<NpgsqlTypes.NpgsqlCircle>)default));
