...
namespace Tests
{
    public class SinglerealMArrayD2E1M
    {
        ...
        public SinglerealMArrayD21MI ModelInner { get; set; }

        
        public System.Single[,] NullableValue { get; set; }

        public static void AssertModel(SinglerealMArrayD2E1M actual, SinglerealMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
