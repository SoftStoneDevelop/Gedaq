...
namespace Tests
{
    public class GuiduuidMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(GuiduuidMMArrayD3E1MIWA actual, GuiduuidMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
