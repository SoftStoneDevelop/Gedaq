...
namespace Tests
{
    public class FlatDateTimetimestamp_with_time_zoneArray1M
    {
        ...
        public static void AssertModel(FlatDateTimetimestamp_with_time_zoneArray1M actual, DateTimetimestamp_with_time_zoneArray1M expect, bool checkInInnerOnlyId)
        {
