...
namespace Tests
{
    public class FlatDecimalmoneyMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatDecimalmoneyMArrayD2E1M actual, DecimalmoneyMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
