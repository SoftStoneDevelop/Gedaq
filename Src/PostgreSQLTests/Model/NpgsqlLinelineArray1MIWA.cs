...
namespace Tests
{
    public class NpgsqlLinelineArray1MIWA
    {
        ...
        public static void AssertModel(NpgsqlLinelineArray1MIWA actual, NpgsqlLinelineArray1MI expect, bool checkInInnerOnlyId)
        {
