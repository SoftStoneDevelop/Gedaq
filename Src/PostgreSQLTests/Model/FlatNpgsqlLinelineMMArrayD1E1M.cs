...
namespace Tests
{
    public class FlatNpgsqlLinelineMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlLinelineMMArrayD1E1M actual, NpgsqlLinelineMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
