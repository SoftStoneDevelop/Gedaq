...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMArrayD11MI
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMArrayD11MI actual, DateTimetimestamp_without_time_zoneMArrayD11MI expect, bool checkInInnerOnlyId)
        {
