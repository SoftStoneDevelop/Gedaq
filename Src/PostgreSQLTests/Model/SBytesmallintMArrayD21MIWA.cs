...
namespace Tests
{
    public class SBytesmallintMArrayD21MIWA
    {
        ...
        public static void AssertModel(SBytesmallintMArrayD21MIWA actual, SBytesmallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
