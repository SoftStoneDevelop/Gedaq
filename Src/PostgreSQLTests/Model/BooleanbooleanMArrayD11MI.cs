...
namespace Tests
{
    public class BooleanbooleanMArrayD11MI
    {
        ...
        public static void AssertModel(BooleanbooleanMArrayD11MI actual, BooleanbooleanMArrayD11MI expect, bool checkInInnerOnlyId)
        {
