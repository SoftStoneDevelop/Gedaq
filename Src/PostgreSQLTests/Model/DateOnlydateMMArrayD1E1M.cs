...
namespace Tests
{
    public class DateOnlydateMMArrayD1E1M
    {
        ...
        public DateOnlydateMMArrayD1E1MI ModelInner { get; set; }

        
        public System.DateOnly[] NullableValue { get; set; }

        public static void AssertModel(DateOnlydateMMArrayD1E1M actual, DateOnlydateMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
