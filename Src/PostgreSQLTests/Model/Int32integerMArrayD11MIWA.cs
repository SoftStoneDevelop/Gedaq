...
namespace Tests
{
    public class Int32integerMArrayD11MIWA
    {
        ...
        public static void AssertModel(Int32integerMArrayD11MIWA actual, Int32integerMArrayD11MI expect, bool checkInInnerOnlyId)
        {
