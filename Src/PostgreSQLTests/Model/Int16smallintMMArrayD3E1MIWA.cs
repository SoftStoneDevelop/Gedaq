...
namespace Tests
{
    public class Int16smallintMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD3E1MIWA actual, Int16smallintMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
