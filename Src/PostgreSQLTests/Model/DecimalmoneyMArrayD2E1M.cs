...
namespace Tests
{
    public class DecimalmoneyMArrayD2E1M
    {
        ...
        public DecimalmoneyMArrayD21MI ModelInner { get; set; }

        
        public System.Decimal[,] NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyMArrayD2E1M actual, DecimalmoneyMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
