...
namespace Tests
{
    public class SBytesmallintMArrayD21MI
    {
        ...
        public static void AssertModel(SBytesmallintMArrayD21MI actual, SBytesmallintMArrayD21MI expect, bool checkInInnerOnlyId)
        {
