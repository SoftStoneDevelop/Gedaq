...
namespace Tests
{
    public class DecimalnumericMArrayD2E1M
    {
        ...
        public DecimalnumericMArrayD21MI ModelInner { get; set; }

        
        public System.Decimal[,] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericMArrayD2E1M actual, DecimalnumericMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
