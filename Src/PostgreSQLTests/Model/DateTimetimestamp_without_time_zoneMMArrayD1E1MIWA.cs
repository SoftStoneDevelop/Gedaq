...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMMArrayD1E1MIWA actual, DateTimetimestamp_without_time_zoneMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
