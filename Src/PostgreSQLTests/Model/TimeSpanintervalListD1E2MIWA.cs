...
namespace Tests
{
    public class TimeSpanintervalListD1E2MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalListD1E2MIWA actual, TimeSpanintervalListD1E2MI expect, bool checkInInnerOnlyId)
        {
