...
namespace Tests
{
    public class DecimalmoneyE0M
    {
        ...
        public DecimalmoneyE0MI ModelInner { get; set; }

        
        public System.Decimal? NullableValue { get; set; }

        public static void AssertModel(DecimalmoneyE0M actual, DecimalmoneyE0M expect, bool checkInInnerOnlyId)
        {
