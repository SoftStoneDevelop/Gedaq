...
namespace Tests
{
    public class Int16smallintMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(Int16smallintMMArrayD1E1MIWA actual, Int16smallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
