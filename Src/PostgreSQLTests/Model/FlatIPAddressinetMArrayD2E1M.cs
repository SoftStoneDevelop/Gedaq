...
namespace Tests
{
    public class FlatIPAddressinetMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatIPAddressinetMArrayD2E1M actual, IPAddressinetMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
