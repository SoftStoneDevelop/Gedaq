...
namespace Tests
{
    public class BooleanbooleanMMArrayD1E1M
    {
        ...
        public BooleanbooleanMMArrayD1E1MI ModelInner { get; set; }

        
        public System.Boolean[] NullableValue { get; set; }

        public static void AssertModel(BooleanbooleanMMArrayD1E1M actual, BooleanbooleanMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
