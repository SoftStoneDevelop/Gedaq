...
namespace Tests
{
    public class TimeSpanintervalListD12MIWA
    {
        ...
        public static void AssertModel(TimeSpanintervalListD12MIWA actual, TimeSpanintervalListD12MI expect, bool checkInInnerOnlyId)
        {
