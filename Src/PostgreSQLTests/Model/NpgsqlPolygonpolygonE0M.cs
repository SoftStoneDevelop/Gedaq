...
namespace Tests
{
    public class NpgsqlPolygonpolygonE0M
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonE0M actual, NpgsqlPolygonpolygonE0M expect, bool checkInInnerOnlyId)
        {
