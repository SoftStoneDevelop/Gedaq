...
namespace Tests
{
    public class NpgsqlPathpathListD12MIWA
    {
        ...
        public static void AssertModel(NpgsqlPathpathListD12MIWA actual, NpgsqlPathpathListD12MI expect, bool checkInInnerOnlyId)
        {
