...
namespace Tests
{
    public class Int16smallintMArrayD11MI
    {
        ...
        public static void AssertModel(Int16smallintMArrayD11MI actual, Int16smallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
