...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneMArrayD1E1M
    {
        ...
        public TimeOnlytime_without_time_zoneMArrayD11MI ModelInner { get; set; }

        
        public System.TimeOnly[] NullableValue { get; set; }

        public static void AssertModel(TimeOnlytime_without_time_zoneMArrayD1E1M actual, TimeOnlytime_without_time_zoneMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
