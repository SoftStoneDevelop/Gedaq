...
namespace Tests
{
    public class IPAddressinetListD1E2MIWA
    {
        ...
        public static void AssertModel(IPAddressinetListD1E2MIWA actual, IPAddressinetListD1E2MI expect, bool checkInInnerOnlyId)
        {
