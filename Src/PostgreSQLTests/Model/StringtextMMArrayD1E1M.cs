...
namespace Tests
{
    public class StringtextMMArrayD1E1M
    {
        ...
        public StringtextMMArrayD1E1MI ModelInner { get; set; }

        
        public System.String[] NullableValue { get; set; }

        public static void AssertModel(StringtextMMArrayD1E1M actual, StringtextMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
