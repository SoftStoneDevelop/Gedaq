...
namespace Tests
{
    public class NpgsqlPathpathMArrayD2E1M
    {
        ...
        public NpgsqlPathpathMArrayD21MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPath[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPathpathMArrayD2E1M actual, NpgsqlPathpathMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
