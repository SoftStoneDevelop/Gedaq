...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMMArrayD2E1M
    {
        ...
        public DateTimetimestamp_without_time_zoneMMArrayD2E1MI ModelInner { get; set; }

        
        public System.DateTime[,] NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_without_time_zoneMMArrayD2E1M actual, DateTimetimestamp_without_time_zoneMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
