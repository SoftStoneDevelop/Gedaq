...
namespace Tests
{
    public class BytesmallintArray1M
    {
        ...
        public BytesmallintArray1MI ModelInner { get; set; }

        
        public System.Byte[] NullableValue { get; set; }

        public static void AssertModel(BytesmallintArray1M actual, BytesmallintArray1M expect, bool checkInInnerOnlyId)
        {
