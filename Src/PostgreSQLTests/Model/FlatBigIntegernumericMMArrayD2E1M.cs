...
namespace Tests
{
    public class FlatBigIntegernumericMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatBigIntegernumericMMArrayD2E1M actual, BigIntegernumericMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
