...
namespace Tests
{
    public class FlatGuiduuidMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatGuiduuidMMArrayD3E1M actual, GuiduuidMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
