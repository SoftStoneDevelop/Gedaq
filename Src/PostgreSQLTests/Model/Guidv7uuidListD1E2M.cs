...
namespace Tests
{
    public class Guidv7uuidListD1E2M
    {
        ...
        public Guidv7uuidListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Guid> NullableValue { get; set; }

        public static void AssertModel(Guidv7uuidListD1E2M actual, Guidv7uuidListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<System.Guid>)default));
