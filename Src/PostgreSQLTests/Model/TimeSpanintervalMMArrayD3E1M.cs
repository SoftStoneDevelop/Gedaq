...
namespace Tests
{
    public class TimeSpanintervalMMArrayD3E1M
    {
        ...
        public TimeSpanintervalMMArrayD3E1MI ModelInner { get; set; }

        
        public System.TimeSpan[,,] NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalMMArrayD3E1M actual, TimeSpanintervalMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.TimeSpan[,,])default));
