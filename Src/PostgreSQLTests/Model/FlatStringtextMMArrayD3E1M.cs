...
namespace Tests
{
    public class FlatStringtextMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatStringtextMMArrayD3E1M actual, StringtextMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
