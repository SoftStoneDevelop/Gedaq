...
namespace Tests
{
    public class Doubledouble_precisionE0M
    {
        ...
        public Doubledouble_precisionE0MI ModelInner { get; set; }

        
        public System.Double? NullableValue { get; set; }

        public static void AssertModel(Doubledouble_precisionE0M actual, Doubledouble_precisionE0M expect, bool checkInInnerOnlyId)
        {
