...
namespace Tests
{
    public class DateTimetimestamp_with_time_zone0M
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zone0M actual, DateTimetimestamp_with_time_zone0M expect, bool checkInInnerOnlyId)
        {
