...
namespace Tests
{
    public class FlatSinglerealMMArrayD3E1M
    {
        ...
        public static void AssertModel(FlatSinglerealMMArrayD3E1M actual, SinglerealMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
