...
namespace Tests
{
    public class FlatNpgsqlPathpathMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathMArrayD2E1M actual, NpgsqlPathpathMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
