...
namespace Tests
{
    public class DateTimetimestamp_with_time_zone0MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_with_time_zone0MIWA actual, DateTimetimestamp_with_time_zone0MI expect, bool checkInInnerOnlyId)
        {
