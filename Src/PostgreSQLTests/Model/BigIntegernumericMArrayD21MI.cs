...
namespace Tests
{
    public class BigIntegernumericMArrayD21MI
    {
        ...
        public static void AssertModel(BigIntegernumericMArrayD21MI actual, BigIntegernumericMArrayD21MI expect, bool checkInInnerOnlyId)
        {
