...
namespace Tests
{
    public class BytesmallintListD1E2MIWA
    {
        ...
        public static void AssertModel(BytesmallintListD1E2MIWA actual, BytesmallintListD1E2MI expect, bool checkInInnerOnlyId)
        {
