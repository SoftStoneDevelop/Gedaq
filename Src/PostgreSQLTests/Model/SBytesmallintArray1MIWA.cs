...
namespace Tests
{
    public class SBytesmallintArray1MIWA
    {
        ...
        public static void AssertModel(SBytesmallintArray1MIWA actual, SBytesmallintArray1MI expect, bool checkInInnerOnlyId)
        {
