...
namespace Tests
{
    public class DateTimetimestamp_with_time_zoneE0M
    {
        ...
        public DateTimetimestamp_with_time_zoneE0MI ModelInner { get; set; }

        
        public System.DateTime? NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_with_time_zoneE0M actual, DateTimetimestamp_with_time_zoneE0M expect, bool checkInInnerOnlyId)
        {
