...
namespace Tests
{
    public class IPAddressinetMMArrayD3E1M
    {
        ...
        public IPAddressinetMMArrayD3E1MI ModelInner { get; set; }

        
        public System.Net.IPAddress[,,] NullableValue { get; set; }

        public static void AssertModel(IPAddressinetMMArrayD3E1M actual, IPAddressinetMMArrayD3E1M expect, bool checkInInnerOnlyId)
        {
