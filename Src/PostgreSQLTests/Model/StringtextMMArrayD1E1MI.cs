...
namespace Tests
{
    public class StringtextMMArrayD1E1MI
    {
        ...
        public static void AssertModel(StringtextMMArrayD1E1MI actual, StringtextMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
