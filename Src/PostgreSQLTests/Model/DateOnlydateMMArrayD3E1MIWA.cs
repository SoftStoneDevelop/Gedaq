...
namespace Tests
{
    public class DateOnlydateMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD3E1MIWA actual, DateOnlydateMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
