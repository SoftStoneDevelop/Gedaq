...
namespace Tests
{
    public class FlatInt16smallintMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatInt16smallintMMArrayD2E1M actual, Int16smallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
