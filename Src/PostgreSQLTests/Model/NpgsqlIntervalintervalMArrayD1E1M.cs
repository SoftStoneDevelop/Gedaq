...
namespace Tests
{
    public class NpgsqlIntervalintervalMArrayD1E1M
    {
        ...
        public NpgsqlIntervalintervalMArrayD11MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlInterval[] NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalMArrayD1E1M actual, NpgsqlIntervalintervalMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
