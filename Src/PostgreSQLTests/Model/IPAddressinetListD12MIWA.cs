...
namespace Tests
{
    public class IPAddressinetListD12MIWA
    {
        ...
        public static void AssertModel(IPAddressinetListD12MIWA actual, IPAddressinetListD12MI expect, bool checkInInnerOnlyId)
        {
