...
namespace Tests
{
    public class FlatStringtextMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatStringtextMArrayD1E1M actual, StringtextMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
