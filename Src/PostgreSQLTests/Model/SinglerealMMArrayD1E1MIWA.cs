...
namespace Tests
{
    public class SinglerealMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(SinglerealMMArrayD1E1MIWA actual, SinglerealMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
