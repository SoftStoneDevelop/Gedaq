...
namespace Tests
{
    public class TimeSpanintervalMArrayD1E1M
    {
        ...
        public TimeSpanintervalMArrayD11MI ModelInner { get; set; }

        
        public System.TimeSpan[] NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalMArrayD1E1M actual, TimeSpanintervalMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
