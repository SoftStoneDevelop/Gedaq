...
namespace Tests
{
    public class BigIntegernumericMArrayD1E1M
    {
        ...
        public BigIntegernumericMArrayD11MI ModelInner { get; set; }

        
        public System.Numerics.BigInteger[] NullableValue { get; set; }

        public static void AssertModel(BigIntegernumericMArrayD1E1M actual, BigIntegernumericMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
