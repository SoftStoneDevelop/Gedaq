...
namespace Tests
{
    public class DecimalmoneyListD1E2MIWA
    {
        ...
        public static void AssertModel(DecimalmoneyListD1E2MIWA actual, DecimalmoneyListD1E2MI expect, bool checkInInnerOnlyId)
        {
