...
namespace Tests
{
    public class NpgsqlCirclecircleMArrayD21MI
    {
        ...
        public static void AssertModel(NpgsqlCirclecircleMArrayD21MI actual, NpgsqlCirclecircleMArrayD21MI expect, bool checkInInnerOnlyId)
        {
