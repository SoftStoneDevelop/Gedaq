...
namespace Tests
{
    public class NpgsqlIntervalintervalMMArrayD2E1M
    {
        ...
        public NpgsqlIntervalintervalMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlInterval[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalMMArrayD2E1M actual, NpgsqlIntervalintervalMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
