...
namespace Tests
{
    public class DateOnlydateMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(DateOnlydateMMArrayD2E1MIWA actual, DateOnlydateMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
