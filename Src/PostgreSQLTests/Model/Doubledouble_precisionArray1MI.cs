...
namespace Tests
{
    public class Doubledouble_precisionArray1MI
    {
        ...
        public static void AssertModel(Doubledouble_precisionArray1MI actual, Doubledouble_precisionArray1MI expect, bool checkInInnerOnlyId)
        {
