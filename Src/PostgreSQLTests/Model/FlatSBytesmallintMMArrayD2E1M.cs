...
namespace Tests
{
    public class FlatSBytesmallintMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatSBytesmallintMMArrayD2E1M actual, SBytesmallintMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
