...
namespace Tests
{
    public class FlatNpgsqlPathpathMMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathMMArrayD2E1M actual, NpgsqlPathpathMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
