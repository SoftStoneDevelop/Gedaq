...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneMMArrayD3E1MIWA
    {
        ...
        public static void AssertModel(DateTimetimestamp_without_time_zoneMMArrayD3E1MIWA actual, DateTimetimestamp_without_time_zoneMMArrayD3E1MI expect, bool checkInInnerOnlyId)
        {
