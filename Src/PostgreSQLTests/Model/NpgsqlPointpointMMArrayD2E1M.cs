...
namespace Tests
{
    public class NpgsqlPointpointMMArrayD2E1M
    {
        ...
        public NpgsqlPointpointMMArrayD2E1MI ModelInner { get; set; }

        
        public NpgsqlTypes.NpgsqlPoint[,] NullableValue { get; set; }

        public static void AssertModel(NpgsqlPointpointMMArrayD2E1M actual, NpgsqlPointpointMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((NpgsqlTypes.NpgsqlPoint[,])default));
