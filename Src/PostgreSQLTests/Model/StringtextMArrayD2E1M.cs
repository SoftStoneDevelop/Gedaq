...
namespace Tests
{
    public class StringtextMArrayD2E1M
    {
        ...
        public StringtextMArrayD21MI ModelInner { get; set; }

        
        public System.String[,] NullableValue { get; set; }

        public static void AssertModel(StringtextMArrayD2E1M actual, StringtextMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
