...
namespace Tests
{
    public class NpgsqlPolygonpolygonArray1MI
    {
        ...
        public static void AssertModel(NpgsqlPolygonpolygonArray1MI actual, NpgsqlPolygonpolygonArray1MI expect, bool checkInInnerOnlyId)
        {
