...
namespace Tests
{
    public class FlatNpgsqlCirclecircleMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleMArrayD2E1M actual, NpgsqlCirclecircleMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
