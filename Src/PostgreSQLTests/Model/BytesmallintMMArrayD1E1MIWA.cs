...
namespace Tests
{
    public class BytesmallintMMArrayD1E1MIWA
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD1E1MIWA actual, BytesmallintMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
