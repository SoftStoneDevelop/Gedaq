...
namespace Tests
{
    public class BytesmallintMMArrayD2E1MIWA
    {
        ...
        public static void AssertModel(BytesmallintMMArrayD2E1MIWA actual, BytesmallintMMArrayD2E1MI expect, bool checkInInnerOnlyId)
        {
