...
namespace Tests
{
    public class NpgsqlIntervalintervalListD1E2M
    {
        ...
        public NpgsqlIntervalintervalListD1E2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<NpgsqlTypes.NpgsqlInterval> NullableValue { get; set; }

        public static void AssertModel(NpgsqlIntervalintervalListD1E2M actual, NpgsqlIntervalintervalListD1E2M expect, bool checkInInnerOnlyId)
        {
                ...
                else
                {
                    ...
                    {
                        Assert.That(actual.ModelInner.Value, Is.EqualTo((System.Collections.Generic.List<NpgsqlTypes.NpgsqlInterval>)default));
