...
namespace Tests
{
    public class FlatNpgsqlLinelineMArrayD2E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlLinelineMArrayD2E1M actual, NpgsqlLinelineMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
