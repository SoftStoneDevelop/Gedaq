...
namespace Tests
{
    public class Int32integerArray2M
    {
        ...
        public Int32integerArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.Int32> NullableValue { get; set; }

        public static void AssertModel(Int32integerArray2M actual, Int32integerArray2M expect, bool checkInInnerOnlyId)
        {
