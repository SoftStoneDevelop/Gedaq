...
namespace Tests
{
    public class DecimalnumericMArrayD11MIWA
    {
        ...
        public static void AssertModel(DecimalnumericMArrayD11MIWA actual, DecimalnumericMArrayD11MI expect, bool checkInInnerOnlyId)
        {
