...
namespace Tests
{
    public class FlatNpgsqlCirclecircleArray2M
    {
        ...
        public static void AssertModel(FlatNpgsqlCirclecircleArray2M actual, NpgsqlCirclecircleArray2M expect, bool checkInInnerOnlyId)
        {
