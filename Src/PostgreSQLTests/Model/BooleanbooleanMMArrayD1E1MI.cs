...
namespace Tests
{
    public class BooleanbooleanMMArrayD1E1MI
    {
        ...
        public static void AssertModel(BooleanbooleanMMArrayD1E1MI actual, BooleanbooleanMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
