...
namespace Tests
{
    public class StringtextMMArrayD2E1M
    {
        ...
        public StringtextMMArrayD2E1MI ModelInner { get; set; }

        
        public System.String[,] NullableValue { get; set; }

        public static void AssertModel(StringtextMMArrayD2E1M actual, StringtextMMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
