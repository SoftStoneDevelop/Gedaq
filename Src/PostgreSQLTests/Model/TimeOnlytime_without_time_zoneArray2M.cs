...
namespace Tests
{
    public class TimeOnlytime_without_time_zoneArray2M
    {
        ...
        public TimeOnlytime_without_time_zoneArray2MI ModelInner { get; set; }

        
        public System.Collections.Generic.List<System.TimeOnly> NullableValue { get; set; }

        public static void AssertModel(TimeOnlytime_without_time_zoneArray2M actual, TimeOnlytime_without_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
