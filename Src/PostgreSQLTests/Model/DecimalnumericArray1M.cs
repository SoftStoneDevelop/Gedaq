...
namespace Tests
{
    public class DecimalnumericArray1M
    {
        ...
        public DecimalnumericArray1MI ModelInner { get; set; }

        
        public System.Decimal[] NullableValue { get; set; }

        public static void AssertModel(DecimalnumericArray1M actual, DecimalnumericArray1M expect, bool checkInInnerOnlyId)
        {
