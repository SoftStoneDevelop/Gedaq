...
namespace Tests
{
    public class FlatDateOnlydateMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatDateOnlydateMMArrayD1E1M actual, DateOnlydateMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
