...
namespace Tests
{
    public class Int16smallintMArrayD11MIWA
    {
        ...
        public static void AssertModel(Int16smallintMArrayD11MIWA actual, Int16smallintMArrayD11MI expect, bool checkInInnerOnlyId)
        {
