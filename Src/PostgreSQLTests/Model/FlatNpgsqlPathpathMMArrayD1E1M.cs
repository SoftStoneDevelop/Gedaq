...
namespace Tests
{
    public class FlatNpgsqlPathpathMMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatNpgsqlPathpathMMArrayD1E1M actual, NpgsqlPathpathMMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
