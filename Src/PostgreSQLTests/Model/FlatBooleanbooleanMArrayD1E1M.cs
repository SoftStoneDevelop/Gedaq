...
namespace Tests
{
    public class FlatBooleanbooleanMArrayD1E1M
    {
        ...
        public static void AssertModel(FlatBooleanbooleanMArrayD1E1M actual, BooleanbooleanMArrayD1E1M expect, bool checkInInnerOnlyId)
        {
