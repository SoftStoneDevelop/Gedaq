...
namespace Tests
{
    public class DateTimetimestamp_without_time_zoneArray2M
    {
        public System.Int32 Id { get; set; }

        public System.Collections.Generic.List<System.DateTime> Value { get; set; }

        public DateTimetimestamp_without_time_zoneArray2MI ModelInner { get; set; }

        public System.Collections.Generic.List<System.DateTime> NullableValue { get; set; }

        public static void AssertModel(DateTimetimestamp_without_time_zoneArray2M actual, DateTimetimestamp_without_time_zoneArray2M expect, bool checkInInnerOnlyId)
        {
