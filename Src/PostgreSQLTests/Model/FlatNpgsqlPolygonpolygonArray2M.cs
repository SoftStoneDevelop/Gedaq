...
namespace Tests
{
    public class FlatNpgsqlPolygonpolygonArray2M
    {
        ...
        public static void AssertModel(FlatNpgsqlPolygonpolygonArray2M actual, NpgsqlPolygonpolygonArray2M expect, bool checkInInnerOnlyId)
        {
