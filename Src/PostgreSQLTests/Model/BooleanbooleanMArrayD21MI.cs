...
namespace Tests
{
    public class BooleanbooleanMArrayD21MI
    {
        ...
        public static void AssertModel(BooleanbooleanMArrayD21MI actual, BooleanbooleanMArrayD21MI expect, bool checkInInnerOnlyId)
        {
