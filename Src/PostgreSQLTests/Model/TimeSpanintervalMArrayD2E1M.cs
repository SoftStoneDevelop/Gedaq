...
namespace Tests
{
    public class TimeSpanintervalMArrayD2E1M
    {
        ...
        public TimeSpanintervalMArrayD21MI ModelInner { get; set; }

        
        public System.TimeSpan[,] NullableValue { get; set; }

        public static void AssertModel(TimeSpanintervalMArrayD2E1M actual, TimeSpanintervalMArrayD2E1M expect, bool checkInInnerOnlyId)
        {
