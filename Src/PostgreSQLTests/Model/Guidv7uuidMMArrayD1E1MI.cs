...
namespace Tests
{
    public class Guidv7uuidMMArrayD1E1MI
    {
        ...
        public static void AssertModel(Guidv7uuidMMArrayD1E1MI actual, Guidv7uuidMMArrayD1E1MI expect, bool checkInInnerOnlyId)
        {
