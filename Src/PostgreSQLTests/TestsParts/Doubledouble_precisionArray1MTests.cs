...
{
0.630553800921456d,
0.08115417861667362d,
0.41585029483365765d,
},
...
new System.Double[4]
{
0.33089510830932045d,
0.5604098540249002d,
0.14868273073222393d,
0.6366695866489949d,
},
    NullableValue = null,
},
...
{
0.4197850235029513d,
0.44886191452188984d,
0.10026333813513355d,
},
    ModelInner = null,
    NullableValue = null,
},
...
new System.Double[4]
{
0.03953700220750278d,
0.2173065514259016d,
0.23308053133762519d,
0.942756259853637d,
},
    ModelInner = null,
    NullableValue = null,
...
new System.Double[3]
{
0.47198624537630474d,
0.8072773385970498d,
0.12318660633072132d,
},
},
            new Doubledouble_precisionArray1M
{
...
{
0.9176841806140299d,
0.31477860604766283d,
0.8755369458758004d,
0.43031095970068733d,
},
    ModelInner = new Doubledouble_precisionArray1MI
{
    Id = 25,
...
new System.Double[4]
{
0.49753470657439003d,
0.6851416645368825d,
0.31264029162777796d,
0.017006255563977057d,
},
    NullableValue = null,
},
    NullableValue = 
...
{
0.4536417267183155d,
0.09427409873435977d,
0.028812001328753833d,
},
    ModelInner = null,
    NullableValue = 
new System.Double[4]
{
0.2097059372648482d,
0.050188463262031635d,
0.6457309823628572d,
0.44283088780966795d,
},
},
            new Doubledouble_precisionArray1M
{
...
{
0.5626278489732687d,
0.07529506494078608d,
0.15672618855951348d,
},
    ModelInner = new Doubledouble_precisionArray1MI
{
    Id = 26,
...
new System.Double[4]
{
0.16448967827903271d,
0.37110350488369737d,
0.11758217939969129d,
0.05439839324774365d,
},
    NullableValue = 
new System.Double[3]
{
...
new System.Double[4]
{
0.26618220033689444d,
0.1898982845914391d,
0.8259869529583935d,
0.011087136474476345d,
},
},
            new Doubledouble_precisionArray1M
{
...
{
0.7255684979751195d,
0.21497106174574887d,
0.3687455698622223d,
0.06348805235433252d,
},
    ModelInner = null,
    NullableValue = null,
},
...
new System.Double[4]
{
0.03891913080522358d,
0.4894972156880364d,
0.09668150628123862d,
0.6607444675879874d,
},
    ModelInner = new Doubledouble_precisionArray1MI
{
...
{
0.9202290276367124d,
0.37470892363469166d,
0.802163878845771d,
0.09928403910519046d,
},
},
            new Doubledouble_precisionArray1M
{
...
{
0.6441681595358746d,
0.01403031632483187d,
0.41303449178791085d,
0.13171316600757998d,
},
},
            new Doubledouble_precisionArray1M
{
...
{
0.3306733037669538d,
0.49126713239256514d,
0.30005652577684416d,
0.7341339219007382d,
},
    NullableValue = 
new System.Double[4]
...
{
0.8155671290074945d,
0.22239363290149905d,
0.26381080933339107d,
0.4196307403104973d,
},
    ModelInner = null,
    NullableValue = null,
...
0.9070029703289473d,
0.769786970339953d,
0.11551828875784842d,
0.14789651657950564d,
},
    ModelInner = new Doubledouble_precisionArray1MI
{
    Id = 59,
...
new System.Double[3]
{
0.29977959996472237d,
0.30997338358753335d,
0.7947231775439064d,
},
    NullableValue = null,
},
...
new System.Double[3]
{
0.06275747926826636d,
0.15831012692023594d,
0.10623860018443076d,
},
},
            new Doubledouble_precisionArray1M
{
...
new System.Double[4]
{
0.42558729211810076d,
0.878855062605407d,
0.1157722397892259d,
0.37628547492015063d,
},
},
            new Doubledouble_precisionArray1M
{
...
new System.Double[3]
{
0.18960751159092093d,
0.7018515646436695d,
0.45963308455746077d,
},
    ModelInner = null,
    NullableValue = null,
},
...
new System.Double[4]
{
0.13339056740620847d,
0.6963789974574536d,
0.9839644994362169d,
0.017587755758835533d,
},
    ModelInner = new Doubledouble_precisionArray1MI
{
    Id = 76,
...
new System.Double[4]
{
0.30857550386650034d,
0.22329947845907916d,
0.09001682549692758d,
0.6055881739479353d,
},
},
    NullableValue = null,
...
new System.Double[3]
{
0.25557183693955676d,
0.6582014011389729d,
0.29116860293973346d,
},
},
        };
...
";
                ...
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems2 = new List<FlatDoubledouble_precisionArray1M>();
                await ((IDoubleArraydouble_precisionArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 174, query1, 174, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(3));
                Assert.That(firstItems2, Has.Count.EqualTo(3));
                        FlatDoubledouble_precisionArray1M.AssertModel(firstItems1[0],_testData[27], false);
                        FlatDoubledouble_precisionArray1M.AssertModel(firstItems2[0],_testData[27], false);
...
";
                ...
                var firstItems2 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                await ((IDoubleArraydouble_precisionArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 159, query1, 119, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems2 = new List<FlatDoubledouble_precisionArray1M>();
                 ((IDoubleArraydouble_precisionArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 125, query1, 58, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                 ((IDoubleArraydouble_precisionArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 150, query1, 132, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDoubleArraydouble_precisionArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 13, query1, 167, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems2 = new List<FlatDoubledouble_precisionArray1M>();
                await ((IDoubleArraydouble_precisionArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 55, query1, 74, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(21));
                        FlatDoubledouble_precisionArray1M.AssertModel(firstItems1[0],_testData[9], false);
                        FlatDoubledouble_precisionArray1M.AssertModel(firstItems1[1],_testData[10], false);
                        FlatDoubledouble_precisionArray1M.AssertModel(firstItems1[2],_testData[11], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDoubleArraydouble_precisionArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 13, query1, 159, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDoubledouble_precisionArray1M>();
                var secondItems2 = new List<FlatDoubledouble_precisionArray1M>();
                 ((IDoubleArraydouble_precisionArray)this).DbConnectionDynQuerySelectModelBatch(connection, 132, query1, 125, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDoubleArraydouble_precisionArray)this).DbConnectionSTSelectModelBatchAsync(connection, 132, 83))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDoubleArraydouble_precisionArray)this).DbConnectionSTSelectModelBatch(connection, 167, 41))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDoubleArraydouble_precisionArray)this).SetDbConnectionSelectModelParametrs(cmd, 115);
