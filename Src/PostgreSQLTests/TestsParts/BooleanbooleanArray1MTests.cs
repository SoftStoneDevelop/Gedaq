...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(18));
                        ...
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[13],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[14],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[14],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[15],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[15],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[16],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[16],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[17],_testData[34], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[17],_testData[34], false);
...
";
                ...
                foreach(var batchResult in  ((IBooleanArraybooleanArray)this).DbConnectionSTDynQuerySelectModelDynParBatch(connection, [parametr1], query1, [parametr2], query2))
                {
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        FlatBooleanbooleanArray1M.AssertModel(models[23],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[24],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[25],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[26],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[27],_testData[34], false);
                        continue;
                    }
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 33, query1, 71, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(26));
                        ...
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[21],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[21],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[22],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[22],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[23],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[23],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[24],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[24],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[25],_testData[34], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[25],_testData[34], false);
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanArray1M>();
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 72, query1, 13, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 2, query1, 78, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanArray1M>();
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 11, query1, 125, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanArraybooleanArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 117, query1, 61, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 64, query1, 61, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanArraybooleanArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 2, query1, 17, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionDynQuerySelectModelBatch(connection, 5, query1, 33, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanArraybooleanArray)this).DbConnectionSTSelectModelBatchAsync(connection, 133, 60))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanArraybooleanArray)this).DbConnectionSTSelectModelBatch(connection, 114, 2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IBooleanArraybooleanArray)this).SetDbConnectionSelectModelParametrs(cmd, 17);
