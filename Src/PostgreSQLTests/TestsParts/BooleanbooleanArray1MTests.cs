...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 12, query1, 147, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanArray1M>();
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 46, query1, 108, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(23));
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 5, query1, 108, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanArray1M>();
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 107, query1, 40, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(10));
                        ...
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[5],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[6],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[6],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[7],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[7],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[8],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[8],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems1[9],_testData[34], false);
                        FlatBooleanbooleanArray1M.AssertModel(firstItems2[9],_testData[34], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanArraybooleanArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 3, query1, 38, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                await ((IBooleanArraybooleanArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 92, query1, 139, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanArraybooleanArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 139, query1, 20, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        FlatBooleanbooleanArray1M.AssertModel(models[24],_testData[30], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[25],_testData[31], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[26],_testData[32], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[27],_testData[33], false);
                        FlatBooleanbooleanArray1M.AssertModel(models[28],_testData[34], false);
                        continue;
                    }
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanArray1M>();
                var secondItems2 = new List<FlatBooleanbooleanArray1M>();
                 ((IBooleanArraybooleanArray)this).DbConnectionDynQuerySelectModelBatch(connection, 108, query1, 72, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanArraybooleanArray)this).DbConnectionSTSelectModelBatchAsync(connection, 63, 77))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        BooleanbooleanArray1M.AssertModel(models[0],_testData[20], false);
                        BooleanbooleanArray1M.AssertModel(models[1],_testData[21], false);
                        BooleanbooleanArray1M.AssertModel(models[2],_testData[22], false);
                        BooleanbooleanArray1M.AssertModel(models[3],_testData[23], false);
                        BooleanbooleanArray1M.AssertModel(models[4],_testData[24], false);
                        BooleanbooleanArray1M.AssertModel(models[5],_testData[25], false);
                        BooleanbooleanArray1M.AssertModel(models[6],_testData[26], false);
                        BooleanbooleanArray1M.AssertModel(models[7],_testData[27], false);
                        BooleanbooleanArray1M.AssertModel(models[8],_testData[28], false);
                        BooleanbooleanArray1M.AssertModel(models[9],_testData[29], false);
                        BooleanbooleanArray1M.AssertModel(models[10],_testData[30], false);
                        BooleanbooleanArray1M.AssertModel(models[11],_testData[31], false);
                        BooleanbooleanArray1M.AssertModel(models[12],_testData[32], false);
                        BooleanbooleanArray1M.AssertModel(models[13],_testData[33], false);
                        BooleanbooleanArray1M.AssertModel(models[14],_testData[34], false);
                        continue;
                    }
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanArraybooleanArray)this).DbConnectionSTSelectModelBatch(connection, 15, 40))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IBooleanArraybooleanArray)this).SetDbConnectionSelectModelParametrs(cmd, 119);
