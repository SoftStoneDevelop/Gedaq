...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 13, query1, 40, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray1M>();
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 40, query1, 91, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 132, query1, 132, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(6));
                Assert.That(firstItems2, Has.Count.EqualTo(6));
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[0],_testData[24], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[0],_testData[24], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[1],_testData[25], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[1],_testData[25], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[2],_testData[26], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[2],_testData[26], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[3],_testData[27], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[3],_testData[27], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[4],_testData[28], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[4],_testData[28], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[5],_testData[29], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems2[5],_testData[29], false);
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray1M>();
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 152, query1, 97, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyArraydateArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 13, query1, 5, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 123, query1, 82, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyArraydateArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 122, query1, 66, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionDynQuerySelectModelBatch(connection, 66, query1, 53, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyArraydateArray)this).DbConnectionSTSelectModelBatchAsync(connection, 91, 61))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyArraydateArray)this).DbConnectionSTSelectModelBatch(connection, 40, 123))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydateArray1M.AssertModel(models[0],_testData[17], false);DateOnlydateArray1M.AssertModel(models[1],_testData[18], false);DateOnlydateArray1M.AssertModel(models[2],_testData[19], false);DateOnlydateArray1M.AssertModel(models[3],_testData[20], false);DateOnlydateArray1M.AssertModel(models[4],_testData[21], false);DateOnlydateArray1M.AssertModel(models[5],_testData[22], false);DateOnlydateArray1M.AssertModel(models[6],_testData[23], false);DateOnlydateArray1M.AssertModel(models[7],_testData[24], false);DateOnlydateArray1M.AssertModel(models[8],_testData[25], false);DateOnlydateArray1M.AssertModel(models[9],_testData[26], false);DateOnlydateArray1M.AssertModel(models[10],_testData[27], false);DateOnlydateArray1M.AssertModel(models[11],_testData[28], false);DateOnlydateArray1M.AssertModel(models[12],_testData[29], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlyArraydateArray)this).SetDbConnectionSelectModelParametrs(cmd, 46);
