...
new DateOnly(year: 1937, month: 10, day: 16),
},
    NullableValue = 
new System.DateOnly[3]
{
...
new DateOnly(year: 1960, month: 10, day: 14),
...
new DateOnly(year: 1972, month: 10, day: 12),
},
},
            new DateOnlydateArray1M
{
...
new DateOnly(year: 1937, month: 10, day: 7),
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(10));
                        ...
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[0],_testData[25], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[1],_testData[26], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[1],_testData[26], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[2],_testData[27], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[2],_testData[27], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[3],_testData[28], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[3],_testData[28], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[4],_testData[29], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[4],_testData[29], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[5],_testData[30], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[5],_testData[30], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[6],_testData[31], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[6],_testData[31], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[7],_testData[32], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[7],_testData[32], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[8],_testData[33], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[8],_testData[33], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems1[9],_testData[34], false);
                        FlatDateOnlydateArray1M.AssertModel(secondItems2[9],_testData[34], false);
            }
        }
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 28, query1, 73, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray1M>();
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 106, query1, 69, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 113, query1, 31, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray1M>();
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 151, query1, 31, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyArraydateArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 153, query1, 138, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                await ((IDateOnlyArraydateArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 154, query1, 18, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyArraydateArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 56, query1, 23, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray1M>();
                var secondItems2 = new List<FlatDateOnlydateArray1M>();
                 ((IDateOnlyArraydateArray)this).DbConnectionDynQuerySelectModelBatch(connection, 18, query1, 60, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(31));
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[0],_testData[4], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[1],_testData[5], false);
                        FlatDateOnlydateArray1M.AssertModel(firstItems1[2],_testData[6], false);
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyArraydateArray)this).DbConnectionSTSelectModelBatchAsync(connection, 34, 5))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyArraydateArray)this).DbConnectionSTSelectModelBatch(connection, 28, 134))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlyArraydateArray)this).SetDbConnectionSelectModelParametrs(cmd, 131);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlyArraydateArray)this).SetDbConnectionSelectModelParametrs(cmd, 19);
