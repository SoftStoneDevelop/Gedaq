...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(7));
                        ...
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[2],_testData[30], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[3],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[3],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[4],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[4],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[5],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[5],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[6],_testData[34], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[6],_testData[34], false);
                Assert.That(secondItems1, Has.Count.EqualTo(17));
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[0],_testData[18], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[1],_testData[19], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[2],_testData[20], false);
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(24));
                        ...
                        FlatDateOnlydateArray2M.AssertModel(secondItems2[19],_testData[30], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[20],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems2[20],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[21],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems2[21],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[22],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems2[22],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[23],_testData[34], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems2[23],_testData[34], false);
            }
        }
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 47, query1, 112, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray2M>();
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 39, query1, 15, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(27));
                Assert.That(firstItems2, Has.Count.EqualTo(27));
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[0],_testData[8], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[0],_testData[8], false);
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 15, query1, 88, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(31));
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray2M>();
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 103, query1, 56, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 122, query1, 118, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 88, query1, 152, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(17));
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[0],_testData[18], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[1],_testData[19], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[2],_testData[20], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 53, query1, 39, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatch(connection, 152, query1, 48, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSTSelectModelBatchAsync(connection, 10, 48))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        DateOnlydateArray2M.AssertModel(models[0],_testData[10], false);
                        DateOnlydateArray2M.AssertModel(models[1],_testData[11], false);
                        DateOnlydateArray2M.AssertModel(models[2],_testData[12], false);
                        DateOnlydateArray2M.AssertModel(models[3],_testData[13], false);
                        DateOnlydateArray2M.AssertModel(models[4],_testData[14], false);
                        DateOnlydateArray2M.AssertModel(models[5],_testData[15], false);
                        DateOnlydateArray2M.AssertModel(models[6],_testData[16], false);
                        DateOnlydateArray2M.AssertModel(models[7],_testData[17], false);
                        DateOnlydateArray2M.AssertModel(models[8],_testData[18], false);
                        DateOnlydateArray2M.AssertModel(models[9],_testData[19], false);
                        DateOnlydateArray2M.AssertModel(models[10],_testData[20], false);
                        DateOnlydateArray2M.AssertModel(models[11],_testData[21], false);
                        DateOnlydateArray2M.AssertModel(models[12],_testData[22], false);
                        DateOnlydateArray2M.AssertModel(models[13],_testData[23], false);
                        DateOnlydateArray2M.AssertModel(models[14],_testData[24], false);
                        DateOnlydateArray2M.AssertModel(models[15],_testData[25], false);
                        DateOnlydateArray2M.AssertModel(models[16],_testData[26], false);
                        DateOnlydateArray2M.AssertModel(models[17],_testData[27], false);
                        DateOnlydateArray2M.AssertModel(models[18],_testData[28], false);
                        DateOnlydateArray2M.AssertModel(models[19],_testData[29], false);
                        DateOnlydateArray2M.AssertModel(models[20],_testData[30], false);
                        DateOnlydateArray2M.AssertModel(models[21],_testData[31], false);
                        DateOnlydateArray2M.AssertModel(models[22],_testData[32], false);
                        DateOnlydateArray2M.AssertModel(models[23],_testData[33], false);
                        DateOnlydateArray2M.AssertModel(models[24],_testData[34], false);
                        continue;
                    }
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionSTSelectModelBatch(connection, 78, 83))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
