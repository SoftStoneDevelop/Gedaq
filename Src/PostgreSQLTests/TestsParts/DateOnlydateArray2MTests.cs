...
new DateOnly(year: 2002, month: 10, day: 16),
...
";
                ...
                Assert.That(secondItems1, Has.Count.EqualTo(4));
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[0],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[1],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[2],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(secondItems1[3],_testData[34], false);
            }
        }
...
";
                ...
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSTDynQuerySelectModelDynParBatchAsync(connection, [parametr1], query1, [parametr2], query2))
                {
                    if(++resultIndex == 1)
                    {
                        ...
                        FlatDateOnlydateArray2M.AssertModel(models[0],_testData[30], false);
                        FlatDateOnlydateArray2M.AssertModel(models[1],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(models[2],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(models[3],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(models[4],_testData[34], false);
                        continue;
                    }                    
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 9, query1, 9, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(34));
                Assert.That(firstItems2, Has.Count.EqualTo(34));
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[0],_testData[1], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[0],_testData[1], false);
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray2M>();
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 77, query1, 138, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(20));
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 155, query1, 155, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydateArray2M>();
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionMMDynQuerySelectModelBatch(connection, 77, query1, 38, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(20));
                Assert.That(firstItems2, Has.Count.EqualTo(20));
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[0],_testData[15], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems2[0],_testData[15], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 18, query1, 138, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                await ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 77, query1, 83, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(20));
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[0],_testData[15], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[1],_testData[16], false);
                        FlatDateOnlydateArray2M.AssertModel(firstItems1[2],_testData[17], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionSTDynQuerySelectModelBatch(connection, 95, query1, 63, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                        ...
                        FlatDateOnlydateArray2M.AssertModel(models[11],_testData[30], false);
                        FlatDateOnlydateArray2M.AssertModel(models[12],_testData[31], false);
                        FlatDateOnlydateArray2M.AssertModel(models[13],_testData[32], false);
                        FlatDateOnlydateArray2M.AssertModel(models[14],_testData[33], false);
                        FlatDateOnlydateArray2M.AssertModel(models[15],_testData[34], false);
                        continue;
                    }                    
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydateArray2M>();
                var secondItems2 = new List<FlatDateOnlydateArray2M>();
                 ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatch(connection, 124, query1, 46, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSTSelectModelBatchAsync(connection, 141, 33))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionSTSelectModelBatch(connection, 107, 107))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
