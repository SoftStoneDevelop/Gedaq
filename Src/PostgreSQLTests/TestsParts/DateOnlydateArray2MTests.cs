...
FlatDateOnlydateArray2M.AssertModel(models[0],_testData[14], false);FlatDateOnlydateArray2M.AssertModel(models[1],_testData[15], false);FlatDateOnlydateArray2M.AssertModel(models[2],_testData[16], false);FlatDateOnlydateArray2M.AssertModel(models[3],_testData[17], false);FlatDateOnlydateArray2M.AssertModel(models[4],_testData[18], false);FlatDateOnlydateArray2M.AssertModel(models[5],_testData[19], false);FlatDateOnlydateArray2M.AssertModel(models[6],_testData[20], false);FlatDateOnlydateArray2M.AssertModel(models[7],_testData[21], false);FlatDateOnlydateArray2M.AssertModel(models[8],_testData[22], false);FlatDateOnlydateArray2M.AssertModel(models[9],_testData[23], false);FlatDateOnlydateArray2M.AssertModel(models[10],_testData[24], false);FlatDateOnlydateArray2M.AssertModel(models[11],_testData[25], false);FlatDateOnlydateArray2M.AssertModel(models[12],_testData[26], false);FlatDateOnlydateArray2M.AssertModel(models[13],_testData[27], false);FlatDateOnlydateArray2M.AssertModel(models[14],_testData[28], false);FlatDateOnlydateArray2M.AssertModel(models[15],_testData[29], false);
                        continue;
                    }                    
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 85, query1, 110, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                        Assert.That(models, Has.Count.EqualTo(11));
FlatDateOnlydateArray2M.AssertModel(models[0],_testData[19], false);FlatDateOnlydateArray2M.AssertModel(models[1],_testData[20], false);FlatDateOnlydateArray2M.AssertModel(models[2],_testData[21], false);FlatDateOnlydateArray2M.AssertModel(models[3],_testData[22], false);FlatDateOnlydateArray2M.AssertModel(models[4],_testData[23], false);FlatDateOnlydateArray2M.AssertModel(models[5],_testData[24], false);FlatDateOnlydateArray2M.AssertModel(models[6],_testData[25], false);FlatDateOnlydateArray2M.AssertModel(models[7],_testData[26], false);FlatDateOnlydateArray2M.AssertModel(models[8],_testData[27], false);FlatDateOnlydateArray2M.AssertModel(models[9],_testData[28], false);FlatDateOnlydateArray2M.AssertModel(models[10],_testData[29], false);
                        continue;
                    }                    
...
FlatDateOnlydateArray2M.AssertModel(models[0],_testData[22], false);FlatDateOnlydateArray2M.AssertModel(models[1],_testData[23], false);FlatDateOnlydateArray2M.AssertModel(models[2],_testData[24], false);FlatDateOnlydateArray2M.AssertModel(models[3],_testData[25], false);FlatDateOnlydateArray2M.AssertModel(models[4],_testData[26], false);FlatDateOnlydateArray2M.AssertModel(models[5],_testData[27], false);FlatDateOnlydateArray2M.AssertModel(models[6],_testData[28], false);FlatDateOnlydateArray2M.AssertModel(models[7],_testData[29], false);
                        continue;
                    }
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionDynQuerySelectModelBatch(connection, 69, query1, 61, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlyListdateArray)this).DbConnectionSelectModelBatchAsync(connection, 115, 124))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydateArray2M.AssertModel(models[0],_testData[25], false);DateOnlydateArray2M.AssertModel(models[1],_testData[26], false);DateOnlydateArray2M.AssertModel(models[2],_testData[27], false);DateOnlydateArray2M.AssertModel(models[3],_testData[28], false);DateOnlydateArray2M.AssertModel(models[4],_testData[29], false);
        ...
        public async Task DbConnectionSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlyListdateArray)this).DbConnectionSelectModelBatch(connection, 58, 58))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydateArray2M.AssertModel(models[0],_testData[13], false);DateOnlydateArray2M.AssertModel(models[1],_testData[14], false);DateOnlydateArray2M.AssertModel(models[2],_testData[15], false);DateOnlydateArray2M.AssertModel(models[3],_testData[16], false);DateOnlydateArray2M.AssertModel(models[4],_testData[17], false);DateOnlydateArray2M.AssertModel(models[5],_testData[18], false);DateOnlydateArray2M.AssertModel(models[6],_testData[19], false);DateOnlydateArray2M.AssertModel(models[7],_testData[20], false);DateOnlydateArray2M.AssertModel(models[8],_testData[21], false);DateOnlydateArray2M.AssertModel(models[9],_testData[22], false);DateOnlydateArray2M.AssertModel(models[10],_testData[23], false);DateOnlydateArray2M.AssertModel(models[11],_testData[24], false);DateOnlydateArray2M.AssertModel(models[12],_testData[25], false);DateOnlydateArray2M.AssertModel(models[13],_testData[26], false);DateOnlydateArray2M.AssertModel(models[14],_testData[27], false);DateOnlydateArray2M.AssertModel(models[15],_testData[28], false);DateOnlydateArray2M.AssertModel(models[16],_testData[29], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlyListdateArray)this).SetDbConnectionSelectModelParametrs(cmd, 35);
