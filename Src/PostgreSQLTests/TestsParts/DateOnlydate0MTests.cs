...
{
    Id = 8,
    Value = new DateOnly(year: 1970, month: 10, day: 1),
    ModelInner = null,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1927, month: 10, day: 16),
},
            new DateOnlydate0M
{
    Id = 12,
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2016, month: 10, day: 15),
},
            new DateOnlydate0M
{
    Id = 21,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2001, month: 10, day: 3),
},
            new DateOnlydate0M
{
    Id = 30,
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1970, month: 10, day: 1),
},
            new DateOnlydate0M
{
    Id = 39,
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1959, month: 10, day: 12),
},
            new DateOnlydate0M
{
    Id = 45,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1957, month: 10, day: 8),
},
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1991, month: 10, day: 17),
},
    NullableValue = null,
},
            new DateOnlydate0M
{
    Id = 72,
    Value = new DateOnly(year: 1953, month: 10, day: 7),
    ModelInner = null,
    NullableValue = new DateOnly(year: 1947, month: 10, day: 6),
},
            new DateOnlydate0M
{
    Id = 77,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1979, month: 10, day: 1),
},
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1933, month: 10, day: 10),
},
            new DateOnlydate0M
{
    Id = 134,
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 45, query1, 11, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 125, query1, 39, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 137, query1, 111, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 92, query1, 20, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 103, query1, 82, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 43, query1, 77, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 72, query1, 18, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 8, query1, 72, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 60, 141))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 65, 125))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 1))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 9))));
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1927, month: 10, day: 16))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1991, month: 10, day: 1))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1994, month: 10, day: 7))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((11)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1941, month: 10, day: 6))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1923, month: 10, day: 16))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 15))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1938, month: 10, day: 14))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((15)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 5))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1987, month: 10, day: 18))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 3))));
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 1))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 19))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((20)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1921, month: 10, day: 8))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 8))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2004, month: 10, day: 4))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 12))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 3))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1957, month: 10, day: 8))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1936, month: 10, day: 2))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1968, month: 10, day: 6))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2011, month: 10, day: 3))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1942, month: 10, day: 14))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2003, month: 10, day: 14))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 14))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1991, month: 10, day: 17))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1953, month: 10, day: 7))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 6))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 14))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((42)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2007, month: 10, day: 14))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2004, month: 10, day: 17))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 5))));
                ...
                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 1))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2006, month: 10, day: 1))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1921, month: 10, day: 6))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1983, month: 10, day: 12))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1982, month: 10, day: 15))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1997, month: 10, day: 13))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 16))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1973, month: 10, day: 2))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((68)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 2))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1975, month: 10, day: 4))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 17))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1933, month: 10, day: 10))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2009, month: 10, day: 7))));//Value
                ...
                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1984, month: 10, day: 4))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1926, month: 10, day: 4))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 5))));
