            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1951, month: 10, day: 18),
},
            new DateOnlydate0M
{
    Id = 7,
...
{
    Id = 13,
    Value = new DateOnly(year: 1945, month: 10, day: 2),
    ModelInner = new DateOnlydate0MI
{
    Id = 6,
    Value = new DateOnly(year: 1984, month: 10, day: 16),
    NullableValue = new DateOnly(year: 1952, month: 10, day: 6),
},
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1968, month: 10, day: 14),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 26,
    Value = new DateOnly(year: 2002, month: 10, day: 18),
    ModelInner = new DateOnlydate0MI
{
    Id = 23,
...
{
    Id = 30,
    Value = new DateOnly(year: 1999, month: 10, day: 12),
    ModelInner = new DateOnlydate0MI
{
    Id = 32,
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2015, month: 10, day: 7),
},
            new DateOnlydate0M
{
    Id = 32,
...
{
    Id = 39,
    Value = new DateOnly(year: 1921, month: 10, day: 10),
    NullableValue = null,
},
...
{
    Id = 63,
    Value = new DateOnly(year: 1918, month: 10, day: 7),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2019, month: 10, day: 12),
},
    NullableValue = new DateOnly(year: 1947, month: 10, day: 7),
},
            new DateOnlydate0M
{
    Id = 80,
...
{
    Id = 82,
    Value = new DateOnly(year: 1987, month: 10, day: 15),
    ModelInner = new DateOnlydate0MI
{
    Id = 58,
...
{
    Id = 66,
    Value = new DateOnly(year: 1975, month: 10, day: 11),
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2010, month: 10, day: 2),
},
            new DateOnlydate0M
{
    Id = 103,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1987, month: 10, day: 1),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 92,
    Value = new DateOnly(year: 1991, month: 10, day: 7),
    NullableValue = new DateOnly(year: 2008, month: 10, day: 18),
},
    NullableValue = new DateOnly(year: 1961, month: 10, day: 19),
},
            new DateOnlydate0M
{
    Id = 156,
    Value = new DateOnly(year: 1945, month: 10, day: 17),
    ModelInner = null,
    NullableValue = null,
},
        };
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 144, query1, 28, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 15, query1, 95, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 31, query1, 144, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 57, query1, 103, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 132, query1, 72, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 21, query1, 26, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(28));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[7], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[1],_testData[8], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[2],_testData[9], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 145, query1, 30, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 95, query1, 147, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 141, 106))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 92, 111))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydate0M.AssertModel(models[0],_testData[4], false);DateOnlydate0M.AssertModel(models[1],_testData[5], false);DateOnlydate0M.AssertModel(models[2],_testData[6], false);DateOnlydate0M.AssertModel(models[3],_testData[7], false);DateOnlydate0M.AssertModel(models[4],_testData[8], false);DateOnlydate0M.AssertModel(models[5],_testData[9], false);DateOnlydate0M.AssertModel(models[6],_testData[10], false);DateOnlydate0M.AssertModel(models[7],_testData[11], false);DateOnlydate0M.AssertModel(models[8],_testData[12], false);DateOnlydate0M.AssertModel(models[9],_testData[13], false);DateOnlydate0M.AssertModel(models[10],_testData[14], false);DateOnlydate0M.AssertModel(models[11],_testData[15], false);DateOnlydate0M.AssertModel(models[12],_testData[16], false);DateOnlydate0M.AssertModel(models[13],_testData[17], false);DateOnlydate0M.AssertModel(models[14],_testData[18], false);DateOnlydate0M.AssertModel(models[15],_testData[19], false);DateOnlydate0M.AssertModel(models[16],_testData[20], false);DateOnlydate0M.AssertModel(models[17],_testData[21], false);DateOnlydate0M.AssertModel(models[18],_testData[22], false);DateOnlydate0M.AssertModel(models[19],_testData[23], false);DateOnlydate0M.AssertModel(models[20],_testData[24], false);DateOnlydate0M.AssertModel(models[21],_testData[25], false);DateOnlydate0M.AssertModel(models[22],_testData[26], false);DateOnlydate0M.AssertModel(models[23],_testData[27], false);DateOnlydate0M.AssertModel(models[24],_testData[28], false);DateOnlydate0M.AssertModel(models[25],_testData[29], false);DateOnlydate0M.AssertModel(models[26],_testData[30], false);DateOnlydate0M.AssertModel(models[27],_testData[31], false);DateOnlydate0M.AssertModel(models[28],_testData[32], false);DateOnlydate0M.AssertModel(models[29],_testData[33], false);DateOnlydate0M.AssertModel(models[30],_testData[34], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlySingleTypedate)this).SetDbConnectionSelectModelParametrs(cmd, 26);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1989, month: 10, day: 17))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1951, month: 10, day: 18))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 16))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((5)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 11))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1965, month: 10, day: 17))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1953, month: 10, day: 16))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 2))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((6)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1984, month: 10, day: 16))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 6))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1977, month: 10, day: 5))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1923, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 9))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1968, month: 10, day: 14))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2008, month: 10, day: 3))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 18))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((23)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1955, month: 10, day: 19))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2017, month: 10, day: 13))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1999, month: 10, day: 12))));//Value
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1981, month: 10, day: 3))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 13))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 7))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1978, month: 10, day: 2))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((34)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1933, month: 10, day: 11))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1921, month: 10, day: 4))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1964, month: 10, day: 12))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1972, month: 10, day: 10))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1921, month: 10, day: 10))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1964, month: 10, day: 4))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1987, month: 10, day: 7))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1994, month: 10, day: 7))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1918, month: 10, day: 7))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1956, month: 10, day: 17))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((52)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1962, month: 10, day: 7))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2019, month: 10, day: 12))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 7))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 8))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1987, month: 10, day: 15))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((58)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1940, month: 10, day: 12))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1967, month: 10, day: 7))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1939, month: 10, day: 10))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((66)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1975, month: 10, day: 11))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1978, month: 10, day: 4))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2010, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1960, month: 10, day: 15))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 5))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1996, month: 10, day: 3))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 7))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1971, month: 10, day: 14))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1922, month: 10, day: 18))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1985, month: 10, day: 16))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1948, month: 10, day: 19))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((74)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1972, month: 10, day: 13))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1973, month: 10, day: 4))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 2))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1974, month: 10, day: 18))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 16))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 6))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2009, month: 10, day: 15))));//Value
                ...
                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1987, month: 10, day: 1))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1991, month: 10, day: 7))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2008, month: 10, day: 18))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1961, month: 10, day: 19))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 17))));//Value
