...
{
    Id = 54,
    Value = new DateOnly(year: 1946, month: 10, day: 17),
    ModelInner = null,
...
{
    Id = 57,
    Value = new DateOnly(year: 1960, month: 10, day: 11),
    ModelInner = new DateOnlydate0MI
{
    Id = 22,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1988, month: 10, day: 4),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 80,
    Value = new DateOnly(year: 1986, month: 10, day: 10),
    ModelInner = new DateOnlydate0MI
{
    Id = 33,
    Value = new DateOnly(year: 2014, month: 10, day: 2),
    NullableValue = new DateOnly(year: 1976, month: 10, day: 2),
},
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1995, month: 10, day: 12),
},
            new DateOnlydate0M
{
    Id = 98,
...
{
    Id = 113,
    Value = new DateOnly(year: 1927, month: 10, day: 15),
    ModelInner = new DateOnlydate0MI
{
    Id = 45,
...
{
    Id = 121,
    Value = new DateOnly(year: 1958, month: 10, day: 7),
    ModelInner = new DateOnlydate0MI
{
    Id = 47,
...
{
    Id = 55,
    Value = new DateOnly(year: 1927, month: 10, day: 13),
    NullableValue = null,
},
    NullableValue = null,
},
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1924, month: 10, day: 1),
},
            new DateOnlydate0M
{
    Id = 146,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1979, month: 10, day: 3),
},
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2011, month: 10, day: 16),
},
            new DateOnlydate0M
{
    Id = 158,
    Value = new DateOnly(year: 1952, month: 10, day: 12),
    ModelInner = new DateOnlydate0MI
{
    Id = 66,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1953, month: 10, day: 15),
},
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2016, month: 10, day: 14),
},
        };
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 105, query1, 75, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 89, query1, 161, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 115, query1, 57, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(11));
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 54, query1, 98, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 132, query1, 41, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 146, query1, 20, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(6));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[24], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[1],_testData[25], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[2],_testData[26], false);
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 158, query1, 132, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 98, query1, 121, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 141, 27))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 41, 41))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlySingleTypedate)this).SetDbConnectionSelectModelParametrs(cmd, 132);
...
DateOnlydate0M.AssertModel(models[0],_testData[22], false);DateOnlydate0M.AssertModel(models[1],_testData[23], false);DateOnlydate0M.AssertModel(models[2],_testData[24], false);DateOnlydate0M.AssertModel(models[3],_testData[25], false);DateOnlydate0M.AssertModel(models[4],_testData[26], false);DateOnlydate0M.AssertModel(models[5],_testData[27], false);DateOnlydate0M.AssertModel(models[6],_testData[28], false);DateOnlydate0M.AssertModel(models[7],_testData[29], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlySingleTypedate)this).SetDbConnectionSelectModelParametrs(cmd, 46);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2000, month: 10, day: 4))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1997, month: 10, day: 16))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 14))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 7))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 9))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1918, month: 10, day: 16))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((6)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 7))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1981, month: 10, day: 18))));
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 10))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1946, month: 10, day: 17))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 15))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1960, month: 10, day: 11))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((22)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 5))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1973, month: 10, day: 18))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((27)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 1))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1988, month: 10, day: 4))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 1))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1986, month: 10, day: 10))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((33)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2014, month: 10, day: 2))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 2))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1955, month: 10, day: 13))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 8))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 12))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1939, month: 10, day: 5))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((42)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1958, month: 10, day: 9))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1989, month: 10, day: 3))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1927, month: 10, day: 15))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((45)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1996, month: 10, day: 16))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2014, month: 10, day: 11))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2006, month: 10, day: 3))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1958, month: 10, day: 7))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((47)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1955, month: 10, day: 17))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1986, month: 10, day: 17))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1925, month: 10, day: 14))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1981, month: 10, day: 4))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((55)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1927, month: 10, day: 13))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1924, month: 10, day: 1))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1937, month: 10, day: 12))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((64)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1948, month: 10, day: 2))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 3))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2017, month: 10, day: 18))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2011, month: 10, day: 16))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 12))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((66)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1928, month: 10, day: 16))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1986, month: 10, day: 1))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1941, month: 10, day: 12))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1986, month: 10, day: 18))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1953, month: 10, day: 15))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 7))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1990, month: 10, day: 7))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1986, month: 10, day: 3))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((80)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 9))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 14))));
