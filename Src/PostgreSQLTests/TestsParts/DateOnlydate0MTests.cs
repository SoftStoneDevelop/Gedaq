            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1962, month: 10, day: 2),
},
            new DateOnlydate0M
{
    Id = 15,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1978, month: 10, day: 2),
},
            new DateOnlydate0M
{
    Id = 17,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2015, month: 10, day: 13),
},
            new DateOnlydate0M
{
    Id = 40,
...
{
    Id = 17,
    Value = new DateOnly(year: 1929, month: 10, day: 9),
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1956, month: 10, day: 5),
},
            new DateOnlydate0M
{
    Id = 57,
...
{
    Id = 64,
    Value = new DateOnly(year: 1969, month: 10, day: 1),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 22,
    Value = new DateOnly(year: 1974, month: 10, day: 4),
    NullableValue = null,
},
    NullableValue = null,
},
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2011, month: 10, day: 2),
},
            new DateOnlydate0M
{
    Id = 85,
            ...
            new DateOnlydate0M
{
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1969, month: 10, day: 5),
},
            new DateOnlydate0M
{
    Id = 131,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1940, month: 10, day: 10),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 60,
    Value = new DateOnly(year: 2016, month: 10, day: 5),
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 90, query1, 138, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 133, query1, 29, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 131, query1, 64, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(4));
                Assert.That(firstItems2, Has.Count.EqualTo(4));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[26], false);
                        FlatDateOnlydate0M.AssertModel(firstItems2[0],_testData[26], false);
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 50, query1, 40, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(19));
                Assert.That(firstItems2, Has.Count.EqualTo(19));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[11], false);
                        FlatDateOnlydate0M.AssertModel(firstItems2[0],_testData[11], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 130, query1, 100, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 100, query1, 96, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 85, query1, 116, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 131, query1, 122, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(4));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[26], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[1],_testData[27], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[2],_testData[28], false);
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 85, 130))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 131, 34))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 2013, month: 10, day: 5))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1962, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1932, month: 10, day: 6))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1935, month: 10, day: 11))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1978, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1999, month: 10, day: 11))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 11))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1970, month: 10, day: 7))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1931, month: 10, day: 1))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((14)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 5))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1923, month: 10, day: 16))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 13))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1929, month: 10, day: 9))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 6))));//InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 4))));
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1956, month: 10, day: 5))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1929, month: 10, day: 18))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((19)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1939, month: 10, day: 10))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1948, month: 10, day: 15))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1969, month: 10, day: 1))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1925, month: 10, day: 18))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((22)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1974, month: 10, day: 4))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1982, month: 10, day: 14))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 2011, month: 10, day: 2))));
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1951, month: 10, day: 10))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1928, month: 10, day: 2))));//Value
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1990, month: 10, day: 6))));
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 4))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((31)));//InnerModel.Id
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1926, month: 10, day: 13))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 2004, month: 10, day: 19))));//Value
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 4))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1975, month: 10, day: 14))));//InnerModel.Value
                ...
                Assert.That((System.DateOnly?)model[5], Is.EqualTo((new DateOnly(year: 1969, month: 10, day: 5))));
                ...
                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1940, month: 10, day: 10))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1999, month: 10, day: 5))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 5))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1996, month: 10, day: 18))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateOnly)model[1], Is.EqualTo((new DateOnly(year: 1931, month: 10, day: 4))));//Value
                ...
                Assert.That((System.DateOnly)model[3], Is.EqualTo((new DateOnly(year: 1991, month: 10, day: 5))));//InnerModel.Value

                Assert.That((System.DateOnly?)model[4], Is.EqualTo((new DateOnly(year: 1932, month: 10, day: 18))));//InnerModel.NullableValue
