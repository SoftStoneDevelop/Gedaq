...
",
        ...
        public async Task InsertModelDynParTestReturningScalar()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.EqualTo(7097));
                {
                    var parameters = new NpgsqlParameter[4];
                    parameters[0] = new NpgsqlParameter<System.Int32>();
                    ((NpgsqlParameter<System.Int32>)parameters[0]).NpgsqlDbType = (NpgsqlTypes.NpgsqlDbType)(9);
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo(2310));
            }
        }
...
",
        ...
        public async Task InsertModelTestReturningScalar()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo(13437));
            }
        }
...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(30));
                        ...
                        FlatInt16smallint0M.AssertModel(firstItems2[25],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[26],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[26],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[27],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[27],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[28],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[28],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[29],_testData[34], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[29],_testData[34], false);
...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(17));
                        ...
                        FlatInt16smallint0M.AssertModel(firstItems2[12],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[13],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[13],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[14],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[14],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[15],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[15],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[16],_testData[34], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[16],_testData[34], false);
...
";
                ...
                foreach(var batchResult in await ((IInt16SingleTypesmallint)this).DbConnectionSTDynQuerySelectModelDynParBatchAsync(connection, [parametr1], query1, [parametr2], query2))
                {
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        FlatInt16smallint0M.AssertModel(models[24],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(models[25],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(models[26],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(models[27],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(models[28],_testData[34], false);
                        continue;
                    }
...
";
                ...
                foreach(var batchResult in  ((IInt16SingleTypesmallint)this).DbConnectionSTDynQuerySelectModelDynParBatch(connection, [parametr1], query1, [parametr2], query2))
                {
                    if(++resultIndex == 1)
                    {
                        ...
                        FlatInt16smallint0M.AssertModel(models[21],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(models[22],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(models[23],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(models[24],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(models[25],_testData[34], false);
                        continue;
                    }                    
            ...
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                foreach(var batchResult in await ((IInt16SingleTypesmallint)this).DbConnectionSTSelectModelDynParBatchAsync(connection, [parametr1], [parametr2]))
                {
                    if(++resultIndex == 1)
                    {
                        ...
                        Int16smallint0M.AssertModel(models[25],_testData[30], false);
                        Int16smallint0M.AssertModel(models[26],_testData[31], false);
                        Int16smallint0M.AssertModel(models[27],_testData[32], false);
                        Int16smallint0M.AssertModel(models[28],_testData[33], false);
                        Int16smallint0M.AssertModel(models[29],_testData[34], false);
                        continue;
                    }                    
            ...
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                foreach(var batchResult in  ((IInt16SingleTypesmallint)this).DbConnectionSTSelectModelDynParBatch(connection, [parametr1], [parametr2]))
                {
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        Int16smallint0M.AssertModel(models[16],_testData[30], false);
                        Int16smallint0M.AssertModel(models[17],_testData[31], false);
                        Int16smallint0M.AssertModel(models[18],_testData[32], false);
                        Int16smallint0M.AssertModel(models[19],_testData[33], false);
                        Int16smallint0M.AssertModel(models[20],_testData[34], false);
                        continue;
                    }
...
";
                ...
                var secondItems1 = new List<FlatInt16smallint0M>();
                var secondItems2 = new List<FlatInt16smallint0M>();
                await ((IInt16SingleTypesmallint)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 66, query1, 10, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatInt16smallint0M>();
                var secondItems1 = new List<FlatInt16smallint0M>();
                await ((IInt16SingleTypesmallint)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 108, query1, 8, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(18));
                        ...
                        FlatInt16smallint0M.AssertModel(firstItems2[13],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[14],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[14],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[15],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[15],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[16],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[16],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[17],_testData[34], false);
                        FlatInt16smallint0M.AssertModel(firstItems2[17],_testData[34], false);
...
";
                ...
                var secondItems1 = new List<FlatInt16smallint0M>();
                var secondItems2 = new List<FlatInt16smallint0M>();
                 ((IInt16SingleTypesmallint)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 164, query1, 170, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatInt16smallint0M>();
                var secondItems1 = new List<FlatInt16smallint0M>();
                 ((IInt16SingleTypesmallint)this).DbConnectionMMDynQuerySelectModelBatch(connection, 143, query1, 172, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IInt16SingleTypesmallint)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 91, query1, 56, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                        ...
                        FlatInt16smallint0M.AssertModel(models[15],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(models[16],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(models[17],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(models[18],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(models[19],_testData[34], false);
                        continue;
                    }                    
...
";
                ...
                var secondItems1 = new List<FlatInt16smallint0M>();
                var secondItems2 = new List<FlatInt16smallint0M>();
                await ((IInt16SingleTypesmallint)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 59, query1, 29, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IInt16SingleTypesmallint)this).DbConnectionSTDynQuerySelectModelBatch(connection, 115, query1, 132, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatInt16smallint0M>();
                var secondItems2 = new List<FlatInt16smallint0M>();
                 ((IInt16SingleTypesmallint)this).DbConnectionDynQuerySelectModelBatch(connection, 75, query1, 108, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(22));
                        FlatInt16smallint0M.AssertModel(firstItems1[0],_testData[13], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[1],_testData[14], false);
                        FlatInt16smallint0M.AssertModel(firstItems1[2],_testData[15], false);
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(18));
                        ...
                        FlatInt16smallint0M.AssertModel(secondItems1[13],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(secondItems2[13],_testData[30], false);
                        FlatInt16smallint0M.AssertModel(secondItems1[14],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(secondItems2[14],_testData[31], false);
                        FlatInt16smallint0M.AssertModel(secondItems1[15],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(secondItems2[15],_testData[32], false);
                        FlatInt16smallint0M.AssertModel(secondItems1[16],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(secondItems2[16],_testData[33], false);
                        FlatInt16smallint0M.AssertModel(secondItems1[17],_testData[34], false);
                        FlatInt16smallint0M.AssertModel(secondItems2[17],_testData[34], false);
            }
        }
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IInt16SingleTypesmallint)this).DbConnectionSTSelectModelBatchAsync(connection, 66, 35))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IInt16SingleTypesmallint)this).DbConnectionSTSelectModelBatch(connection, 171, 115))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IInt16SingleTypesmallint)this).SetDbConnectionSelectModelParametrs(cmd, 115);
                var models = await ((IInt16SingleTypesmallint)this).ExecuteDbConnectionSelectModelCommandAsync(cmd);

                Assert.That(models, Has.Count.EqualTo(16));
Int16smallint0M.AssertModel(models[0],_testData[19], false);Int16smallint0M.AssertModel(models[1],_testData[20], false);Int16smallint0M.AssertModel(models[2],_testData[21], false);Int16smallint0M.AssertModel(models[3],_testData[22], false);Int16smallint0M.AssertModel(models[4],_testData[23], false);Int16smallint0M.AssertModel(models[5],_testData[24], false);Int16smallint0M.AssertModel(models[6],_testData[25], false);Int16smallint0M.AssertModel(models[7],_testData[26], false);Int16smallint0M.AssertModel(models[8],_testData[27], false);Int16smallint0M.AssertModel(models[9],_testData[28], false);Int16smallint0M.AssertModel(models[10],_testData[29], false);Int16smallint0M.AssertModel(models[11],_testData[30], false);Int16smallint0M.AssertModel(models[12],_testData[31], false);Int16smallint0M.AssertModel(models[13],_testData[32], false);Int16smallint0M.AssertModel(models[14],_testData[33], false);Int16smallint0M.AssertModel(models[15],_testData[34], false);
            }
        }
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IInt16SingleTypesmallint)this).SetDbConnectionSelectModelParametrs(cmd, 146);
                var models =  ((IInt16SingleTypesmallint)this).ExecuteDbConnectionSelectModelCommand(cmd);

                Assert.That(models, Has.Count.EqualTo(9));
Int16smallint0M.AssertModel(models[0],_testData[26], false);Int16smallint0M.AssertModel(models[1],_testData[27], false);Int16smallint0M.AssertModel(models[2],_testData[28], false);Int16smallint0M.AssertModel(models[3],_testData[29], false);Int16smallint0M.AssertModel(models[4],_testData[30], false);Int16smallint0M.AssertModel(models[5],_testData[31], false);Int16smallint0M.AssertModel(models[6],_testData[32], false);Int16smallint0M.AssertModel(models[7],_testData[33], false);Int16smallint0M.AssertModel(models[8],_testData[34], false);
            }
        }
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((1648)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((10785)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((18921)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((9)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((19705)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((2045)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((22341)));//Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((31274)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((14)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((20731)));//InnerModel.Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((30710)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((7097)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((1092)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((22)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((18835)));//InnerModel.Value

                Assert.That((System.Int16?)model[4], Is.EqualTo((15879)));//InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((2310)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((27610)));//Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((22883)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((24)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((20248)));//InnerModel.Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((4131)));//Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((3898)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((26)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((3217)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((13437)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((13001)));//Value
                ...
                Assert.That((System.Int16)model[3], Is.EqualTo((10988)));//InnerModel.Value

                Assert.That((System.Int16?)model[4], Is.EqualTo((5502)));//InnerModel.NullableValue
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((7077)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((29641)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((29288)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((38)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((13181)));//InnerModel.Value

                Assert.That((System.Int16?)model[4], Is.EqualTo((25305)));//InnerModel.NullableValue
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((2571)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((19175)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((21573)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((47)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((6321)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((21942)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((19677)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((29319)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((22214)));//Value
                ...
                Assert.That((System.Int16?)model[5], Is.EqualTo((22832)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((28603)));//Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((5044)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((56)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((20280)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((24582)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((7157)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((22349)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((23705)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((60)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((13816)));//InnerModel.Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((3007)));//Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((18645)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((68)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((21518)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((5159)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((28095)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((29940)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((11854)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((73)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((2484)));//InnerModel.Value
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((4154)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((28861)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((27446)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((77)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((8317)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((10171)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((29948)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((13974)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((31819)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((84)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((13322)));//InnerModel.Value

                Assert.That((System.Int16?)model[4], Is.EqualTo((13290)));//InnerModel.NullableValue
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((527)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((26935)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((30331)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((92)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((10436)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Int16?)model[5], Is.EqualTo((21349)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((13546)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Int16?)model[5], Is.EqualTo((31296)));
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((11938)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((95)));//InnerModel.Id
                Assert.That((System.Int16)model[3], Is.EqualTo((11571)));//InnerModel.Value

                Assert.That((System.Int16?)model[4], Is.EqualTo((26730)));//InnerModel.NullableValue
                ...
                Assert.That((System.Int16)model[1], Is.EqualTo((24095)));//Value
