...
{
    Id = 4,
    Value = "ibxuxyhgqabroimelinivrsokexg",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
...
{
    Id = 3,
    Value = "ivydytjdofqgqxvqgtrcfbxbgsya",
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 11,
    Value = "rweksyomnwbpnlf",
    NullableValue = null,
},
    NullableValue = "ppnmbipkfivyi",
},
            new StringtextE0M
{
    Id = 22,
    ...
    ModelInner = new Stringtext0MI
{
    ...
    NullableValue = "jsanvgbekwpm",
},
            new StringtextE0M
{
    Id = 33,
    Value = "rtlhqhgeyewingemfrssbhekon",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
{
    Id = 39,
    Value = "issanbauxxkavdbgveg",
    ModelInner = new Stringtext0MI
{
    Id = 18,
    Value = "jtvydialxlamgbag",
    NullableValue = null,
},
    NullableValue = "wocomitsxx",
},
            new StringtextE0M
{
    Id = 41,
    Value = "opgjbmrjrauwispxjurg",
    ModelInner = null,
    NullableValue = "fdhgfbadsjxqtxgnrabmgvl",
},
            new StringtextE0M
{
    Id = 46,
    Value = "clxrdvvdicuxjhetxwxowbm",
    ModelInner = new Stringtext0MI
{
    Id = 19,
    Value = "xitnsfheqtmplgcfdxtrefrkjwivh",
    NullableValue = null,
},
    NullableValue = "ccuwowgmjobsmojxkwrfybjegotaw",
},
            new StringtextE0M
{
    Id = 54,
    Value = "uddgrnrshvdqfkpicbkdnsharf",
    ModelInner = null,
    NullableValue = "ifyrfgphxh",
},
            new StringtextE0M
{
    Id = 58,
            ...
            new StringtextE0M
{
    ...
    Value = "gdjvpcsxlbf",
    ModelInner = null,
    NullableValue = "oxkuufpewoxaotasxgpkj",
},
            new StringtextE0M
{
    Id = 71,
    Value = "ffqsxdobxbmhqqmrptbx",
    ModelInner = new Stringtext0MI
{
    Id = 31,
    Value = "wrbodbtcggomoppbhhyw",
    NullableValue = null,
},
    NullableValue = "inyrbktnmrcjyfjynkrou",
},
            new StringtextE0M
{
    Id = 79,
    Value = "gsswlauywr",
    ModelInner = null,
    NullableValue = "nrtrcypsnwtwtuk",
},
            new StringtextE0M
{
    Id = 84,
    Value = "pwcuuwuodwrolumko",
    ModelInner = new Stringtext0MI
{
    Id = 32,
    Value = "vlrnmvthd",
    ...
    NullableValue = "vdcehsrbhjhx",
},
            new StringtextE0M
{
    Id = 92,
    Value = "nygnrrtceiuakexjjmeetdfwhly",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
...
{
    Id = 100,
    Value = "ejeclsuisomqbtkudnikvbeukrjj",
    ModelInner = null,
    NullableValue = "fvibmkyb",
},
            new StringtextE0M
{
    Id = 105,
    ...
    ModelInner = new Stringtext0MI
{
    Id = 48,
    Value = "dvvkr",
    NullableValue = "twxtujtncifx",
},
    NullableValue = "qaawthyrabvkgawpndotj",
},
            new StringtextE0M
{
    Id = 114,
    Value = "rndbvuwaphwonhmgapcimdms",
    ModelInner = null,
    NullableValue = "ekdrgarjenkjnhjfguos",
},
            new StringtextE0M
{
    Id = 115,
    Value = "vdpraqvoepnpgsdsysyub",
    ModelInner = new Stringtext0MI
{
    Id = 51,
    Value = "sxldbabifkmuvdyvbl",
    NullableValue = null,
},
    NullableValue = "qquutqiactjwqirvps",
},
            new StringtextE0M
{
    Id = 121,
    Value = "tagjvuuroanxunfkl",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
    ...
    ModelInner = new Stringtext0MI
{
    ...
    NullableValue = "iidsnigpkax",
},
            new StringtextE0M
{
    Id = 133,
    Value = "awtatekgilcolfaikctwkngcea",
    ModelInner = null,
    NullableValue = "drxoheijjf",
},
            new StringtextE0M
{
    Id = 136,
    Value = "dorxfjflcpxlpkhrmhfhbyfdwtj",
    ModelInner = new Stringtext0MI
{
    Id = 63,
    Value = "nalngjntdmknwrvxcw",
    NullableValue = "xeiqelshlwcklwyimioxffjlqwn",
},
    NullableValue = null,
},
            new StringtextE0M
...
{
    Id = 144,
    Value = "xnaixvhkupivuuenhpkcbnqbif",
    ModelInner = new Stringtext0MI
{
    Id = 67,
    Value = "qwighbkmntmlyeupadmfkenj",
    NullableValue = "nwipomkln",
},
    NullableValue = "xrhtdyh",
},
            new StringtextE0M
{
    Id = 146,
...
{
    Id = 74,
    Value = "espwsdvmcxclvecgnhsjyfapeb",
    NullableValue = "qakjdpmrmpdarjqxsagbnmcc",
},
    NullableValue = null,
},
            new StringtextE0M
{
    Id = 157,
    Value = "riemtqynkknnprtuysfjlrujcpg",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
{
    Id = 158,
    Value = "thsaiogusvlbgeepwpdgmaeigk",
    ModelInner = new Stringtext0MI
{
    Id = 75,
    Value = "clovix",
    NullableValue = "dvqtoofmyjg",
},
    NullableValue = "vqslpkynnxinkexddjfano",
},
            new StringtextE0M
{
    Id = 166,
    Value = "qwgnnapevatdrvqfvid",
    ModelInner = null,
    NullableValue = null,
},
            new StringtextE0M
    ...
    ModelInner = new Stringtext0MI
{
    ...
    NullableValue = "jqhruntapwtmxnive",
},
            new StringtextE0M
{
    Id = 179,
    Value = "lsakvb",
    ModelInner = null,
    NullableValue = "kicaawkemuelnitkxcbohbmsaw",
},
        };
...
",
        ...
        public async Task InsertModelDynParTestReturningScalar()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.EqualTo("jsanvgbekwpm"));
            }
        }
        ...
        public async Task InsertModelDynParTestReturningScalarAsync()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo("wocomitsxx"));
            }
        }
...
",
        ...
        public async Task InsertModelTestReturningScalar()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo("fdhgfbadsjxqtxgnrabmgvl"));
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo("ccuwowgmjobsmojxkwrfybjegotaw"));
            }
        }
        ...
        public async Task InsertModelTestReturningScalarAsync()
        {
            await using (var connection = GlobalSetUp.GetConnection)
            {
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo("ifyrfgphxh"));
                ...
                Assert.That(nullable, Is.Not.Null);
                Assert.That(nullable, Is.EqualTo("gggveowmees"));
            }
        }
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(25));
                        ...
                        FlatStringtextE0M.AssertModel(secondItems2[0],_testData[10], false);
                        FlatStringtextE0M.AssertModel(secondItems1[1],_testData[11], false);
                        FlatStringtextE0M.AssertModel(secondItems2[1],_testData[11], false);
                        FlatStringtextE0M.AssertModel(secondItems1[2],_testData[12], false);
                        FlatStringtextE0M.AssertModel(secondItems2[2],_testData[12], false);
                        FlatStringtextE0M.AssertModel(secondItems1[3],_testData[13], false);
                        FlatStringtextE0M.AssertModel(secondItems2[3],_testData[13], false);
                        FlatStringtextE0M.AssertModel(secondItems1[4],_testData[14], false);
                        FlatStringtextE0M.AssertModel(secondItems2[4],_testData[14], false);
                        FlatStringtextE0M.AssertModel(secondItems1[5],_testData[15], false);
                        FlatStringtextE0M.AssertModel(secondItems2[5],_testData[15], false);
                        FlatStringtextE0M.AssertModel(secondItems1[6],_testData[16], false);
                        FlatStringtextE0M.AssertModel(secondItems2[6],_testData[16], false);
                        FlatStringtextE0M.AssertModel(secondItems1[7],_testData[17], false);
                        FlatStringtextE0M.AssertModel(secondItems2[7],_testData[17], false);
                        FlatStringtextE0M.AssertModel(secondItems1[8],_testData[18], false);
                        FlatStringtextE0M.AssertModel(secondItems2[8],_testData[18], false);
                        FlatStringtextE0M.AssertModel(secondItems1[9],_testData[19], false);
                        FlatStringtextE0M.AssertModel(secondItems2[9],_testData[19], false);
                        FlatStringtextE0M.AssertModel(secondItems1[10],_testData[20], false);
                        FlatStringtextE0M.AssertModel(secondItems2[10],_testData[20], false);
                        FlatStringtextE0M.AssertModel(secondItems1[11],_testData[21], false);
                        FlatStringtextE0M.AssertModel(secondItems2[11],_testData[21], false);
                        FlatStringtextE0M.AssertModel(secondItems1[12],_testData[22], false);
                        FlatStringtextE0M.AssertModel(secondItems2[12],_testData[22], false);
                        FlatStringtextE0M.AssertModel(secondItems1[13],_testData[23], false);
                        FlatStringtextE0M.AssertModel(secondItems2[13],_testData[23], false);
                        FlatStringtextE0M.AssertModel(secondItems1[14],_testData[24], false);
                        FlatStringtextE0M.AssertModel(secondItems2[14],_testData[24], false);
                        FlatStringtextE0M.AssertModel(secondItems1[15],_testData[25], false);
                        FlatStringtextE0M.AssertModel(secondItems2[15],_testData[25], false);
                        FlatStringtextE0M.AssertModel(secondItems1[16],_testData[26], false);
                        FlatStringtextE0M.AssertModel(secondItems2[16],_testData[26], false);
                        FlatStringtextE0M.AssertModel(secondItems1[17],_testData[27], false);
                        FlatStringtextE0M.AssertModel(secondItems2[17],_testData[27], false);
                        FlatStringtextE0M.AssertModel(secondItems1[18],_testData[28], false);
                        FlatStringtextE0M.AssertModel(secondItems2[18],_testData[28], false);
                        FlatStringtextE0M.AssertModel(secondItems1[19],_testData[29], false);
                        FlatStringtextE0M.AssertModel(secondItems2[19],_testData[29], false);
                        FlatStringtextE0M.AssertModel(secondItems1[20],_testData[30], false);
                        FlatStringtextE0M.AssertModel(secondItems2[20],_testData[30], false);
                        FlatStringtextE0M.AssertModel(secondItems1[21],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems2[21],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems1[22],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems2[22],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems1[23],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems2[23],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems1[24],_testData[34], false);
                        FlatStringtextE0M.AssertModel(secondItems2[24],_testData[34], false);
            }
        }
...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(7));
                        ...
                        FlatStringtextE0M.AssertModel(firstItems2[0],_testData[28], false);
                        FlatStringtextE0M.AssertModel(firstItems1[1],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems2[1],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems1[2],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems2[2],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems1[3],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems2[3],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems1[4],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems2[4],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems1[5],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems2[5],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems1[6],_testData[34], false);
                        FlatStringtextE0M.AssertModel(firstItems2[6],_testData[34], false);
...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(19));
                        ...
                        FlatStringtextE0M.AssertModel(firstItems2[0],_testData[16], false);
                        FlatStringtextE0M.AssertModel(firstItems1[1],_testData[17], false);
                        FlatStringtextE0M.AssertModel(firstItems2[1],_testData[17], false);
                        FlatStringtextE0M.AssertModel(firstItems1[2],_testData[18], false);
                        FlatStringtextE0M.AssertModel(firstItems2[2],_testData[18], false);
                        FlatStringtextE0M.AssertModel(firstItems1[3],_testData[19], false);
                        FlatStringtextE0M.AssertModel(firstItems2[3],_testData[19], false);
                        FlatStringtextE0M.AssertModel(firstItems1[4],_testData[20], false);
                        FlatStringtextE0M.AssertModel(firstItems2[4],_testData[20], false);
                        FlatStringtextE0M.AssertModel(firstItems1[5],_testData[21], false);
                        FlatStringtextE0M.AssertModel(firstItems2[5],_testData[21], false);
                        FlatStringtextE0M.AssertModel(firstItems1[6],_testData[22], false);
                        FlatStringtextE0M.AssertModel(firstItems2[6],_testData[22], false);
                        FlatStringtextE0M.AssertModel(firstItems1[7],_testData[23], false);
                        FlatStringtextE0M.AssertModel(firstItems2[7],_testData[23], false);
                        FlatStringtextE0M.AssertModel(firstItems1[8],_testData[24], false);
                        FlatStringtextE0M.AssertModel(firstItems2[8],_testData[24], false);
                        FlatStringtextE0M.AssertModel(firstItems1[9],_testData[25], false);
                        FlatStringtextE0M.AssertModel(firstItems2[9],_testData[25], false);
                        FlatStringtextE0M.AssertModel(firstItems1[10],_testData[26], false);
                        FlatStringtextE0M.AssertModel(firstItems2[10],_testData[26], false);
                        FlatStringtextE0M.AssertModel(firstItems1[11],_testData[27], false);
                        FlatStringtextE0M.AssertModel(firstItems2[11],_testData[27], false);
                        FlatStringtextE0M.AssertModel(firstItems1[12],_testData[28], false);
                        FlatStringtextE0M.AssertModel(firstItems2[12],_testData[28], false);
                        FlatStringtextE0M.AssertModel(firstItems1[13],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems2[13],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems1[14],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems2[14],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems1[15],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems2[15],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems1[16],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems2[16],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems1[17],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems2[17],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems1[18],_testData[34], false);
                        FlatStringtextE0M.AssertModel(firstItems2[18],_testData[34], false);
...
";
                ...
                foreach(var batchResult in await ((IStringSingleTypetext)this).DbConnectionSTDynQuerySelectModelDynParBatchAsync(connection, [parametr1], query1, [parametr2], query2))
                {
                    if(++resultIndex == 1)
                    {
                        ...
                        FlatStringtextE0M.AssertModel(models[0],_testData[19], false);
                        FlatStringtextE0M.AssertModel(models[1],_testData[20], false);
                        FlatStringtextE0M.AssertModel(models[2],_testData[21], false);
                        FlatStringtextE0M.AssertModel(models[3],_testData[22], false);
                        FlatStringtextE0M.AssertModel(models[4],_testData[23], false);
                        FlatStringtextE0M.AssertModel(models[5],_testData[24], false);
                        FlatStringtextE0M.AssertModel(models[6],_testData[25], false);
                        FlatStringtextE0M.AssertModel(models[7],_testData[26], false);
                        FlatStringtextE0M.AssertModel(models[8],_testData[27], false);
                        FlatStringtextE0M.AssertModel(models[9],_testData[28], false);
                        FlatStringtextE0M.AssertModel(models[10],_testData[29], false);
                        FlatStringtextE0M.AssertModel(models[11],_testData[30], false);
                        FlatStringtextE0M.AssertModel(models[12],_testData[31], false);
                        FlatStringtextE0M.AssertModel(models[13],_testData[32], false);
                        FlatStringtextE0M.AssertModel(models[14],_testData[33], false);
                        FlatStringtextE0M.AssertModel(models[15],_testData[34], false);
                        continue;
                    }                    
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        FlatStringtextE0M.AssertModel(models[0],_testData[29], false);
                        FlatStringtextE0M.AssertModel(models[1],_testData[30], false);
                        FlatStringtextE0M.AssertModel(models[2],_testData[31], false);
                        FlatStringtextE0M.AssertModel(models[3],_testData[32], false);
                        FlatStringtextE0M.AssertModel(models[4],_testData[33], false);
                        FlatStringtextE0M.AssertModel(models[5],_testData[34], false);
                        continue;
                    }
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(21));
                        FlatStringtextE0M.AssertModel(secondItems1[0],_testData[14], false);
                        FlatStringtextE0M.AssertModel(secondItems2[0],_testData[14], false);
                        FlatStringtextE0M.AssertModel(secondItems1[1],_testData[15], false);
                        FlatStringtextE0M.AssertModel(secondItems2[1],_testData[15], false);
                        FlatStringtextE0M.AssertModel(secondItems1[2],_testData[16], false);
                        FlatStringtextE0M.AssertModel(secondItems2[2],_testData[16], false);
                        FlatStringtextE0M.AssertModel(secondItems1[3],_testData[17], false);
                        FlatStringtextE0M.AssertModel(secondItems2[3],_testData[17], false);
                        FlatStringtextE0M.AssertModel(secondItems1[4],_testData[18], false);
                        FlatStringtextE0M.AssertModel(secondItems2[4],_testData[18], false);
                        FlatStringtextE0M.AssertModel(secondItems1[5],_testData[19], false);
                        FlatStringtextE0M.AssertModel(secondItems2[5],_testData[19], false);
                        FlatStringtextE0M.AssertModel(secondItems1[6],_testData[20], false);
                        FlatStringtextE0M.AssertModel(secondItems2[6],_testData[20], false);
                        FlatStringtextE0M.AssertModel(secondItems1[7],_testData[21], false);
                        FlatStringtextE0M.AssertModel(secondItems2[7],_testData[21], false);
                        FlatStringtextE0M.AssertModel(secondItems1[8],_testData[22], false);
                        FlatStringtextE0M.AssertModel(secondItems2[8],_testData[22], false);
                        FlatStringtextE0M.AssertModel(secondItems1[9],_testData[23], false);
                        FlatStringtextE0M.AssertModel(secondItems2[9],_testData[23], false);
                        FlatStringtextE0M.AssertModel(secondItems1[10],_testData[24], false);
                        FlatStringtextE0M.AssertModel(secondItems2[10],_testData[24], false);
                        FlatStringtextE0M.AssertModel(secondItems1[11],_testData[25], false);
                        FlatStringtextE0M.AssertModel(secondItems2[11],_testData[25], false);
                        FlatStringtextE0M.AssertModel(secondItems1[12],_testData[26], false);
                        FlatStringtextE0M.AssertModel(secondItems2[12],_testData[26], false);
                        FlatStringtextE0M.AssertModel(secondItems1[13],_testData[27], false);
                        FlatStringtextE0M.AssertModel(secondItems2[13],_testData[27], false);
                        FlatStringtextE0M.AssertModel(secondItems1[14],_testData[28], false);
                        FlatStringtextE0M.AssertModel(secondItems2[14],_testData[28], false);
                        FlatStringtextE0M.AssertModel(secondItems1[15],_testData[29], false);
                        FlatStringtextE0M.AssertModel(secondItems2[15],_testData[29], false);
                        FlatStringtextE0M.AssertModel(secondItems1[16],_testData[30], false);
                        FlatStringtextE0M.AssertModel(secondItems2[16],_testData[30], false);
                        FlatStringtextE0M.AssertModel(secondItems1[17],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems2[17],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems1[18],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems2[18],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems1[19],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems2[19],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems1[20],_testData[34], false);
                        FlatStringtextE0M.AssertModel(secondItems2[20],_testData[34], false);
            }
        }
            ...
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                foreach(var batchResult in  ((IStringSingleTypetext)this).DbConnectionSTSelectModelDynParBatch(connection, [parametr1], [parametr2]))
                {
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        StringtextE0M.AssertModel(models[0],_testData[30], false);
                        StringtextE0M.AssertModel(models[1],_testData[31], false);
                        StringtextE0M.AssertModel(models[2],_testData[32], false);
                        StringtextE0M.AssertModel(models[3],_testData[33], false);
                        StringtextE0M.AssertModel(models[4],_testData[34], false);
                        continue;
                    }
...
";
                ...
                var secondItems1 = new List<FlatStringtextE0M>();
                var secondItems2 = new List<FlatStringtextE0M>();
                await ((IStringSingleTypetext)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 33, query1, 157, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(4));
                        FlatStringtextE0M.AssertModel(secondItems1[0],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems2[0],_testData[31], false);
                        FlatStringtextE0M.AssertModel(secondItems1[1],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems2[1],_testData[32], false);
                        FlatStringtextE0M.AssertModel(secondItems1[2],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems2[2],_testData[33], false);
                        FlatStringtextE0M.AssertModel(secondItems1[3],_testData[34], false);
                        FlatStringtextE0M.AssertModel(secondItems2[3],_testData[34], false);
            }
        }
...
";
                ...
                var firstItems2 = new List<FlatStringtextE0M>();
                var secondItems1 = new List<FlatStringtextE0M>();
                await ((IStringSingleTypetext)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 39, query1, 136, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(27));
                Assert.That(firstItems2, Has.Count.EqualTo(27));
                        FlatStringtextE0M.AssertModel(firstItems1[0],_testData[8], false);
                        FlatStringtextE0M.AssertModel(firstItems2[0],_testData[8], false);
                        FlatStringtextE0M.AssertModel(firstItems1[1],_testData[9], false);
                        FlatStringtextE0M.AssertModel(firstItems2[1],_testData[9], false);
                        FlatStringtextE0M.AssertModel(firstItems1[2],_testData[10], false);
                        FlatStringtextE0M.AssertModel(firstItems2[2],_testData[10], false);
                        FlatStringtextE0M.AssertModel(firstItems1[3],_testData[11], false);
                        FlatStringtextE0M.AssertModel(firstItems2[3],_testData[11], false);
                        FlatStringtextE0M.AssertModel(firstItems1[4],_testData[12], false);
                        FlatStringtextE0M.AssertModel(firstItems2[4],_testData[12], false);
                        FlatStringtextE0M.AssertModel(firstItems1[5],_testData[13], false);
                        FlatStringtextE0M.AssertModel(firstItems2[5],_testData[13], false);
                        FlatStringtextE0M.AssertModel(firstItems1[6],_testData[14], false);
                        FlatStringtextE0M.AssertModel(firstItems2[6],_testData[14], false);
                        FlatStringtextE0M.AssertModel(firstItems1[7],_testData[15], false);
                        FlatStringtextE0M.AssertModel(firstItems2[7],_testData[15], false);
                        FlatStringtextE0M.AssertModel(firstItems1[8],_testData[16], false);
                        FlatStringtextE0M.AssertModel(firstItems2[8],_testData[16], false);
                        FlatStringtextE0M.AssertModel(firstItems1[9],_testData[17], false);
                        FlatStringtextE0M.AssertModel(firstItems2[9],_testData[17], false);
                        FlatStringtextE0M.AssertModel(firstItems1[10],_testData[18], false);
                        FlatStringtextE0M.AssertModel(firstItems2[10],_testData[18], false);
                        FlatStringtextE0M.AssertModel(firstItems1[11],_testData[19], false);
                        FlatStringtextE0M.AssertModel(firstItems2[11],_testData[19], false);
                        FlatStringtextE0M.AssertModel(firstItems1[12],_testData[20], false);
                        FlatStringtextE0M.AssertModel(firstItems2[12],_testData[20], false);
                        FlatStringtextE0M.AssertModel(firstItems1[13],_testData[21], false);
                        FlatStringtextE0M.AssertModel(firstItems2[13],_testData[21], false);
                        FlatStringtextE0M.AssertModel(firstItems1[14],_testData[22], false);
                        FlatStringtextE0M.AssertModel(firstItems2[14],_testData[22], false);
                        FlatStringtextE0M.AssertModel(firstItems1[15],_testData[23], false);
                        FlatStringtextE0M.AssertModel(firstItems2[15],_testData[23], false);
                        FlatStringtextE0M.AssertModel(firstItems1[16],_testData[24], false);
                        FlatStringtextE0M.AssertModel(firstItems2[16],_testData[24], false);
                        FlatStringtextE0M.AssertModel(firstItems1[17],_testData[25], false);
                        FlatStringtextE0M.AssertModel(firstItems2[17],_testData[25], false);
                        FlatStringtextE0M.AssertModel(firstItems1[18],_testData[26], false);
                        FlatStringtextE0M.AssertModel(firstItems2[18],_testData[26], false);
                        FlatStringtextE0M.AssertModel(firstItems1[19],_testData[27], false);
                        FlatStringtextE0M.AssertModel(firstItems2[19],_testData[27], false);
                        FlatStringtextE0M.AssertModel(firstItems1[20],_testData[28], false);
                        FlatStringtextE0M.AssertModel(firstItems2[20],_testData[28], false);
                        FlatStringtextE0M.AssertModel(firstItems1[21],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems2[21],_testData[29], false);
                        FlatStringtextE0M.AssertModel(firstItems1[22],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems2[22],_testData[30], false);
                        FlatStringtextE0M.AssertModel(firstItems1[23],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems2[23],_testData[31], false);
                        FlatStringtextE0M.AssertModel(firstItems1[24],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems2[24],_testData[32], false);
                        FlatStringtextE0M.AssertModel(firstItems1[25],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems2[25],_testData[33], false);
                        FlatStringtextE0M.AssertModel(firstItems1[26],_testData[34], false);
                        FlatStringtextE0M.AssertModel(firstItems2[26],_testData[34], false);
...
";
                ...
                var secondItems1 = new List<FlatStringtextE0M>();
                var secondItems2 = new List<FlatStringtextE0M>();
                 ((IStringSingleTypetext)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 4, query1, 114, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatStringtextE0M>();
                var secondItems1 = new List<FlatStringtextE0M>();
                 ((IStringSingleTypetext)this).DbConnectionMMDynQuerySelectModelBatch(connection, 158, query1, 26, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IStringSingleTypetext)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 146, query1, 141, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatStringtextE0M>();
                var secondItems2 = new List<FlatStringtextE0M>();
                await ((IStringSingleTypetext)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 146, query1, 144, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IStringSingleTypetext)this).DbConnectionSTDynQuerySelectModelBatch(connection, 21, query1, 149, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
                    ...
                    if(resultIndex == 2)
                    {
                        ...
                        FlatStringtextE0M.AssertModel(models[0],_testData[30], false);
                        FlatStringtextE0M.AssertModel(models[1],_testData[31], false);
                        FlatStringtextE0M.AssertModel(models[2],_testData[32], false);
                        FlatStringtextE0M.AssertModel(models[3],_testData[33], false);
                        FlatStringtextE0M.AssertModel(models[4],_testData[34], false);
                        continue;
                    }
...
";
                ...
                var secondItems1 = new List<FlatStringtextE0M>();
                var secondItems2 = new List<FlatStringtextE0M>();
                 ((IStringSingleTypetext)this).DbConnectionDynQuerySelectModelBatch(connection, 21, query1, 22, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IStringSingleTypetext)this).DbConnectionSTSelectModelBatchAsync(connection, 115, 16))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IStringSingleTypetext)this).DbConnectionSTSelectModelBatch(connection, 26, 114))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                StringtextE0M.AssertModel(models[0],_testData[4], false);
                StringtextE0M.AssertModel(models[1],_testData[5], false);
                StringtextE0M.AssertModel(models[2],_testData[6], false);
                StringtextE0M.AssertModel(models[3],_testData[7], false);
                StringtextE0M.AssertModel(models[4],_testData[8], false);
                StringtextE0M.AssertModel(models[5],_testData[9], false);
                StringtextE0M.AssertModel(models[6],_testData[10], false);
                StringtextE0M.AssertModel(models[7],_testData[11], false);
                StringtextE0M.AssertModel(models[8],_testData[12], false);
                StringtextE0M.AssertModel(models[9],_testData[13], false);
                StringtextE0M.AssertModel(models[10],_testData[14], false);
                StringtextE0M.AssertModel(models[11],_testData[15], false);
                StringtextE0M.AssertModel(models[12],_testData[16], false);
                StringtextE0M.AssertModel(models[13],_testData[17], false);
                StringtextE0M.AssertModel(models[14],_testData[18], false);
                StringtextE0M.AssertModel(models[15],_testData[19], false);
                StringtextE0M.AssertModel(models[16],_testData[20], false);
                StringtextE0M.AssertModel(models[17],_testData[21], false);
                StringtextE0M.AssertModel(models[18],_testData[22], false);
                StringtextE0M.AssertModel(models[19],_testData[23], false);
                StringtextE0M.AssertModel(models[20],_testData[24], false);
                StringtextE0M.AssertModel(models[21],_testData[25], false);
                StringtextE0M.AssertModel(models[22],_testData[26], false);
                StringtextE0M.AssertModel(models[23],_testData[27], false);
                StringtextE0M.AssertModel(models[24],_testData[28], false);
                StringtextE0M.AssertModel(models[25],_testData[29], false);
                StringtextE0M.AssertModel(models[26],_testData[30], false);
                StringtextE0M.AssertModel(models[27],_testData[31], false);
                StringtextE0M.AssertModel(models[28],_testData[32], false);
                StringtextE0M.AssertModel(models[29],_testData[33], false);
                StringtextE0M.AssertModel(models[30],_testData[34], false);
            }
        }
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IStringSingleTypetext)this).SetDbConnectionSelectModelParametrs(cmd, 4);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("ibxuxyhgqabroimelinivrsokexg")));//Value
                ...
                Assert.That((System.String)model[3], Is.EqualTo(("ivydytjdofqgqxvqgtrcfbxbgsya")));//InnerModel.Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("stdksdhouvlenpeatf")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("blavbug")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((11)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("rweksyomnwbpnlf")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("ppnmbipkfivyi")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("yvwo")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("jwgobrwtibln")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((13)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("lijnt")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("jsanvgbekwpm")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("rtlhqhgeyewingemfrssbhekon")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("issanbauxxkavdbgveg")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((18)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("jtvydialxlamgbag")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("wocomitsxx")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("opgjbmrjrauwispxjurg")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("fdhgfbadsjxqtxgnrabmgvl")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("clxrdvvdicuxjhetxwxowbm")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((19)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("xitnsfheqtmplgcfdxtrefrkjwivh")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("ccuwowgmjobsmojxkwrfybjegotaw")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("uddgrnrshvdqfkpicbkdnsharf")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("ifyrfgphxh")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("wekxggq")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((24)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("pnrgeepfiuoo")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("gggveowmees")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("gdjvpcsxlbf")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("oxkuufpewoxaotasxgpkj")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("ffqsxdobxbmhqqmrptbx")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((31)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("wrbodbtcggomoppbhhyw")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("inyrbktnmrcjyfjynkrou")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("gsswlauywr")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("nrtrcypsnwtwtuk")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("pwcuuwuodwrolumko")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((32)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("vlrnmvthd")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("xmflt")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("vdcehsrbhjhx")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("nygnrrtceiuakexjjmeetdfwhly")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("scxbmxnfyeladq")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((40)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("ckbpchfcuh")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("thu")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("ejeclsuisomqbtkudnikvbeukrjj")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("fvibmkyb")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("gqmwvuo")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((48)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("dvvkr")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("twxtujtncifx")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("qaawthyrabvkgawpndotj")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("rndbvuwaphwonhmgapcimdms")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("ekdrgarjenkjnhjfguos")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("vdpraqvoepnpgsdsysyub")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((51)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("sxldbabifkmuvdyvbl")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("qquutqiactjwqirvps")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("tagjvuuroanxunfkl")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("larwtpmandd")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((57)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("x")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("iidsnigpkax")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("awtatekgilcolfaikctwkngcea")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("drxoheijjf")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("dorxfjflcpxlpkhrmhfhbyfdwtj")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((63)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("nalngjntdmknwrvxcw")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("xeiqelshlwcklwyimioxffjlqwn")));//InnerModel.NullableValue
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("qccbrjapyd")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("xnaixvhkupivuuenhpkcbnqbif")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((67)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("qwighbkmntmlyeupadmfkenj")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("nwipomkln")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("xrhtdyh")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("hvibaskqxwqg")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("pitqfjpmc")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((74)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("espwsdvmcxclvecgnhsjyfapeb")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("qakjdpmrmpdarjqxsagbnmcc")));//InnerModel.NullableValue
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("riemtqynkknnprtuysfjlrujcpg")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("thsaiogusvlbgeepwpdgmaeigk")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((75)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("clovix")));//InnerModel.Value

                Assert.That((System.String)model[4], Is.EqualTo(("dvqtoofmyjg")));//InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("vqslpkynnxinkexddjfano")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("qwgnnapevatdrvqfvid")));//Value
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("vdy")));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((76)));//InnerModel.Id
                Assert.That((System.String)model[3], Is.EqualTo(("uawtpwl")));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.String)model[5], Is.EqualTo(("jqhruntapwtmxnive")));
                ...
                Assert.That((System.String)model[1], Is.EqualTo(("lsakvb")));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.String)model[5], Is.EqualTo(("kicaawkemuelnitkxcbohbmsaw")));
