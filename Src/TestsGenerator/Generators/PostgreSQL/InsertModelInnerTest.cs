...
namespace TestsGenerator.Generators.PostgreSQL
{
    internal static class InsertModelInner
    {
            ...
            )
        {
            ...
            InsertModelInnerTest(order, stringBuilder, storage, ref indexValue, indexValue + 2, isAsync: false);
            InsertModelInnerTest(order, stringBuilder, storage, ref indexValue, indexValue + 2, isAsync: true);
        }
