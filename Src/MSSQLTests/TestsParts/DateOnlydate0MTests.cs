...
{
    Id = 9,
    Value = new DateOnly(year: 1998, month: 10, day: 15),
...
{
    Id = 28,
    Value = new DateOnly(year: 1974, month: 10, day: 10),
    ModelInner = null,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1974, month: 10, day: 4),
},
            new DateOnlydate0M
{
    Id = 41,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1977, month: 10, day: 14),
},
            new DateOnlydate0M
{
    Id = 51,
...
{
    Id = 57,
    Value = new DateOnly(year: 2008, month: 10, day: 14),
    ModelInner = new DateOnlydate0MI
{
    Id = 23,
    Value = new DateOnly(year: 1946, month: 10, day: 3),
    NullableValue = new DateOnly(year: 2014, month: 10, day: 3),
},
    NullableValue = null,
},
            new DateOnlydate0M
{
    Id = 65,
    Value = new DateOnly(year: 1940, month: 10, day: 9),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 30,
    Value = new DateOnly(year: 1946, month: 10, day: 2),
    NullableValue = new DateOnly(year: 1965, month: 10, day: 6),
},
    NullableValue = new DateOnly(year: 2017, month: 10, day: 19),
},
            new DateOnlydate0M
{
    Id = 79,
...
{
    Id = 44,
    Value = new DateOnly(year: 1980, month: 10, day: 8),
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 102,
    Value = new DateOnly(year: 2004, month: 10, day: 17),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
            ...
            new DateOnlydate0M
{
    ...
    Value = new DateOnly(year: 2003, month: 10, day: 13),
    ModelInner = null,
    NullableValue = new DateOnly(year: 1957, month: 10, day: 10),
},
            new DateOnlydate0M
{
    Id = 126,
    Value = new DateOnly(year: 1922, month: 10, day: 11),
    ModelInner = new DateOnlydate0MI
{
    Id = 57,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1961, month: 10, day: 13),
},
            new DateOnlydate0M
{
    Id = 134,
    Value = new DateOnly(year: 1979, month: 10, day: 9),
    ModelInner = null,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2017, month: 10, day: 12),
},
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2012, month: 10, day: 13),
},
            new DateOnlydate0M
{
    Id = 162,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2002, month: 10, day: 16),
},
            new DateOnlydate0M
{
    Id = 173,
...
{
    Id = 93,
    Value = new DateOnly(year: 1946, month: 10, day: 10),
    NullableValue = new DateOnly(year: 1976, month: 10, day: 7),
},
    NullableValue = new DateOnly(year: 1992, month: 10, day: 11),
},
            new DateOnlydate0M
{
    Id = 193,
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 142, query1, 148, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 78, query1, 74, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 9, query1, 148, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 79, query1, 142, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(20));
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 57, query1, 51, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 9, query1, 85, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(33));
                        FlatDateOnlydate0M.AssertModel(firstItems1[0],_testData[2], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[1],_testData[3], false);
                        FlatDateOnlydate0M.AssertModel(firstItems1[2],_testData[4], false);
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 102, query1, 169, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 25, 18))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 57, 154))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((3)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1992, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1963, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1974, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1940, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1974, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1991, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 2003, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1977, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2008, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 2014, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1940, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1942, month: 10, day: 5)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1931, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2004, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1946, month: 10, day: 2)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1965, month: 10, day: 6)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2017, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2018, month: 10, day: 6)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 2)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((38)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1978, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1922, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2000, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1980, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2004, month: 10, day: 17)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1960, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1957, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1922, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1925, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1950, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((63)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 2011, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1973, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1961, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 2017, month: 10, day: 12)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1919, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2012, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1949, month: 10, day: 6)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1956, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((93)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1946, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1992, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1964, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));
