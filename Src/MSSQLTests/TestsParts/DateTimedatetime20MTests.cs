...
{
    Id = 6,
    Value = new DateTime(year: 2001, month: 10, day: 14, hour: 12, minute: 7, second: 25, millisecond: 84, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1993, month: 10, day: 3, hour: 17, minute: 3, second: 25, millisecond: 375, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 15,
    Value = new DateTime(year: 1983, month: 10, day: 17, hour: 13, minute: 11, second: 42, millisecond: 837, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 3,
    Value = new DateTime(year: 1959, month: 10, day: 7, hour: 7, minute: 53, second: 29, millisecond: 275, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1993, month: 10, day: 7, hour: 5, minute: 35, second: 50, millisecond: 706, kind: DateTimeKind.Local),
},
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 16,
    Value = new DateTime(year: 2000, month: 10, day: 17, hour: 12, minute: 27, second: 40, millisecond: 201, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 18,
    Value = new DateTime(year: 1981, month: 10, day: 3, hour: 2, minute: 23, second: 58, millisecond: 403, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 5,
    Value = new DateTime(year: 1933, month: 10, day: 6, hour: 17, minute: 16, second: 48, millisecond: 453, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 21,
    Value = new DateTime(year: 1988, month: 10, day: 14, hour: 15, minute: 15, second: 55, millisecond: 833, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 27,
    Value = new DateTime(year: 1933, month: 10, day: 14, hour: 20, minute: 18, second: 36, millisecond: 338, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 9,
    Value = new DateTime(year: 1979, month: 10, day: 13, hour: 7, minute: 21, second: 47, millisecond: 661, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = new DateTime(year: 2019, month: 10, day: 4, hour: 4, minute: 28, second: 55, millisecond: 344, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 34,
    Value = new DateTime(year: 1996, month: 10, day: 19, hour: 13, minute: 1, second: 11, millisecond: 254, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1921, month: 10, day: 18, hour: 1, minute: 21, second: 25, millisecond: 507, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 41,
    Value = new DateTime(year: 1987, month: 10, day: 17, hour: 10, minute: 21, second: 20, millisecond: 773, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 16,
    Value = new DateTime(year: 2000, month: 10, day: 11, hour: 18, minute: 47, second: 34, millisecond: 122, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1998, month: 10, day: 3, hour: 17, minute: 9, second: 13, millisecond: 200, kind: DateTimeKind.Local),
},
    NullableValue = new DateTime(year: 2011, month: 10, day: 9, hour: 5, minute: 19, second: 13, millisecond: 954, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 49,
    Value = new DateTime(year: 1963, month: 10, day: 5, hour: 18, minute: 6, second: 16, millisecond: 704, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1971, month: 10, day: 15, hour: 10, minute: 57, second: 9, millisecond: 358, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 54,
    Value = new DateTime(year: 1989, month: 10, day: 3, hour: 7, minute: 20, second: 47, millisecond: 238, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 22,
    Value = new DateTime(year: 1984, month: 10, day: 4, hour: 15, minute: 52, second: 39, millisecond: 933, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1969, month: 10, day: 12, hour: 11, minute: 14, second: 44, millisecond: 697, kind: DateTimeKind.Local),
},
    NullableValue = new DateTime(year: 2006, month: 10, day: 6, hour: 14, minute: 9, second: 46, millisecond: 607, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 57,
    Value = new DateTime(year: 1992, month: 10, day: 14, hour: 16, minute: 5, second: 33, millisecond: 556, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1960, month: 10, day: 2, hour: 7, minute: 47, second: 49, millisecond: 635, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 64,
    Value = new DateTime(year: 1984, month: 10, day: 6, hour: 19, minute: 33, second: 18, millisecond: 846, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 31,
    Value = new DateTime(year: 2014, month: 10, day: 11, hour: 19, minute: 38, second: 31, millisecond: 245, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 2008, month: 10, day: 8, hour: 6, minute: 57, second: 29, millisecond: 452, kind: DateTimeKind.Local),
},
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 66,
    Value = new DateTime(year: 1930, month: 10, day: 12, hour: 9, minute: 6, second: 38, millisecond: 945, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 70,
    Value = new DateTime(year: 2009, month: 10, day: 14, hour: 20, minute: 38, second: 40, millisecond: 764, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 33,
    Value = new DateTime(year: 1979, month: 10, day: 8, hour: 14, minute: 49, second: 38, millisecond: 737, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = new DateTime(year: 2000, month: 10, day: 12, hour: 5, minute: 53, second: 40, millisecond: 912, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 71,
    Value = new DateTime(year: 1917, month: 10, day: 3, hour: 20, minute: 23, second: 4, millisecond: 258, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1952, month: 10, day: 10, hour: 13, minute: 52, second: 26, millisecond: 596, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 74,
    Value = new DateTime(year: 1968, month: 10, day: 16, hour: 9, minute: 20, second: 32, millisecond: 188, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 37,
    Value = new DateTime(year: 2019, month: 10, day: 3, hour: 21, minute: 33, second: 45, millisecond: 479, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 2003, month: 10, day: 10, hour: 16, minute: 55, second: 26, millisecond: 518, kind: DateTimeKind.Local),
},
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 79,
    Value = new DateTime(year: 1952, month: 10, day: 12, hour: 7, minute: 24, second: 45, millisecond: 122, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1971, month: 10, day: 19, hour: 1, minute: 30, second: 39, millisecond: 258, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 86,
    Value = new DateTime(year: 2013, month: 10, day: 14, hour: 11, minute: 38, second: 7, millisecond: 825, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 42,
    Value = new DateTime(year: 1960, month: 10, day: 6, hour: 20, minute: 39, second: 42, millisecond: 31, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1993, month: 10, day: 7, hour: 10, minute: 5, second: 25, millisecond: 169, kind: DateTimeKind.Local),
},
    NullableValue = new DateTime(year: 1961, month: 10, day: 11, hour: 6, minute: 10, second: 37, millisecond: 612, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 95,
    Value = new DateTime(year: 1988, month: 10, day: 1, hour: 10, minute: 8, second: 16, millisecond: 385, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1984, month: 10, day: 2, hour: 9, minute: 57, second: 49, millisecond: 519, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 104,
    Value = new DateTime(year: 1977, month: 10, day: 3, hour: 15, minute: 36, second: 55, millisecond: 412, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 45,
    Value = new DateTime(year: 2000, month: 10, day: 3, hour: 14, minute: 1, second: 46, millisecond: 464, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = new DateTime(year: 1954, month: 10, day: 17, hour: 18, minute: 10, second: 47, millisecond: 821, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 113,
    Value = new DateTime(year: 1969, month: 10, day: 14, hour: 15, minute: 50, second: 9, millisecond: 280, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 122,
    Value = new DateTime(year: 1956, month: 10, day: 17, hour: 19, minute: 2, second: 3, millisecond: 53, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 50,
    Value = new DateTime(year: 1919, month: 10, day: 2, hour: 19, minute: 18, second: 31, millisecond: 11, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1919, month: 10, day: 10, hour: 8, minute: 26, second: 54, millisecond: 326, kind: DateTimeKind.Local),
},
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 127,
    Value = new DateTime(year: 1953, month: 10, day: 3, hour: 3, minute: 14, second: 49, millisecond: 939, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1980, month: 10, day: 10, hour: 18, minute: 45, second: 56, millisecond: 449, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 128,
    Value = new DateTime(year: 2019, month: 10, day: 1, hour: 17, minute: 47, second: 17, millisecond: 503, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 59,
    Value = new DateTime(year: 1992, month: 10, day: 8, hour: 22, minute: 49, second: 1, millisecond: 662, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 133,
    Value = new DateTime(year: 1947, month: 10, day: 12, hour: 21, minute: 25, second: 11, millisecond: 511, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1984, month: 10, day: 16, hour: 2, minute: 48, second: 48, millisecond: 24, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 135,
    Value = new DateTime(year: 1994, month: 10, day: 13, hour: 6, minute: 53, second: 56, millisecond: 228, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 61,
    Value = new DateTime(year: 1966, month: 10, day: 13, hour: 7, minute: 15, second: 17, millisecond: 845, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1963, month: 10, day: 2, hour: 7, minute: 58, second: 31, millisecond: 814, kind: DateTimeKind.Local),
},
    NullableValue = new DateTime(year: 2006, month: 10, day: 14, hour: 17, minute: 27, second: 8, millisecond: 927, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 140,
    Value = new DateTime(year: 1954, month: 10, day: 12, hour: 4, minute: 18, second: 17, millisecond: 760, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 147,
    Value = new DateTime(year: 1995, month: 10, day: 5, hour: 20, minute: 41, second: 51, millisecond: 110, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 70,
    Value = new DateTime(year: 1938, month: 10, day: 11, hour: 15, minute: 7, second: 47, millisecond: 960, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 1954, month: 10, day: 14, hour: 14, minute: 3, second: 32, millisecond: 211, kind: DateTimeKind.Local),
},
    NullableValue = null,
},
            new DateTimedatetime20M
{
    Id = 153,
    Value = new DateTime(year: 1945, month: 10, day: 10, hour: 11, minute: 24, second: 3, millisecond: 671, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1979, month: 10, day: 10, hour: 18, minute: 40, second: 27, millisecond: 767, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 158,
    Value = new DateTime(year: 1954, month: 10, day: 19, hour: 2, minute: 40, second: 19, millisecond: 415, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 78,
    Value = new DateTime(year: 1981, month: 10, day: 19, hour: 1, minute: 57, second: 50, millisecond: 330, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = new DateTime(year: 1940, month: 10, day: 17, hour: 13, minute: 39, second: 51, millisecond: 543, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 161,
    Value = new DateTime(year: 2010, month: 10, day: 8, hour: 15, minute: 3, second: 50, millisecond: 501, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1983, month: 10, day: 17, hour: 2, minute: 49, second: 54, millisecond: 525, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 164,
    Value = new DateTime(year: 1952, month: 10, day: 2, hour: 11, minute: 1, second: 10, millisecond: 862, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 86,
    Value = new DateTime(year: 1967, month: 10, day: 8, hour: 10, minute: 1, second: 45, millisecond: 259, kind: DateTimeKind.Local),
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 169,
    Value = new DateTime(year: 1959, month: 10, day: 19, hour: 10, minute: 53, second: 20, millisecond: 428, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = new DateTime(year: 1961, month: 10, day: 7, hour: 4, minute: 35, second: 24, millisecond: 793, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 177,
    Value = new DateTime(year: 1991, month: 10, day: 16, hour: 19, minute: 16, second: 44, millisecond: 714, kind: DateTimeKind.Local),
    ModelInner = new DateTimedatetime20MI
{
    Id = 90,
    Value = new DateTime(year: 1940, month: 10, day: 16, hour: 11, minute: 38, second: 1, millisecond: 881, kind: DateTimeKind.Local),
    NullableValue = new DateTime(year: 2011, month: 10, day: 16, hour: 7, minute: 44, second: 15, millisecond: 490, kind: DateTimeKind.Local),
},
    NullableValue = new DateTime(year: 2005, month: 10, day: 19, hour: 14, minute: 52, second: 56, millisecond: 390, kind: DateTimeKind.Local),
},
            new DateTimedatetime20M
{
    Id = 181,
    Value = new DateTime(year: 1971, month: 10, day: 6, hour: 8, minute: 36, second: 40, millisecond: 853, kind: DateTimeKind.Local),
    ModelInner = null,
    NullableValue = null,
},
        };
...
";
                ...
                Assert.That(firstItems2, Has.Count.EqualTo(20));
                        ...
                        FlatDateTimedatetime20M.AssertModel(firstItems2[15],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[16],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems2[16],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[17],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems2[17],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[18],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems2[18],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[19],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems2[19],_testData[34], false);
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(32));
                        ...
                        FlatDateTimedatetime20M.AssertModel(secondItems2[0],_testData[3], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[1],_testData[4], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[1],_testData[4], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[2],_testData[5], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[2],_testData[5], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[3],_testData[6], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[3],_testData[6], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[4],_testData[7], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[4],_testData[7], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[5],_testData[8], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[5],_testData[8], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[6],_testData[9], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[6],_testData[9], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[7],_testData[10], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[7],_testData[10], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[8],_testData[11], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[8],_testData[11], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[9],_testData[12], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[9],_testData[12], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[10],_testData[13], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[10],_testData[13], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[11],_testData[14], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[11],_testData[14], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[12],_testData[15], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[12],_testData[15], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[13],_testData[16], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[13],_testData[16], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[14],_testData[17], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[14],_testData[17], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[15],_testData[18], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[15],_testData[18], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[16],_testData[19], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[16],_testData[19], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[17],_testData[20], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[17],_testData[20], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[18],_testData[21], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[18],_testData[21], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[19],_testData[22], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[19],_testData[22], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[20],_testData[23], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[20],_testData[23], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[21],_testData[24], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[21],_testData[24], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[22],_testData[25], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[22],_testData[25], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[23],_testData[26], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[23],_testData[26], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[24],_testData[27], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[24],_testData[27], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[25],_testData[28], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[25],_testData[28], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[26],_testData[29], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[26],_testData[29], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[27],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[27],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[28],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[28],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[29],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[29],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[30],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[30],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[31],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[31],_testData[34], false);
            }
        }
...
";
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(8));
                        ...
                        FlatDateTimedatetime20M.AssertModel(secondItems1[3],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[3],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[4],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[4],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[5],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[5],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[6],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[6],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[7],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[7],_testData[34], false);
            }
        }
...
";
                ...
                Assert.That(firstItems1, Has.Count.EqualTo(31));
                        ...
                        FlatDateTimedatetime20M.AssertModel(firstItems1[26],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[27],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[28],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[29],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[30],_testData[34], false);
                Assert.That(secondItems1, Has.Count.EqualTo(28));
                Assert.That(secondItems2, Has.Count.EqualTo(28));
                        FlatDateTimedatetime20M.AssertModel(secondItems1[0],_testData[7], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[0],_testData[7], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[1],_testData[8], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[1],_testData[8], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[2],_testData[9], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[2],_testData[9], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[3],_testData[10], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[3],_testData[10], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[4],_testData[11], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[4],_testData[11], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[5],_testData[12], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[5],_testData[12], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[6],_testData[13], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[6],_testData[13], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[7],_testData[14], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[7],_testData[14], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[8],_testData[15], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[8],_testData[15], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[9],_testData[16], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[9],_testData[16], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[10],_testData[17], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[10],_testData[17], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[11],_testData[18], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[11],_testData[18], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[12],_testData[19], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[12],_testData[19], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[13],_testData[20], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[13],_testData[20], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[14],_testData[21], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[14],_testData[21], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[15],_testData[22], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[15],_testData[22], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[16],_testData[23], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[16],_testData[23], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[17],_testData[24], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[17],_testData[24], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[18],_testData[25], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[18],_testData[25], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[19],_testData[26], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[19],_testData[26], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[20],_testData[27], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[20],_testData[27], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[21],_testData[28], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[21],_testData[28], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[22],_testData[29], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[22],_testData[29], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[23],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[23],_testData[30], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[24],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[24],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[25],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[25],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[26],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[26],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[27],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[27],_testData[34], false);
            }
        }
...
";
                ...
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                var secondItems2 = new List<FlatDateTimedatetime20M>();
                await ((IDateTimeSingleTypedatetime2)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 34, query1, 147, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(7));
                        ...
                        FlatDateTimedatetime20M.AssertModel(secondItems2[0],_testData[28], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[1],_testData[29], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[1],_testData[29], false);
                        ...
                        FlatDateTimedatetime20M.AssertModel(secondItems2[3],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[4],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[4],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[5],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[5],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[6],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[6],_testData[34], false);
            }
        }
...
";
                ...
                var firstItems2 = new List<FlatDateTimedatetime20M>();
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                await ((IDateTimeSingleTypedatetime2)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 16, query1, 158, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(32));
                Assert.That(firstItems2, Has.Count.EqualTo(32));
                        FlatDateTimedatetime20M.AssertModel(firstItems1[0],_testData[3], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems2[0],_testData[3], false);
...
";
                ...
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                var secondItems2 = new List<FlatDateTimedatetime20M>();
                 ((IDateTimeSingleTypedatetime2)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 164, query1, 122, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateTimedatetime20M>();
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                 ((IDateTimeSingleTypedatetime2)this).DbConnectionMMDynQuerySelectModelBatch(connection, 122, query1, 6, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateTimeSingleTypedatetime2)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 27, query1, 18, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                var secondItems2 = new List<FlatDateTimedatetime20M>();
                await ((IDateTimeSingleTypedatetime2)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 113, query1, 15, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                Assert.That(firstItems1, Has.Count.EqualTo(14));
                        FlatDateTimedatetime20M.AssertModel(firstItems1[0],_testData[21], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[1],_testData[22], false);
                        FlatDateTimedatetime20M.AssertModel(firstItems1[2],_testData[23], false);
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateTimeSingleTypedatetime2)this).DbConnectionSTDynQuerySelectModelBatch(connection, 133, query1, 140, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateTimedatetime20M>();
                var secondItems2 = new List<FlatDateTimedatetime20M>();
                 ((IDateTimeSingleTypedatetime2)this).DbConnectionDynQuerySelectModelBatch(connection, 27, query1, 21, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
                ...
                Assert.That(secondItems2, Has.Count.EqualTo(30));
                        ...
                        FlatDateTimedatetime20M.AssertModel(secondItems2[26],_testData[31], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[27],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[27],_testData[32], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[28],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[28],_testData[33], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems1[29],_testData[34], false);
                        FlatDateTimedatetime20M.AssertModel(secondItems2[29],_testData[34], false);
            }
        }
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateTimeSingleTypedatetime2)this).DbConnectionSTSelectModelBatchAsync(connection, 161, 95))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateTimeSingleTypedatetime2)this).DbConnectionSTSelectModelBatch(connection, 66, 6))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateTimeSingleTypedatetime2)this).SetDbConnectionSelectModelParametrs(cmd, 158);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateTimeSingleTypedatetime2)this).SetDbConnectionSelectModelParametrs(cmd, 16);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2001, month: 10, day: 14, hour: 12, minute: 7, second: 25, millisecond: 84, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1993, month: 10, day: 3, hour: 17, minute: 3, second: 25, millisecond: 375, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1983, month: 10, day: 17, hour: 13, minute: 11, second: 42, millisecond: 837, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((3)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1959, month: 10, day: 7, hour: 7, minute: 53, second: 29, millisecond: 275, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1993, month: 10, day: 7, hour: 5, minute: 35, second: 50, millisecond: 706, kind: DateTimeKind.Local))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2000, month: 10, day: 17, hour: 12, minute: 27, second: 40, millisecond: 201, kind: DateTimeKind.Local))));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1981, month: 10, day: 3, hour: 2, minute: 23, second: 58, millisecond: 403, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((5)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1933, month: 10, day: 6, hour: 17, minute: 16, second: 48, millisecond: 453, kind: DateTimeKind.Local))));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1988, month: 10, day: 14, hour: 15, minute: 15, second: 55, millisecond: 833, kind: DateTimeKind.Local))));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1933, month: 10, day: 14, hour: 20, minute: 18, second: 36, millisecond: 338, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((9)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1979, month: 10, day: 13, hour: 7, minute: 21, second: 47, millisecond: 661, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2019, month: 10, day: 4, hour: 4, minute: 28, second: 55, millisecond: 344, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1996, month: 10, day: 19, hour: 13, minute: 1, second: 11, millisecond: 254, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1921, month: 10, day: 18, hour: 1, minute: 21, second: 25, millisecond: 507, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1987, month: 10, day: 17, hour: 10, minute: 21, second: 20, millisecond: 773, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((16)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 2000, month: 10, day: 11, hour: 18, minute: 47, second: 34, millisecond: 122, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1998, month: 10, day: 3, hour: 17, minute: 9, second: 13, millisecond: 200, kind: DateTimeKind.Local))));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2011, month: 10, day: 9, hour: 5, minute: 19, second: 13, millisecond: 954, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1963, month: 10, day: 5, hour: 18, minute: 6, second: 16, millisecond: 704, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1971, month: 10, day: 15, hour: 10, minute: 57, second: 9, millisecond: 358, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1989, month: 10, day: 3, hour: 7, minute: 20, second: 47, millisecond: 238, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((22)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1984, month: 10, day: 4, hour: 15, minute: 52, second: 39, millisecond: 933, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1969, month: 10, day: 12, hour: 11, minute: 14, second: 44, millisecond: 697, kind: DateTimeKind.Local))));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2006, month: 10, day: 6, hour: 14, minute: 9, second: 46, millisecond: 607, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1992, month: 10, day: 14, hour: 16, minute: 5, second: 33, millisecond: 556, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1960, month: 10, day: 2, hour: 7, minute: 47, second: 49, millisecond: 635, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1984, month: 10, day: 6, hour: 19, minute: 33, second: 18, millisecond: 846, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((31)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 2014, month: 10, day: 11, hour: 19, minute: 38, second: 31, millisecond: 245, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 2008, month: 10, day: 8, hour: 6, minute: 57, second: 29, millisecond: 452, kind: DateTimeKind.Local))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1930, month: 10, day: 12, hour: 9, minute: 6, second: 38, millisecond: 945, kind: DateTimeKind.Local))));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2009, month: 10, day: 14, hour: 20, minute: 38, second: 40, millisecond: 764, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((33)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1979, month: 10, day: 8, hour: 14, minute: 49, second: 38, millisecond: 737, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2000, month: 10, day: 12, hour: 5, minute: 53, second: 40, millisecond: 912, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1917, month: 10, day: 3, hour: 20, minute: 23, second: 4, millisecond: 258, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1952, month: 10, day: 10, hour: 13, minute: 52, second: 26, millisecond: 596, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1968, month: 10, day: 16, hour: 9, minute: 20, second: 32, millisecond: 188, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((37)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 2019, month: 10, day: 3, hour: 21, minute: 33, second: 45, millisecond: 479, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 2003, month: 10, day: 10, hour: 16, minute: 55, second: 26, millisecond: 518, kind: DateTimeKind.Local))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1952, month: 10, day: 12, hour: 7, minute: 24, second: 45, millisecond: 122, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1971, month: 10, day: 19, hour: 1, minute: 30, second: 39, millisecond: 258, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2013, month: 10, day: 14, hour: 11, minute: 38, second: 7, millisecond: 825, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((42)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1960, month: 10, day: 6, hour: 20, minute: 39, second: 42, millisecond: 31, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1993, month: 10, day: 7, hour: 10, minute: 5, second: 25, millisecond: 169, kind: DateTimeKind.Local))));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1961, month: 10, day: 11, hour: 6, minute: 10, second: 37, millisecond: 612, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1988, month: 10, day: 1, hour: 10, minute: 8, second: 16, millisecond: 385, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1984, month: 10, day: 2, hour: 9, minute: 57, second: 49, millisecond: 519, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1977, month: 10, day: 3, hour: 15, minute: 36, second: 55, millisecond: 412, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((45)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 2000, month: 10, day: 3, hour: 14, minute: 1, second: 46, millisecond: 464, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1954, month: 10, day: 17, hour: 18, minute: 10, second: 47, millisecond: 821, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1969, month: 10, day: 14, hour: 15, minute: 50, second: 9, millisecond: 280, kind: DateTimeKind.Local))));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1956, month: 10, day: 17, hour: 19, minute: 2, second: 3, millisecond: 53, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((50)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1919, month: 10, day: 2, hour: 19, minute: 18, second: 31, millisecond: 11, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1919, month: 10, day: 10, hour: 8, minute: 26, second: 54, millisecond: 326, kind: DateTimeKind.Local))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1953, month: 10, day: 3, hour: 3, minute: 14, second: 49, millisecond: 939, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1980, month: 10, day: 10, hour: 18, minute: 45, second: 56, millisecond: 449, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2019, month: 10, day: 1, hour: 17, minute: 47, second: 17, millisecond: 503, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((59)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1992, month: 10, day: 8, hour: 22, minute: 49, second: 1, millisecond: 662, kind: DateTimeKind.Local))));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1947, month: 10, day: 12, hour: 21, minute: 25, second: 11, millisecond: 511, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1984, month: 10, day: 16, hour: 2, minute: 48, second: 48, millisecond: 24, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1994, month: 10, day: 13, hour: 6, minute: 53, second: 56, millisecond: 228, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((61)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1966, month: 10, day: 13, hour: 7, minute: 15, second: 17, millisecond: 845, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1963, month: 10, day: 2, hour: 7, minute: 58, second: 31, millisecond: 814, kind: DateTimeKind.Local))));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2006, month: 10, day: 14, hour: 17, minute: 27, second: 8, millisecond: 927, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1954, month: 10, day: 12, hour: 4, minute: 18, second: 17, millisecond: 760, kind: DateTimeKind.Local))));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1995, month: 10, day: 5, hour: 20, minute: 41, second: 51, millisecond: 110, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((70)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1938, month: 10, day: 11, hour: 15, minute: 7, second: 47, millisecond: 960, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 1954, month: 10, day: 14, hour: 14, minute: 3, second: 32, millisecond: 211, kind: DateTimeKind.Local))));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1945, month: 10, day: 10, hour: 11, minute: 24, second: 3, millisecond: 671, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1979, month: 10, day: 10, hour: 18, minute: 40, second: 27, millisecond: 767, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1954, month: 10, day: 19, hour: 2, minute: 40, second: 19, millisecond: 415, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((78)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1981, month: 10, day: 19, hour: 1, minute: 57, second: 50, millisecond: 330, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1940, month: 10, day: 17, hour: 13, minute: 39, second: 51, millisecond: 543, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 2010, month: 10, day: 8, hour: 15, minute: 3, second: 50, millisecond: 501, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1983, month: 10, day: 17, hour: 2, minute: 49, second: 54, millisecond: 525, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1952, month: 10, day: 2, hour: 11, minute: 1, second: 10, millisecond: 862, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((86)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1967, month: 10, day: 8, hour: 10, minute: 1, second: 45, millisecond: 259, kind: DateTimeKind.Local))));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1959, month: 10, day: 19, hour: 10, minute: 53, second: 20, millisecond: 428, kind: DateTimeKind.Local))));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 1961, month: 10, day: 7, hour: 4, minute: 35, second: 24, millisecond: 793, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1991, month: 10, day: 16, hour: 19, minute: 16, second: 44, millisecond: 714, kind: DateTimeKind.Local))));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((90)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateTime(year: 1940, month: 10, day: 16, hour: 11, minute: 38, second: 1, millisecond: 881, kind: DateTimeKind.Local))));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateTime(year: 2011, month: 10, day: 16, hour: 7, minute: 44, second: 15, millisecond: 490, kind: DateTimeKind.Local))));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateTime(year: 2005, month: 10, day: 19, hour: 14, minute: 52, second: 56, millisecond: 390, kind: DateTimeKind.Local))));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateTime(year: 1971, month: 10, day: 6, hour: 8, minute: 36, second: 40, millisecond: 853, kind: DateTimeKind.Local))));//Value
