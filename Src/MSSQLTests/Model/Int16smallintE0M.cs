...
namespace Tests
{
    public class Int16smallintE0M
    {
        ...
        public Int16smallintE0MI ModelInner { get; set; }

        
        public System.Int16? NullableValue { get; set; }

        public static void AssertModel(Int16smallintE0M actual, Int16smallintE0M expect, bool checkInInnerOnlyId)
        {
