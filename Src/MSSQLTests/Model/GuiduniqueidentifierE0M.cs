...
namespace Tests
{
    public class GuiduniqueidentifierE0M
    {
        ...
        public GuiduniqueidentifierE0MI ModelInner { get; set; }

        
        public System.Guid? NullableValue { get; set; }

        public static void AssertModel(GuiduniqueidentifierE0M actual, GuiduniqueidentifierE0M expect, bool checkInInnerOnlyId)
        {
