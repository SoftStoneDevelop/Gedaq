...
namespace Tests
{
    public class Int32intE0M
    {
        ...
        public Int32intE0MI ModelInner { get; set; }

        
        public System.Int32? NullableValue { get; set; }

        public static void AssertModel(Int32intE0M actual, Int32intE0M expect, bool checkInInnerOnlyId)
        {
