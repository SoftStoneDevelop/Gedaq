...
namespace Tests
{
    public class BooleanbitE0M
    {
        ...
        public BooleanbitE0MI ModelInner { get; set; }

        
        public System.Boolean? NullableValue { get; set; }

        public static void AssertModel(BooleanbitE0M actual, BooleanbitE0M expect, bool checkInInnerOnlyId)
        {
