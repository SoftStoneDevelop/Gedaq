...
namespace Tests
{
    public class SinglefloatE0M
    {
        ...
        public SinglefloatE0MI ModelInner { get; set; }

        
        public System.Single? NullableValue { get; set; }

        public static void AssertModel(SinglefloatE0M actual, SinglefloatE0M expect, bool checkInInnerOnlyId)
        {
