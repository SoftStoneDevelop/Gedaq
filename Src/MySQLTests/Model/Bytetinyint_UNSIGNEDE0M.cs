...
namespace Tests
{
    public class Bytetinyint_UNSIGNEDE0M
    {
        ...
        public Bytetinyint_UNSIGNEDE0MI ModelInner { get; set; }

        
        public System.Byte? NullableValue { get; set; }

        public static void AssertModel(Bytetinyint_UNSIGNEDE0M actual, Bytetinyint_UNSIGNEDE0M expect, bool checkInInnerOnlyId)
        {
