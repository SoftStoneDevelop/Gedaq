...
namespace Tests
{
    public class UInt32int_UNSIGNEDE0M
    {
        ...
        public UInt32int_UNSIGNEDE0MI ModelInner { get; set; }

        
        public System.UInt32? NullableValue { get; set; }

        public static void AssertModel(UInt32int_UNSIGNEDE0M actual, UInt32int_UNSIGNEDE0M expect, bool checkInInnerOnlyId)
        {
