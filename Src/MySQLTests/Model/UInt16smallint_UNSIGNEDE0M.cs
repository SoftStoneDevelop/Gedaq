...
namespace Tests
{
    public class UInt16smallint_UNSIGNEDE0M
    {
        ...
        public UInt16smallint_UNSIGNEDE0MI ModelInner { get; set; }

        
        public System.UInt16? NullableValue { get; set; }

        public static void AssertModel(UInt16smallint_UNSIGNEDE0M actual, UInt16smallint_UNSIGNEDE0M expect, bool checkInInnerOnlyId)
        {
