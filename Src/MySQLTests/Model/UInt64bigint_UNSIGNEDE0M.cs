...
namespace Tests
{
    public class UInt64bigint_UNSIGNEDE0M
    {
        ...
        public UInt64bigint_UNSIGNEDE0MI ModelInner { get; set; }

        
        public System.UInt64? NullableValue { get; set; }

        public static void AssertModel(UInt64bigint_UNSIGNEDE0M actual, UInt64bigint_UNSIGNEDE0M expect, bool checkInInnerOnlyId)
        {
