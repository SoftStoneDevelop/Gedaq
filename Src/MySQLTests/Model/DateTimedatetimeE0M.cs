...
namespace Tests
{
    public class DateTimedatetimeE0M
    {
        ...
        public DateTimedatetimeE0MI ModelInner { get; set; }

        
        public System.DateTime? NullableValue { get; set; }

        public static void AssertModel(DateTimedatetimeE0M actual, DateTimedatetimeE0M expect, bool checkInInnerOnlyId)
        {
