...
namespace Tests
{
    public class DoubledoubleE0M
    {
        ...
        public DoubledoubleE0MI ModelInner { get; set; }

        
        public System.Double? NullableValue { get; set; }

        public static void AssertModel(DoubledoubleE0M actual, DoubledoubleE0M expect, bool checkInInnerOnlyId)
        {
