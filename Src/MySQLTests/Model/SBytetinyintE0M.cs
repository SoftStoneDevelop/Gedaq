...
namespace Tests
{
    public class SBytetinyintE0M
    {
        ...
        public SBytetinyintE0MI ModelInner { get; set; }

        
        public System.SByte? NullableValue { get; set; }

        public static void AssertModel(SBytetinyintE0M actual, SBytetinyintE0M expect, bool checkInInnerOnlyId)
        {
