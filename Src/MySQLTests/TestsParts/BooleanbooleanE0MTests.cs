...
";
                ...
                foreach(var batchResult in  ((IBooleanSingleTypeboolean)this).DbConnectionSTDynQuerySelectModelDynParBatch(connection, [parametr1], query1, [parametr2], query2))
                {
                    if(++resultIndex == 1)
                    {
                        ...
                        FlatBooleanbooleanE0M.AssertModel(models[0],_testData[18], false);
                        FlatBooleanbooleanE0M.AssertModel(models[1],_testData[19], false);
                        FlatBooleanbooleanE0M.AssertModel(models[2],_testData[20], false);
                        FlatBooleanbooleanE0M.AssertModel(models[3],_testData[21], false);
                        FlatBooleanbooleanE0M.AssertModel(models[4],_testData[22], false);
                        FlatBooleanbooleanE0M.AssertModel(models[5],_testData[23], false);
                        FlatBooleanbooleanE0M.AssertModel(models[6],_testData[24], false);
                        FlatBooleanbooleanE0M.AssertModel(models[7],_testData[25], false);
                        FlatBooleanbooleanE0M.AssertModel(models[8],_testData[26], false);
                        FlatBooleanbooleanE0M.AssertModel(models[9],_testData[27], false);
                        FlatBooleanbooleanE0M.AssertModel(models[10],_testData[28], false);
                        FlatBooleanbooleanE0M.AssertModel(models[11],_testData[29], false);
                        FlatBooleanbooleanE0M.AssertModel(models[12],_testData[30], false);
                        FlatBooleanbooleanE0M.AssertModel(models[13],_testData[31], false);
                        FlatBooleanbooleanE0M.AssertModel(models[14],_testData[32], false);
                        FlatBooleanbooleanE0M.AssertModel(models[15],_testData[33], false);
                        FlatBooleanbooleanE0M.AssertModel(models[16],_testData[34], false);
                        continue;
                    }                    
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                var secondItems2 = new List<FlatBooleanbooleanE0M>();
                await ((IBooleanSingleTypeboolean)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 156, query1, 91, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanE0M>();
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                await ((IBooleanSingleTypeboolean)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 116, query1, 161, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                ...
                Assert.That(secondItems1, Has.Count.EqualTo(5));
                        FlatBooleanbooleanE0M.AssertModel(secondItems1[0],_testData[30], false);
                        FlatBooleanbooleanE0M.AssertModel(secondItems1[1],_testData[31], false);
                        FlatBooleanbooleanE0M.AssertModel(secondItems1[2],_testData[32], false);
                        FlatBooleanbooleanE0M.AssertModel(secondItems1[3],_testData[33], false);
                        FlatBooleanbooleanE0M.AssertModel(secondItems1[4],_testData[34], false);
            }
        }
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                var secondItems2 = new List<FlatBooleanbooleanE0M>();
                 ((IBooleanSingleTypeboolean)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 124, query1, 142, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatBooleanbooleanE0M>();
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                 ((IBooleanSingleTypeboolean)this).DbConnectionMMDynQuerySelectModelBatch(connection, 41, query1, 24, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanSingleTypeboolean)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 24, query1, 45, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                var secondItems2 = new List<FlatBooleanbooleanE0M>();
                await ((IBooleanSingleTypeboolean)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 83, query1, 55, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanSingleTypeboolean)this).DbConnectionSTDynQuerySelectModelBatch(connection, 176, query1, 127, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatBooleanbooleanE0M>();
                var secondItems2 = new List<FlatBooleanbooleanE0M>();
                 ((IBooleanSingleTypeboolean)this).DbConnectionDynQuerySelectModelBatch(connection, 18, query1, 124, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IBooleanSingleTypeboolean)this).DbConnectionSTSelectModelBatchAsync(connection, 55, 173))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IBooleanSingleTypeboolean)this).DbConnectionSTSelectModelBatch(connection, 131, 41))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IBooleanSingleTypeboolean)this).SetDbConnectionSelectModelParametrs(cmd, 9);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IBooleanSingleTypeboolean)this).SetDbConnectionSelectModelParametrs(cmd, 173);
