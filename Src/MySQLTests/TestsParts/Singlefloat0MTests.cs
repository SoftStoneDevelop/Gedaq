    ...
    ModelInner = new Singlefloat0MI
{
    Id = 50,
    Value = 0.47896856f,
    NullableValue = 0.16352844f,
},
    NullableValue = 0.07496637f,
},
            new Singlefloat0M
{
    Id = 103,
    ...
    ModelInner = new Singlefloat0MI
{
    Id = 58,
    Value = 0.31990325f,
    NullableValue = 0.38227767f,
},
    NullableValue = 0.112906575f,
},
            new Singlefloat0M
{
    Id = 116,
    ...
    ModelInner = new Singlefloat0MI
{
    Id = 67,
    Value = 0.5566697f,
    NullableValue = 0.9102457f,
},
    NullableValue = 0.48144442f,
},
            new Singlefloat0M
{
    Id = 123,
    ...
    ModelInner = new Singlefloat0MI
{
    Id = 71,
    Value = 0.42741412f,
    NullableValue = 0.5110156f,
},
    NullableValue = 0.34614325f,
},
            new Singlefloat0M
{
    Id = 133,
    ...
    ModelInner = new Singlefloat0MI
{
    Id = 80,
    Value = 0.36988944f,
    NullableValue = 0.05026102f,
},
    NullableValue = 0.21727377f,
},
            new Singlefloat0M
{
    Id = 143,
...
";
                ...
                var secondItems1 = new List<FlatSinglefloat0M>();
                var secondItems2 = new List<FlatSinglefloat0M>();
                await ((ISingleSingleTypefloat)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 85, query1, 136, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatSinglefloat0M>();
                var secondItems1 = new List<FlatSinglefloat0M>();
                await ((ISingleSingleTypefloat)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 42, query1, 6, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(22));
                Assert.That(firstItems2, Has.Count.EqualTo(22));
                        FlatSinglefloat0M.AssertModel(firstItems1[0],_testData[8], false);
                        FlatSinglefloat0M.AssertModel(firstItems2[0],_testData[8], false);
...
";
                ...
                var secondItems1 = new List<FlatSinglefloat0M>();
                var secondItems2 = new List<FlatSinglefloat0M>();
                 ((ISingleSingleTypefloat)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 47, query1, 22, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatSinglefloat0M>();
                var secondItems1 = new List<FlatSinglefloat0M>();
                 ((ISingleSingleTypefloat)this).DbConnectionMMDynQuerySelectModelBatch(connection, 65, query1, 133, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((ISingleSingleTypefloat)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 146, query1, 146, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatSinglefloat0M>();
                var secondItems2 = new List<FlatSinglefloat0M>();
                await ((ISingleSingleTypefloat)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 6, query1, 127, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((ISingleSingleTypefloat)this).DbConnectionSTDynQuerySelectModelBatch(connection, 54, query1, 143, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatSinglefloat0M>();
                var secondItems2 = new List<FlatSinglefloat0M>();
                 ((ISingleSingleTypefloat)this).DbConnectionDynQuerySelectModelBatch(connection, 54, query1, 119, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((ISingleSingleTypefloat)this).DbConnectionSTSelectModelBatchAsync(connection, 143, 6))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((ISingleSingleTypefloat)this).DbConnectionSTSelectModelBatch(connection, 63, 116))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionCommandSelectModelTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((ISingleSingleTypefloat)this).SetDbConnectionSelectModelParametrs(cmd, 85);
...
Singlefloat0M.AssertModel(models[0],_testData[15], false);Singlefloat0M.AssertModel(models[1],_testData[16], false);Singlefloat0M.AssertModel(models[2],_testData[17], false);Singlefloat0M.AssertModel(models[3],_testData[18], false);Singlefloat0M.AssertModel(models[4],_testData[19], false);Singlefloat0M.AssertModel(models[5],_testData[20], false);Singlefloat0M.AssertModel(models[6],_testData[21], false);Singlefloat0M.AssertModel(models[7],_testData[22], false);Singlefloat0M.AssertModel(models[8],_testData[23], false);Singlefloat0M.AssertModel(models[9],_testData[24], false);Singlefloat0M.AssertModel(models[10],_testData[25], false);Singlefloat0M.AssertModel(models[11],_testData[26], false);Singlefloat0M.AssertModel(models[12],_testData[27], false);Singlefloat0M.AssertModel(models[13],_testData[28], false);Singlefloat0M.AssertModel(models[14],_testData[29], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((ISingleSingleTypefloat)this).SetDbConnectionSelectModelParametrs(cmd, 19);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.88304186f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.91318065f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((8)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.08595091f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.9154947f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.39839655f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.73409164f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((14)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.37434483f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.43565077f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.91865927f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.60730255f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((21)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.5419606f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.53162134f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.95867455f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.62553155f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((26)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.21232492f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.33916342f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.9429672f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.90703285f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((29)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.079797566f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.12594938f)));//InnerModel.NullableValue
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.984558f)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.30227536f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.17463136f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((34)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.09183663f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.56212974f)));//InnerModel.NullableValue
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.37856507f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.15575057f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((37)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.56647563f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.1761902f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.00820446f)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.42891276f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.8675898f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((43)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.1713643f)));//InnerModel.Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.21020561f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.6477488f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((50)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.47896856f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.16352844f)));//InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.07496637f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.558503f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.48167825f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((58)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.31990325f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.38227767f)));//InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.112906575f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.7721111f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.009210527f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((67)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.5566697f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.9102457f)));//InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.48144442f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.5320403f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.37226623f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((71)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.42741412f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.5110156f)));//InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.34614325f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.8492959f)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.69965f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.66602135f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((80)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.36988944f)));//InnerModel.Value

                Assert.That((System.Single?)model[4], Is.EqualTo((0.05026102f)));//InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.21727377f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.34871352f)));//Value
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.72895753f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((85)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.61071986f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.17957968f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.6963777f)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.Single?)model[5], Is.EqualTo((0.023694873f)));
                ...
                Assert.That((System.Single)model[1], Is.EqualTo((0.993359f)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((87)));//InnerModel.Id
                Assert.That((System.Single)model[3], Is.EqualTo((0.40764308f)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.Single?)model[5], Is.EqualTo((0.05316603f)));
