    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1959, month: 10, day: 8),
},
            new DateOnlydate0M
{
    Id = 21,
    Value = new DateOnly(year: 1966, month: 10, day: 1),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1962, month: 10, day: 11),
},
    NullableValue = new DateOnly(year: 1933, month: 10, day: 18),
},
            new DateOnlydate0M
{
    Id = 29,
...
{
    Id = 12,
    Value = new DateOnly(year: 1997, month: 10, day: 5),
    NullableValue = new DateOnly(year: 1939, month: 10, day: 10),
},
...
{
    Id = 30,
    Value = new DateOnly(year: 1923, month: 10, day: 3),
...
{
    Id = 37,
    Value = new DateOnly(year: 1996, month: 10, day: 14),
    NullableValue = new DateOnly(year: 1947, month: 10, day: 13),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 105,
    Value = new DateOnly(year: 1978, month: 10, day: 5),
    ModelInner = null,
...
{
    Id = 53,
    Value = new DateOnly(year: 1994, month: 10, day: 14),
    NullableValue = null,
},
    NullableValue = null,
},
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1945, month: 10, day: 15),
},
    NullableValue = new DateOnly(year: 1988, month: 10, day: 11),
},
            new DateOnlydate0M
{
    Id = 133,
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 1920, month: 10, day: 4),
},
            new DateOnlydate0M
{
    Id = 139,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1998, month: 10, day: 10),
},
            new DateOnlydate0M
{
    Id = 144,
...
{
    Id = 78,
    Value = new DateOnly(year: 1945, month: 10, day: 1),
    NullableValue = new DateOnly(year: 1988, month: 10, day: 8),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 64, query1, 91, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 86, query1, 86, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
                Assert.That(firstItems1, Has.Count.EqualTo(15));
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 147, query1, 133, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 22, query1, 68, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 14, query1, 5, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 105, query1, 133, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 65, query1, 129, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 144, query1, 105, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 22, 21))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 68, 29))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1919, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1966, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1962, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1933, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1924, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((12)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1997, month: 10, day: 5)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1939, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1957, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((30)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1923, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1972, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1996, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1978, month: 10, day: 5)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 2005, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1929, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1994, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1988, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1920, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1945, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1988, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1985, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
