    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1954, month: 10, day: 16),
},
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1938, month: 10, day: 8),
},
            new DateOnlydate0M
{
    Id = 20,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1926, month: 10, day: 11),
},
    NullableValue = new DateOnly(year: 1924, month: 10, day: 18),
},
            new DateOnlydate0M
{
    Id = 29,
    ...
    ModelInner = null,
    NullableValue = new DateOnly(year: 2017, month: 10, day: 16),
},
            new DateOnlydate0M
{
    Id = 31,
...
{
    Id = 38,
    Value = new DateOnly(year: 1947, month: 10, day: 8),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1953, month: 10, day: 10),
},
            new DateOnlydate0M
{
    Id = 53,
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1922, month: 10, day: 17),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 88,
    Value = new DateOnly(year: 1934, month: 10, day: 19),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 90,
    Value = new DateOnly(year: 2002, month: 10, day: 9),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 117,
    Value = new DateOnly(year: 1990, month: 10, day: 8),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 76,
    Value = new DateOnly(year: 2003, month: 10, day: 5),
    NullableValue = null,
},
    NullableValue = null,
},
...
{
    Id = 79,
    Value = new DateOnly(year: 1995, month: 10, day: 10),
    NullableValue = null,
},
...
{
    Id = 83,
    Value = new DateOnly(year: 1962, month: 10, day: 8),
    NullableValue = null,
},
    NullableValue = new DateOnly(year: 1964, month: 10, day: 16),
},
        };
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatchAsync(connection, 90, query1, 127, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                await ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatchAsync(connection, 25, query1, 12, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionSTMMDynQuerySelectModelBatch(connection, 31, query1, 15, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
";
                ...
                var firstItems2 = new List<FlatDateOnlydate0M>();
                var secondItems1 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionMMDynQuerySelectModelBatch(connection, 79, query1, 105, query2, (item1, item2) => { firstItems1.Add(item1); firstItems2.Add(item2); }, (item1) => { secondItems1.Add(item1); });
...
";
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatchAsync(connection, 12, query1, 31, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTDynQuerySelectModelBatch(connection, 12, query1, 88, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
";
                ...
                var secondItems1 = new List<FlatDateOnlydate0M>();
                var secondItems2 = new List<FlatDateOnlydate0M>();
                 ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 29, query1, 61, query2, (item1) => { firstItems1.Add(item1); }, (item1, item2) => { secondItems1.Add(item1); secondItems2.Add(item2); });
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSTSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatchAsync(connection, 122, 64))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
        ...
        public async Task DbConnectionSTSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSTSelectModelBatch(connection, 127, 137))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1963, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1988, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((15)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 17)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1938, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1943, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1969, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1926, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1924, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2017, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1982, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1947, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((33)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1953, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1932, month: 10, day: 15)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1922, month: 10, day: 17)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1971, month: 10, day: 2)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1934, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1980, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2002, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1930, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1973, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1989, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1990, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1939, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 2003, month: 10, day: 5)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1976, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((DBNull)model[2], Is.EqualTo(DBNull.Value)); // InnerModel.Id
                Assert.That((DBNull)model[3], Is.EqualTo(DBNull.Value)); // InnerModel.Value
                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value)); // InnerModel.NullableValue

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1956, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2009, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((79)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1962, month: 10, day: 8)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1964, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));
