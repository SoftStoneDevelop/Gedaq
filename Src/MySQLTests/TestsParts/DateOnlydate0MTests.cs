    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 2015, month: 10, day: 18),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 33,
    Value = new DateOnly(year: 1956, month: 10, day: 10),
    ModelInner = null,
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 51,
    Value = new DateOnly(year: 1938, month: 10, day: 19),
    ModelInner = new DateOnlydate0MI
{
    Id = 22,
...
{
    Id = 35,
    Value = new DateOnly(year: 1943, month: 10, day: 9),
    NullableValue = null,
},
    NullableValue = null,
},
    ...
    ModelInner = new DateOnlydate0MI
{
    ...
    NullableValue = new DateOnly(year: 1967, month: 10, day: 11),
},
    NullableValue = null,
},
            new DateOnlydate0M
...
{
    Id = 153,
    Value = new DateOnly(year: 1959, month: 10, day: 10),
    ModelInner = new DateOnlydate0MI
{
    Id = 59,
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatchAsync(connection, 13, query1, 123, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
ORDER BY
    m.id ASC
";
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionDynQuerySelectModelBatch(connection, 38, query1, 65, query2))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
Gedaq.DbConnection.Attributes.BatchPart(
        ...
        public async Task DbConnectionSelectModelBatchTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in await ((IDateOnlySingleTypedate)this).DbConnectionSelectModelBatchAsync(connection, 94, 38))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydate0M.AssertModel(models[0],_testData[10], false);DateOnlydate0M.AssertModel(models[1],_testData[11], false);DateOnlydate0M.AssertModel(models[2],_testData[12], false);DateOnlydate0M.AssertModel(models[3],_testData[13], false);DateOnlydate0M.AssertModel(models[4],_testData[14], false);DateOnlydate0M.AssertModel(models[5],_testData[15], false);DateOnlydate0M.AssertModel(models[6],_testData[16], false);DateOnlydate0M.AssertModel(models[7],_testData[17], false);DateOnlydate0M.AssertModel(models[8],_testData[18], false);DateOnlydate0M.AssertModel(models[9],_testData[19], false);DateOnlydate0M.AssertModel(models[10],_testData[20], false);DateOnlydate0M.AssertModel(models[11],_testData[21], false);DateOnlydate0M.AssertModel(models[12],_testData[22], false);DateOnlydate0M.AssertModel(models[13],_testData[23], false);DateOnlydate0M.AssertModel(models[14],_testData[24], false);DateOnlydate0M.AssertModel(models[15],_testData[25], false);DateOnlydate0M.AssertModel(models[16],_testData[26], false);DateOnlydate0M.AssertModel(models[17],_testData[27], false);DateOnlydate0M.AssertModel(models[18],_testData[28], false);DateOnlydate0M.AssertModel(models[19],_testData[29], false);
        ...
        public async Task DbConnectionSelectModelBatchTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                await connection.OpenAsync();
                int resultIndex = 0;
                foreach(var batchResult in  ((IDateOnlySingleTypedate)this).DbConnectionSelectModelBatch(connection, 86, 56))
                {
                    if(++resultIndex == 1)
                    {
                        var models = batchResult;
...
DateOnlydate0M.AssertModel(models[0],_testData[13], false);DateOnlydate0M.AssertModel(models[1],_testData[14], false);DateOnlydate0M.AssertModel(models[2],_testData[15], false);DateOnlydate0M.AssertModel(models[3],_testData[16], false);DateOnlydate0M.AssertModel(models[4],_testData[17], false);DateOnlydate0M.AssertModel(models[5],_testData[18], false);DateOnlydate0M.AssertModel(models[6],_testData[19], false);DateOnlydate0M.AssertModel(models[7],_testData[20], false);DateOnlydate0M.AssertModel(models[8],_testData[21], false);DateOnlydate0M.AssertModel(models[9],_testData[22], false);DateOnlydate0M.AssertModel(models[10],_testData[23], false);DateOnlydate0M.AssertModel(models[11],_testData[24], false);DateOnlydate0M.AssertModel(models[12],_testData[25], false);DateOnlydate0M.AssertModel(models[13],_testData[26], false);DateOnlydate0M.AssertModel(models[14],_testData[27], false);DateOnlydate0M.AssertModel(models[15],_testData[28], false);DateOnlydate0M.AssertModel(models[16],_testData[29], false);
        ...
        public async Task DbConnectionCommandSelectModelTest()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                ((IDateOnlySingleTypedate)this).SetDbConnectionSelectModelParametrs(cmd, 123);
...
,
        ...
        public async Task DbConnectionSelectModelToObjArrTestAsync()
        {
            await using (var connection = GlobalSetUp.GetDbConnection)
            {
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1961, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1962, month: 10, day: 17)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1924, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1923, month: 10, day: 12)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 17)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1956, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1918, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2003, month: 10, day: 13)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1938, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((22)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1988, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1954, month: 10, day: 14)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1967, month: 10, day: 19)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1952, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1981, month: 10, day: 4)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1921, month: 10, day: 3)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((34)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1920, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1943, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2015, month: 10, day: 12)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1992, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((DBNull)model[4], Is.EqualTo(DBNull.Value));//InnerModel.Value

                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 1943, month: 10, day: 16)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[5], Is.EqualTo((new DateOnly(year: 2016, month: 10, day: 5)).ToDateTime(TimeOnly.MinValue)));
                ...
                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1967, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1969, month: 10, day: 1)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1998, month: 10, day: 7)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 2001, month: 10, day: 2)).ToDateTime(TimeOnly.MinValue)));//Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 18)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((55)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1979, month: 10, day: 12)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value
                ...
                Assert.That((System.DateTime)model[1], Is.EqualTo((new DateOnly(year: 1959, month: 10, day: 10)).ToDateTime(TimeOnly.MinValue)));//Value

                Assert.That((System.Int32)model[2], Is.EqualTo((59)));//InnerModel.Id
                Assert.That((System.DateTime)model[3], Is.EqualTo((new DateOnly(year: 1995, month: 10, day: 11)).ToDateTime(TimeOnly.MinValue)));//InnerModel.Value

                Assert.That((System.DateTime?)model[4], Is.EqualTo((new DateOnly(year: 1941, month: 10, day: 9)).ToDateTime(TimeOnly.MinValue)));//InnerModel.NullableValue
