...
namespace Tests
{
    ...
    internal partial class Int64SingleTypebigint
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int64biginte0mi (
    id int  NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int64biginte0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int64biginte0m
(
    id int NOT NULL,
    value bigint NOT NULL,
    nullablevalue bigint,
    int64biginte0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (int64biginte0mi_id)
        REFERENCES gedaqtests.int64biginte0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int64biginte0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
