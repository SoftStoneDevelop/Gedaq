...
namespace Tests
{
    ...
    internal partial class DecimalSingleTypedecimal
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.decimaldecimale0mi (
    id int  NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.decimaldecimale0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.decimaldecimale0m
(
    id int NOT NULL,
    value decimal(30, 30) NOT NULL,
    nullablevalue decimal(30, 30),
    decimaldecimale0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (decimaldecimale0mi_id)
        REFERENCES gedaqtests.decimaldecimale0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.decimaldecimale0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
