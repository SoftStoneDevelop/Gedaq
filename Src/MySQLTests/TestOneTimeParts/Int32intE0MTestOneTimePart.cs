...
namespace Tests
{
    ...
    internal partial class Int32SingleTypeint
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int32inte0mi (
    id int  NOT NULL,
    value int NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int32inte0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int32inte0m
(
    id int NOT NULL,
    value int NOT NULL,
    nullablevalue int,
    int32inte0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (int32inte0mi_id)
        REFERENCES gedaqtests.int32inte0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int32inte0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
