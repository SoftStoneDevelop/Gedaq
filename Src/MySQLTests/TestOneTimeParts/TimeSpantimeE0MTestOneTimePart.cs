...
namespace Tests
{
    ...
    internal partial class TimeSpanSingleTypetime
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.timespantimee0mi (
    id int  NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.timespantimee0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.timespantimee0m
(
    id int NOT NULL,
    value time(6) NOT NULL,
    nullablevalue time(6),
    timespantimee0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (timespantimee0mi_id)
        REFERENCES gedaqtests.timespantimee0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.timespantimee0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
