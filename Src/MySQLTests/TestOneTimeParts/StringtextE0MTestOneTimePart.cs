...
namespace Tests
{
    ...
    internal partial class StringSingleTypetext
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.stringtexte0mi (
    id int  NOT NULL,
    value text NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringtexte0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.stringtexte0m
(
    id int NOT NULL,
    value text NOT NULL,
    nullablevalue text,
    stringtexte0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (stringtexte0mi_id)
        REFERENCES gedaqtests.stringtexte0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.stringtexte0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
