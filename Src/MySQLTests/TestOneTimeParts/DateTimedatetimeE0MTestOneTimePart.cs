...
namespace Tests
{
    ...
    internal partial class DateTimeSingleTypedatetime
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.datetimedatetimee0mi (
    id int  NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.datetimedatetimee0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.datetimedatetimee0m
(
    id int NOT NULL,
    value datetime(6) NOT NULL,
    nullablevalue datetime(6),
    datetimedatetimee0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (datetimedatetimee0mi_id)
        REFERENCES gedaqtests.datetimedatetimee0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.datetimedatetimee0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
