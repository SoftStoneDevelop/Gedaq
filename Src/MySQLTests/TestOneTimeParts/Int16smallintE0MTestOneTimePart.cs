...
namespace Tests
{
    ...
    internal partial class Int16SingleTypesmallint
    {
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int16smallinte0mi (
    id int  NOT NULL,
...
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int16smallinte0mi
";
            await cmd.ExecuteNonQueryAsync();
        }
        ...
        {
            cmd.CommandText = @"
CREATE TABLE gedaqtests.int16smallinte0m
(
    id int NOT NULL,
    value smallint NOT NULL,
    nullablevalue smallint,
    int16smallinte0mi_id int,
    PRIMARY KEY (id),
    FOREIGN KEY (int16smallinte0mi_id)
        REFERENCES gedaqtests.int16smallinte0mi (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
";
        ...
        {
            cmd.CommandText = @"
DROP TABLE IF EXISTS gedaqtests.int16smallinte0m;
";
            await cmd.ExecuteNonQueryAsync();
        }
