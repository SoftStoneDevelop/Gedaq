...
- [DbConnection](https://github.com/SoftStoneDevelop/Gedaq.DbConnection). Only the methods available in DbConnection do not use database-specific features and methods and optimizations.
